...
mariadb-galera: LDAP
    ...
    $ helm install {{ .Release.Name }} https://charts-dev.bitmoa.net/bitmoa//mariadb-galera \
...
{{- if and .Values.tls.enabled .Values.tls.autoGenerated }}
    {{- printf "/bitmoa/mariadb/certs/tls.crt" -}}
{{- else -}}
    {{- printf "/bitmoa/mariadb/certs/%s" .Values.tls.certFilename -}}
{{- end -}}
{{- end -}}
...
{{- if and .Values.tls.enabled .Values.tls.autoGenerated }}
    {{- printf "/bitmoa/mariadb/certs/tls.key" -}}
{{- else -}}
    {{- printf "/bitmoa/mariadb/certs/%s" .Values.tls.certKeyFilename -}}
{{- end -}}
{{- end -}}
...
{{- if and .Values.tls.enabled .Values.tls.autoGenerated }}
    {{- printf "/bitmoa/mariadb/certs/ca.crt" -}}
{{- else -}}
    {{- printf "/bitmoa/mariadb/certs/%s" .Values.tls.certCAFilename -}}
{{- end -}}
{{- end -}}
