...
- name: ELASTICSEARCH_PASSWORD_FILE
  value: "/opt/bitmoa/elasticsearch/secrets/elasticsearch-password"
{{- else }}
...
- name: ELASTICSEARCH_KEYSTORE_LOCATION
  value: "/opt/bitmoa/elasticsearch/config/certs/{{ .Values.security.tls.keystoreFilename }}"
- name: ELASTICSEARCH_TRUSTSTORE_LOCATION
  value: "/opt/bitmoa/elasticsearch/config/certs/{{ .Values.security.tls.truststoreFilename }}"
{{- end }}
...
- name: ELASTICSEARCH_KEYSTORE_PASSWORD_FILE
  value: {{ printf "/opt/bitmoa/elasticsearch/secrets/%s" (include "elasticsearch.keystorePasswordKey" .) }}
{{- else }}
...
- name: ELASTICSEARCH_TRUSTSTORE_PASSWORD_FILE
  value: {{ printf "/opt/bitmoa/elasticsearch/secrets/%s" (include "elasticsearch.truststorePasswordKey" .) }}
{{- else }}
...
- name: ELASTICSEARCH_KEY_PASSWORD_FILE
  value: {{ printf "/opt/bitmoa/elasticsearch/secrets/%s" (include "elasticsearch.keyPasswordKey" .) }}
{{- else }}
