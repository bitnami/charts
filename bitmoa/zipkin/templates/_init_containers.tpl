...
- name: init-certs
  ...
  args:
    ...
    - |
      ...
      for file in $(find /bitmoa/zipkin/secrets -type f); do
      ...
      if [[ -f "/certs/tls.key" ]] && [[ -f "/certs/tls.crt" ]]; then
          ...
          keytool -importkeystore -srckeystore "/tmp/keystore.p12" \
              ...
              -destkeystore "/opt/bitmoa/zipkin/certs/zipkin.jks"
          rm "/tmp/keystore.p12"
      else
      ...
      if [[ -f "/certs/zipkin.jks" ]]; then
          cp "/certs/zipkin.jks" "/opt/bitmoa/zipkin/certs/zipkin.jks"
      else
  ...
  volumeMounts:
    - name: input-tls-certs
      mountPath: /certs
    - name: empty-dir
      mountPath: /opt/bitmoa/zipkin/certs
    ...
    - name: keystore-password
      mountPath: /bitmoa/zipkin/secrets/keystore-password
    {{- end }}
    {{- end }}
{{- end -}}
