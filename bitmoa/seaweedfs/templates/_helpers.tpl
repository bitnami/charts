...
- name: auth-config-init
  ...
  env:
    ...
    - name: ADMIN_ACCESS_KEY_ID_FILE
      value: "/opt/bitmoa/seaweed/secrets/admin_access_key_id"
    - name: ADMIN_SECRET_ACCESS_KEY_FILE
      value: "/opt/bitmoa/seaweed/secrets/admin_secret_access_key"
    - name: READ_ACCESS_KEY_ID_FILE
      value: "/opt/bitmoa/seaweed/secrets/read_access_key_id"
    - name: READ_SECRET_ACCESS_KEY_FILE
      value: "/opt/bitmoa/seaweed/secrets/read_secret_access_key"
    {{- else }}
  ...
  volumeMounts:
    ...
    - name: seaweed-secrets
      mountPath: /opt/bitmoa/seaweed/secrets
    {{- end}}
{{- end -}}
