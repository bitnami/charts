...
{{- if (include "valkey-cluster.createTlsSecret" . ) -}}
    {{- printf "/opt/bitmoa/valkey/certs/%s" "tls.crt" -}}
{{- else -}}
    {{- required "Certificate filename is required when TLS in enabled" .Values.tls.certFilename | printf "/opt/bitmoa/valkey/certs/%s" -}}
{{- end -}}
{{- end -}}
...
{{- if (include "valkey-cluster.createTlsSecret" . ) -}}
    {{- printf "/opt/bitmoa/valkey/certs/%s" "tls.key" -}}
{{- else -}}
    {{- required "Certificate Key filename is required when TLS in enabled" .Values.tls.certKeyFilename | printf "/opt/bitmoa/valkey/certs/%s" -}}
{{- end -}}
{{- end -}}
...
{{- if (include "valkey-cluster.createTlsSecret" . ) -}}
    {{- printf "/opt/bitmoa/valkey/certs/%s" "ca.crt" -}}
{{- else -}}
    {{- required "Certificate CA filename is required when TLS in enabled" .Values.tls.certCAFilename | printf "/opt/bitmoa/valkey/certs/%s" -}}
{{- end -}}
{{- end -}}
...
{{- printf "/opt/bitmoa/valkey/certs/%s" .Values.tls.dhParamsFilename -}}
{{- end -}}
{{- end -}}
