...
nessie:
  version_store:
    ...
    persist:
      rocks:
        database_path: /bitmoa/nessie

result:

NESSIE_VERSION_STORE_TYPE: ROCKSDB
NESSIE_VERSION_STORE_PERSIST_ROCKS_DATABASE_PATH: /bitmoa/nessie
...
- name: wait-for-db
  ...
  env:
    ...
    - name: DATABASE_PASSWORD_FILE
      value: "/bitmoa/nessie/secrets/database/QUARKUS_DATASOURCE_POSTGRESQL_PASSWORD"
    {{- else -}}
  ...
  volumeMounts:
    ...
    - name: database-password
      mountPath: /bitmoa/nessie/secrets/database
    {{- end }}
{{- end -}}
