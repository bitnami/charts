...
postgresql-ha: LDAP
    ...
    $ helm install {{ .Release.Name }} oci://registry-1.docker.io/bitmoacharts/postgresql-ha \
...
postgresql-ha: Upgrade repmgr extension
    ...
    $ helm upgrade {{ .Release.Name }} oci://registry-1.docker.io/bitmoacharts/postgresql-ha \
...
{{- if and .Values.pgpool.tls.enabled .Values.pgpool.tls.autoGenerated }}
    {{- printf "/opt/bitmoa/pgpool/certs/tls.crt" -}}
{{- else -}}
    {{- required "Certificate filename is required when TLS in enabled" .Values.pgpool.tls.certFilename | printf "/opt/bitmoa/pgpool/certs/%s" -}}
{{- end -}}
{{- end -}}
...
{{- if and .Values.pgpool.tls.enabled .Values.pgpool.tls.autoGenerated }}
    {{- printf "/opt/bitmoa/pgpool/certs/tls.key" -}}
{{- else -}}
    {{- required "Certificate Key filename is required when TLS in enabled" .Values.pgpool.tls.certKeyFilename | printf "/opt/bitmoa/pgpool/certs/%s" -}}
{{- end -}}
{{- end -}}
...
{{- if and .Values.pgpool.tls.enabled .Values.pgpool.tls.autoGenerated }}
    {{- printf "/opt/bitmoa/pgpool/certs/ca.crt" -}}
{{- else -}}
    {{- printf "/opt/bitmoa/pgpool/certs/%s" .Values.pgpool.tls.certCAFilename -}}
{{- end -}}
{{- end -}}
...
{{- required "Certificate filename is required when TLS in enabled" .Values.postgresql.tls.certFilename | printf "/opt/bitmoa/postgresql/certs/%s" -}}
{{- end -}}
...
{{- required "Certificate Key filename is required when TLS in enabled" .Values.postgresql.tls.certKeyFilename | printf "/opt/bitmoa/postgresql/certs/%s" -}}
{{- end -}}
