...
{{- if (include "scylladb.createTlsSecret" . ) -}}
    {{- printf "/bitmoa/scylladb/cert/%s" "tls.crt" -}}
{{- else -}}
    {{- required "Certificate filename is required when TLS in enabled" .Values.tls.certFilename | printf "/bitmoa/scylladb/certs/%s" -}}
{{- end -}}
{{- end -}}
...
{{- if (include "scylladb.createTlsSecret" . ) -}}
    {{- printf "/bitmoa/scylladb/cert/%s" "tls.key" -}}
{{- else -}}
    {{- required "Certificate Key filename is required when TLS in enabled" .Values.tls.certKeyFilename | printf "/bitmoa/scylladb/certs/%s" -}}
{{- end -}}
{{- end -}}
...
{{- if (include "scylladb.createTlsSecret" . ) -}}
    {{- printf "/bitmoa/scylladb/ca/%s" "tls.crt" -}}
{{- else if .Values.tls.certCAFilename -}}
    {{- printf "/bitmoa/scylladb/ca/%s" .Values.tls.certCAFilename -}}
{{- end -}}
{{- end -}}
