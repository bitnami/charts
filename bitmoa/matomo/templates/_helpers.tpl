...
- name: volume-permissions
  ...
  args:
    - -ec
    - |
      mkdir -p /bitmoa/matomo
      find /bitmoa/matomo -mindepth 0 -maxdepth 1 -not -name ".snapshot" -not -name "lost+found" | xargs -r chown -R {{ .Values.containerSecurityContext.runAsUser }}:{{ .Values.podSecurityContext.fsGroup }}
  securityContext:
    runAsUser: 0
