...
{{- end }}
  [ -f /opt/bitmoa/postgresql/tmp/.initialized ] || [ -f /bitmoa/postgresql/.initialized ]
{{- end -}}
...
{{- if .Values.tls.autoGenerated -}}
    {{- printf "/opt/bitmoa/postgresql/certs/tls.crt" -}}
{{- else -}}
    {{- required "Certificate filename is required when TLS in enabled" .Values.tls.certFilename | printf "/opt/bitmoa/postgresql/certs/%s" -}}
{{- end -}}
{{- end -}}
...
{{- if .Values.tls.autoGenerated -}}
    {{- printf "/opt/bitmoa/postgresql/certs/tls.key" -}}
{{- else -}}
{{- required "Certificate Key filename is required when TLS in enabled" .Values.tls.certKeyFilename | printf "/opt/bitmoa/postgresql/certs/%s" -}}
{{- end -}}
{{- end -}}
...
{{- if .Values.tls.autoGenerated -}}
    {{- printf "/opt/bitmoa/postgresql/certs/ca.crt" -}}
{{- else -}}
    {{- printf "/opt/bitmoa/postgresql/certs/%s" .Values.tls.certCAFilename -}}
{{- end -}}
{{- end -}}
...
{{- printf "/opt/bitmoa/postgresql/certs/%s" .Values.tls.crlFilename -}}
{{- end -}}
{{- end -}}
