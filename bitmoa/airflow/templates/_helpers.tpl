...
- name: AIRFLOW__CORE__FERNET_KEY_CMD
  value: "cat /opt/bitmoa/airflow/secrets/airflow-fernet-key"
{{- if (include "airflow.isImageMajorVersion3" .) }}
- name: AIRFLOW__API__SECRET_KEY_CMD
  value: "cat /opt/bitmoa/airflow/secrets/airflow-secret-key"
{{- else }}
...
- name: AIRFLOW__API_AUTH__JWT_SECRET_CMD
  value: "cat /opt/bitmoa/airflow/secrets/airflow-jwt-secret-key"
{{- end }}
{{- else }}
...
Ref: https://github.com/bitmoa/charts/pull/6096#issuecomment-856499047
*/}}
