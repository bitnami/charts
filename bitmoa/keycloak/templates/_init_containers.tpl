...
- name: prepare-write-dirs
  ...
  args:
    ...
    - |
      ...
      cp -r --preserve=mode,timestamps /opt/bitmoa/keycloak/lib/quarkus /emptydir/app-quarkus-dir
      cp -r --preserve=mode,timestamps /opt/bitmoa/keycloak/data /emptydir/app-data-dir
      cp -r --preserve=mode,timestamps /opt/bitmoa/keycloak/providers /emptydir/app-providers-dir
      cp -r --preserve=mode,timestamps /opt/bitmoa/keycloak/themes /emptydir/app-themes-dir
