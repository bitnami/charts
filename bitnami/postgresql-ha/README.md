...
| `postgresqlImage.tag`                           | PostgreSQL with Repmgr image tag                                                                                                                                                                              | `11.15.0-debian-10-r7`      |
...
| `postgresql.replicaCount`                       | Number of replicas to deploy. Use an odd number. Having 3 replicas is the minimun to get quorum when promoting a new primary.                                                                                 | `3`                         |
...
| `pgpoolImage.tag`                           | Pgpool image tag                                                                                                                         | `4.3.1-debian-10-r1` |
...
| `metricsImage.tag`                           | PostgreSQL Prometheus exporter image tag                                                                                                                  | `0.10.1-debian-10-r29`      |
...
| `volumePermissionsImage.tag`                  | Init container volume-permissions image tag         | `10-debian-10-r341`     |
