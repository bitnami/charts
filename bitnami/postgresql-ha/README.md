...
| `pgpool.customUsers.usernames`                 | List of comma or semicolon separeted list of postgres usernames to be added to pgpool_passwd                                                                         | `nil`                                                        |
| `pgpool.customUsers.passwords`                 | List of comma or semicolon separeted list of the associated passwords for the users to be added to pgpool_passwd                                                     | `nil`                                                        |
