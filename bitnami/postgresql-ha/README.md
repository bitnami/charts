...
| `postgresql.image.tag`                                         | PostgreSQL with Repmgr image tag                                                                                                                                                                              | `16.0.0-debian-11-r9`       |
...
| `pgpool.image.tag`                                         | Pgpool image tag                                                                                                                                | `4.4.4-debian-11-r43` |
...
| `metrics.image.tag`                              | PostgreSQL Prometheus exporter image tag                                                                                                                  | `0.14.0-debian-11-r12`      |
