...
| `postgresqlImage.tag`                           | PostgreSQL with Repmgr image tag                                                                                                                                                                              | `11.13.0-debian-10-r53`     |
...
| `pgpoolImage.tag`                           | Pgpool image tag                                                                                                   | `4.2.5-debian-10-r22` |
...
| `metricsImage.tag`                           | PostgreSQL Prometheus exporter image tag                                                                                                                  | `0.10.0-debian-10-r82`      |
...
| `metrics.service.port`                       | PostgreSQL Prometheus exporter metrics service HTTP port                                                                                                  | `9187`                      |
...
| `metrics.service.loadBalancerIP`             | PostgreSQL Prometheus exporter metrics service Load Balancer IP                                                                                           | `""`                        |
| `metrics.service.loadBalancerSourceRanges`   | PostgreSQL Prometheus exporter metrics service Load Balancer sources                                                                                      | `[]`                        |
| `metrics.service.externalTrafficPolicy`      | PostgreSQL Prometheus exporter metrics service external traffic policy                                                                                    | `Cluster`                   |
...
| `volumePermissionsImage.tag`                  | Init container volume-permissions image tag         | `10-debian-10-r214`     |
