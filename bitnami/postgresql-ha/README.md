...
| `postgresql.image.tag`                                       | PostgreSQL with Repmgr image tag                                                                                                                                                                              | `15.1.0-debian-11-r9`       |
...
| `pgpool.image.tag`                                       | Pgpool image tag                                                                                                                         | `4.4.0-debian-11-r0` |
...
| `metrics.image.tag`                          | PostgreSQL Prometheus exporter image tag                                                                                                                | `0.11.1-debian-11-r36`      |
