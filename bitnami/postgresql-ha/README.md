...
| `postgresql.image.tag`                                       | PostgreSQL with Repmgr image tag                                                                                                                                                                              | `15.3.0-debian-11-r2`       |
...
| `pgpool.image.tag`                                       | Pgpool image tag                                                                                                                         | `4.4.2-debian-11-r33` |
...
| `metrics.image.tag`                          | PostgreSQL Prometheus exporter image tag                                                                                                                  | `0.12.0-debian-11-r87`      |
