...
| `pgpool.loadBalancingOnWrite`                   | Specify load balance behavior after write queries appear ('off', 'transaction', 'trans_transaction', 'always'). Load-Balancing                                                                  | `transaction`                                                |
