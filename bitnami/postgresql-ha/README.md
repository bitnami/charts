...
| `postgresql.image.tag`                                         | PostgreSQL with Repmgr image tag                                                                                                                                                                              | `15.4.0-debian-11-r0`       |
...
| `pgpool.image.tag`                                         | Pgpool image tag                                                                                                                                | `4.4.3-debian-11-r72` |
...
| `metrics.image.tag`                              | PostgreSQL Prometheus exporter image tag                                                                                                                  | `0.13.2-debian-11-r15`      |
