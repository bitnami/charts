...
| `postgresql.image.tag`                                         | PostgreSQL with Repmgr image tag                                                                                                                                                                              | `15.4.0-debian-11-r40`      |
...
| `pgpool.image.tag`                                         | Pgpool image tag                                                                                                                                | `4.4.4-debian-11-r29` |
...
| `metrics.image.tag`                              | PostgreSQL Prometheus exporter image tag                                                                                                                  | `0.14.0-debian-11-r0`       |
