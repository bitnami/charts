...
| `postgresql.image.tag`                                         | PostgreSQL with Repmgr image tag                                                                                                                                                                              | `15.3.0-debian-11-r82`      |
...
| `pgpool.image.tag`                                         | Pgpool image tag                                                                                                                                | `4.4.3-debian-11-r69` |
...
| `metrics.image.tag`                              | PostgreSQL Prometheus exporter image tag                                                                                                                  | `0.13.2-debian-11-r12`      |
