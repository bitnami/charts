...
| `postgresql.image.tag`                                       | PostgreSQL with Repmgr image tag                                                                                                                                                                              | `14.5.0-debian-11-r28`      |
...
| `pgpool.image.tag`                                       | Pgpool image tag                                                                                                                         | `4.3.3-debian-11-r20` |
...
| `metrics.image.tag`                          | PostgreSQL Prometheus exporter image tag                                                                                                                | `0.11.1-debian-11-r20`      |
