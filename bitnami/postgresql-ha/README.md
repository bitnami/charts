...
| `postgresqlImage.tag`                           | PostgreSQL with Repmgr image tag                                                                                                                                                                              | `11.14.0-debian-10-r59`     |
...
| `pgpoolImage.tag`                           | Pgpool image tag                                                                                                                         | `4.3.0-debian-10-r1` |
...
| `metricsImage.tag`                           | PostgreSQL Prometheus exporter image tag                                                                                                                  | `0.10.0-debian-10-r176`     |
...
| `volumePermissionsImage.tag`                  | Init container volume-permissions image tag         | `10-debian-10-r308`     |
