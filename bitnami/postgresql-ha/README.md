...
| `postgresql.labels`                            | Map of labels to add to the statefulset                                                                                                                              | `{}`                                                         |
| `postgresql.podLabels`                         | Map of labels to add to the pods                                                                                                                                     | `{}`                                                         |
...
| `pgpool.labels`                                | Map of labels to add to the deployment                                                                                                                               | `{}`                                                         |
| `pgpool.podLabels`                             | Map of labels to add to the pods                                                                                                                                     | `{}`                                                         |
