...
| `postgresql.image.tag`                                       | PostgreSQL with Repmgr image tag                                                                                                                                                                              | `14.4.0-debian-11-r9`       |
...
| `pgpool.image.tag`                                       | Pgpool image tag                                                                                                                         | `4.3.2-debian-11-r14` |
...
| `metrics.image.tag`                          | PostgreSQL Prometheus exporter image tag                                                                                                                  | `0.10.1-debian-11-r14`      |
