...
| `backup.cronjob.extraVolumes`                                      | Extra volumes to add to the deployment                                                                                                | `[]`                                                                                                                                                                                 |
| `backup.cronjob.extraVolumeMounts`                                 | Extra volume mounts to add to the container. Normally used with `extraVolumes`                                                        | `[]`                                                                                                                                                                                 |
