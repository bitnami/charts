...
| `postgresql.image.tag`                                       | PostgreSQL with Repmgr image tag                                                                                                                                                                              | `14.2.0-debian-10-r70`      |
...
| `pgpool.image.tag`                                       | Pgpool image tag                                                                                                                         | `4.3.1-debian-10-r62` |
...
| `metrics.image.tag`                          | PostgreSQL Prometheus exporter image tag                                                                                                                  | `0.10.1-debian-10-r93`      |
...
| `volumePermissions.image.tag`                    | Init container volume-permissions image tag         | `10-debian-10-r406`     |
