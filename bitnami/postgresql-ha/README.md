...
| `postgresql.image.tag`                                       | PostgreSQL with Repmgr image tag                                                                                                                                                                              | `15.2.0-debian-11-r25`      |
...
| `postgresql.syncReplicationMode`                             | This specifies the method to choose synchronous standbys from the listed servers (empty, first, any).                                                                                                         | `''`                        |
...
| `pgpool.image.tag`                                       | Pgpool image tag                                                                                                                         | `4.4.2-debian-11-r26` |
...
| `metrics.image.tag`                          | PostgreSQL Prometheus exporter image tag                                                                                                                  | `0.12.0-debian-11-r80`      |
...
| `volumePermissions.image.tag`                    | Init container volume-permissions image tag                                                                                       | `11-debian-11-r109`     |
