...
| `postgresql.image.tag`                                       | PostgreSQL with Repmgr image tag                                                                                                                                                                              | `15.2.0-debian-11-r13`      |
...
| `pgpool.image.tag`                                       | Pgpool image tag                                                                                                                         | `4.4.2-debian-11-r16` |
...
| `metrics.image.tag`                          | PostgreSQL Prometheus exporter image tag                                                                                                                  | `0.11.1-debian-11-r69`      |
