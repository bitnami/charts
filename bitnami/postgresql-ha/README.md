...
| `witness.image.registry`                                     | PostgreSQL with Repmgr image registry                                                                                                                                                                         | `docker.io`                 |
| `witness.image.repository`                                   | PostgreSQL with Repmgr image repository                                                                                                                                                                       | `bitnami/postgresql-repmgr` |
| `witness.image.tag`                                          | PostgreSQL with Repmgr image tag                                                                                                                                                                              | `15.1.0-debian-11-r22`      |
| `witness.image.digest`                                       | PostgreSQL image digest in the way sha256:aa.... Please note this parameter, if set, will override the tag                                                                                                    | `""`                        |
| `witness.image.pullPolicy`                                   | PostgreSQL with Repmgr image pull policy                                                                                                                                                                      | `IfNotPresent`              |
| `witness.image.pullSecrets`                                  | Specify docker-registry secret names as an array                                                                                                                                                              | `[]`                        |
| `witness.image.debug`                                        | Specify if debug logs should be enabled                                                                                                                                                                       | `false`                     |
...
| `witness.repmgrFenceOldPrimary`                              | Set if fencing of old primary in multiple primary situation is desired                                                                                                                                        | `false`                     |
| `witness.repmgrChildNodesCheckInterval`                      | Repmgr child nodes check interval (in seconds)                                                                                                                                                                | `5`                         |
| `witness.repmgrChildNodesConnectedMinCount`                  | Repmgr minimum number of connected child nodes before being considered as failed primary for fencing                                                                                                          | `1`                         |
| `witness.repmgrChildNodesDisconnectTimeout`                  | Repmgr time before node will be fenced when insufficient child nodes are detected (in seconds)                                                                                                                | `30`                        |
...
| `witness.sharedPreloadLibraries`                             | Shared preload libraries (comma-separated list)                                                                                                                                                               | `pgaudit, repmgr`           |
...
| `witness.tls.enabled`                                        | Enable TLS traffic support for end-client connections                                                                                                                                                         | `false`                     |
| `witness.tls.preferServerCiphers`                            | Whether to use the server's TLS cipher preferences rather than the client's                                                                                                                                   | `true`                      |
| `witness.tls.certificatesSecret`                             | Name of an existing secret that contains the certificates                                                                                                                                                     | `""`                        |
| `witness.tls.certFilename`                                   | Certificate filename                                                                                                                                                                                          | `""`                        |
| `witness.tls.certKeyFilename`                                | Certificate key filename                                                                                                                                                                                      | `""`                        |
