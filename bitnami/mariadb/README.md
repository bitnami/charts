...
| `primary.startupProbe.failureThreshold`         | Failure threshold for startupProbe                                                                                | `3`             |
...
| `secondary.startupProbe.failureThreshold`         | Failure threshold for startupProbe                                                                                    | `3`             |
...
- `primary.service.port` renamed as `primary.service.ports.http`.
- `primary.service.nodePort` renamed as `primary.service.nodePorts.http`.
- `secondary.service.port` renamed as `secondary.service.ports.http`.
- `secondary.service.nodePort` renamed as `secondary.service.nodePorts.http`.
