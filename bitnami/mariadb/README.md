...
| `primary.persistentVolumeClaimRetentionPolicy.whenDeleted`  | What to do with the PVCs when the StatefulSet is deleted                                                                                                                                                                          | `{}`                |
| `primary.persistentVolumeClaimRetentionPolicy.whenScaled`   | What to do with the PVCs when the StatefulSet is scaled down                                                                                                                                                                      | `{}`                |
