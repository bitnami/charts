...
| `primary.persistentVolumeClaimRetentionPolicy.enabled`      | Enable Persistent volume retention policy for MariaDB secondary Statefulset                                                                                                                                                       | `false`             |
...
| `secondary.persistentVolumeClaimRetentionPolicy.enabled`      | Enable Persistent volume retention policy for MariaDB secondary Statefulset                                                                                                                                                           | `false`             |
