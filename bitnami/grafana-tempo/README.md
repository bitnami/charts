...
| `tempo.image.tag`                      | Grafana Tempo image tag (immutable tags are recommended)   | `1.0.1-debian-10-r45`         |
...
| `queryFrontend.query.image.tag`                          | Grafana Tempo Query image tag (immutable tags are recommended)                                          | `1.0.1-debian-10-r50`         |
...
| `vulture.image.tag`                          | Grafana Vulture image tag (immutable tags are recommended)                                        | `1.0.1-debian-10-r52`           |
