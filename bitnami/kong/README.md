...
| `image.tag`         | kong image tag (immutable tags are recommended)                                                      | `3.0.0-debian-11-r7` |
...
| `ingressController.image.tag`                                   | Kong Ingress Controller image tag                                                                                                             | `2.7.0-debian-11-r9`              |
...
| `postgresql.image.tag`                          | PostgreSQL image tag (immutable tags are recommended)                                                      | `15.0.0-debian-11-r0` |
