...
| `image.tag`         | kong image tag (immutable tags are recommended)                                                      | `2.8.1-debian-11-r49` |
...
| `ingressController.image.tag`                                   | Kong Ingress Controller image tag                                                                                                             | `2.5.0-debian-11-r24`             |
...
| `postgresql.image.tag`                          | PostgreSQL image tag (immutable tags are recommended)                                                      | `11.17.0-debian-11-r13` |
