...
| `image.tag`         | kong image tag (immutable tags are recommended)                                                      | `3.2.2-debian-11-r11` |
...
| `ingressController.image.tag`                                   | Kong Ingress Controller image tag                                                                                                             | `2.9.3-debian-11-r3`              |
...
| `postgresql.image.tag`                          | PostgreSQL image tag (immutable tags are recommended)                                                      | `14.7.0-debian-11-r26` |
