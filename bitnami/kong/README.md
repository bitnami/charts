...
| `image.tag`         | kong image tag (immutable tags are recommended)                                                      | `3.3.0-debian-11-r0` |
...
| `postgresql.image.tag`                          | PostgreSQL image tag (immutable tags are recommended)                                                      | `14.8.0-debian-11-r1` |
