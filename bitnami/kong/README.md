...
| `image.tag`         | kong image tag (immutable tags are recommended)                                                      | `3.3.0-debian-11-r10` |
...
| `ingressController.image.tag`                                   | Kong Ingress Controller image tag                                                                                                             | `2.10.0-debian-11-r4`             |
...
| `postgresql.image.tag`                          | PostgreSQL image tag (immutable tags are recommended)                                                      | `14.8.0-debian-11-r14` |
