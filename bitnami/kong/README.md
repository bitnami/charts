...
| `image.tag`         | kong image tag (immutable tags are recommended)                                                      | `3.3.1-debian-11-r28` |
...
| `ingressController.image.tag`                                   | Kong Ingress Controller image tag                                                                                                             | `2.11.0-debian-11-r0`             |
...
| `postgresql.image.tag`                          | PostgreSQL image tag (immutable tags are recommended)                                                      | `14.9.0-debian-11-r0` |
