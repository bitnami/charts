...
```console
helm install my-release my-repo/argo-workflowss
```
...
| `server.image.tag`                                       | server image tag (immutable tags are recommended)                                                                   | `3.4.2-scratch-r0`          |
...
| `controller.image.tag`                                       | controller image tag (immutable tags are recommended)                                                                         | `3.4.2-scratch-r0`                 |
...
| `executor.image.tag`                                       | executor image tag (immutable tags are recommended)                                                      | `3.4.2-debian-11-r0`         |
