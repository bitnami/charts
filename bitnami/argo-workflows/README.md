...
| `server.image.tag`                                       | server image tag (immutable tags are recommended)                                                                   | `3.4.6-scratch-r0`          |
...
| `controller.image.tag`                                       | controller image tag (immutable tags are recommended)                                                                         | `3.4.5-scratch-r7`                 |
...
| `executor.image.tag`                                       | executor image tag (immutable tags are recommended)                                                      | `3.4.5-debian-11-r17`        |
