...
| `server.image.tag`                                       | server image tag (immutable tags are recommended)                                                                   | `3.4.5-scratch-r0`          |
...
| `controller.image.tag`                                       | controller image tag (immutable tags are recommended)                                                                         | `3.4.4-scratch-r2`                 |
...
| `executor.image.tag`                                       | executor image tag (immutable tags are recommended)                                                      | `3.4.4-debian-11-r23`        |
