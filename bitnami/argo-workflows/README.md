...
| `server.image.tag`                                   | server image tag (immutable tags are recommended)                                                       | `v2`                 |
...
| `executor.image.tag`                  | executor image tag (immutable tags are recommended)           | `3.1.13-scratch-r1`          |
