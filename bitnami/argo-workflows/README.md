...
| `server.image.tag`                                       | server image tag (immutable tags are recommended)                                                                   | `3.4.10-debian-11-r0`       |
...
| `controller.image.tag`                                       | controller image tag (immutable tags are recommended)                                                                         | `3.4.10-debian-11-r4`              |
...
| `executor.image.tag`                                       | executor image tag (immutable tags are recommended)                                                      | `3.4.10-debian-11-r2`        |
