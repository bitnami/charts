...
| `server.image.tag`                                       | server image tag (immutable tags are recommended)                                                                   | `3.4.7-scratch-r4`          |
...
| `executor.image.tag`                                       | executor image tag (immutable tags are recommended)                                                      | `3.4.7-debian-11-r11`        |
