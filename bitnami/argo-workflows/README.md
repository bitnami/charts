...
| `server.image.tag`                                       | server image tag (immutable tags are recommended)                                                                   | `3.4.9-debian-11-r13`       |
...
| `controller.image.tag`                                       | controller image tag (immutable tags are recommended)                                                                         | `3.4.10-debian-11-r1`              |
...
| `executor.image.tag`                                       | executor image tag (immutable tags are recommended)                                                      | `3.4.10-debian-11-r0`        |
