...
### clusterOperator.logging RabbitMQ Cluster Operator logging configuration

| Name                                                          | Description                                                                                             | Value           |
| ------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------- | --------------- |
| `clusterOperator.logging.development`                         | Enable/disable development logging mode.                                                                | `false`         |
| `clusterOperator.logging.encoder`                             | Set the logging encoder. Allowed values: `json`, `console`                                              | `json`          |
| `clusterOperator.logging.logLevel`                            | Set the logging level. Allowed values: `error`, `warn`, `info`, `debug`                                 | `error`         |
| `clusterOperator.logging.stacktraceLevel`                     | Set the stacktrace log level. Allowed values: `error`, `warn`, `info`, `debug`                          | `error`         |
...
### msgTopologyOperator.logging RabbitMQ Message Topology Operator logging configuration

| Name                                                              | Description                                                                                                        | Value           |
| ----------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------ | --------------- |
| `msgTopologyOperator.logging.development`                         | Enable/disable development logging mode.                                                                           | `false`         |
| `msgTopologyOperator.logging.encoder`                             | Set the logging encoder. Allowed values: `json`, `console`                                                         | `json`          |
| `msgTopologyOperator.logging.logLevel`                            | Set the logging level. Allowed values: `error`, `warn`, `info`, `debug`                                            | `error`         |
| `msgTopologyOperator.logging.stacktraceLevel`                     | Set the stacktrace log level. Allowed values: `error`, `warn`, `info`, `debug`                                     | `error`         |
