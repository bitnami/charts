...
| `clusterOperator.watchNamespaces`                                   | Watch for resources in the given namespaces                                                                                              | `[]`                                             |
...
| `msgTopologyOperator.watchNamespaces`                                   | Watch for resources in the given namespaces                                                                                          | `[]`                                              |
