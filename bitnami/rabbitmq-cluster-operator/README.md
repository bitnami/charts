...
| `msgTopologyOperator.containerPorts.webhook`                          | RabbitMQ Messaging Topology Operator webhook port number                                                                             | `9443`                                    |
| `msgTopologyOperator.containerPorts.metrics`                          | RabbitMQ Messaging Topology Operator metrics port number                                                                             | `8080`                                    |
