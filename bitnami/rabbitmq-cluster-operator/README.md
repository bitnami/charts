...
| `msgTopologyOperator.dnsPolicy`                                       | Override default dnsPolicy                                                                                                           | `ClusterFirst`                            |
| `msgTopologyOperator.hostAliases`                                     | RabbitMQ Messaging Topology Operator pods host aliases                                                                               | `[]`                                      |
| `msgTopologyOperator.hostNetwork`                                     | RabbitMQ Messaging Topology Operator pods host Network                                                                               | `false`                                   |
