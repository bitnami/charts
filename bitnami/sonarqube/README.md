...
| `image.tag`         | SonarQube&trade; image tag (immutable tags are recommended)                                                      | `10.1.0-debian-11-r30` |
...
| `caCerts.image.tag`                          | OS Shell + Utility image tag (immutable tags are recommended)                                                      | `11-debian-11-r19` |
...
| `plugins.image.tag`                          | OS Shell + Utility image tag (immutable tags are recommended)                                                      | `11-debian-11-r19` |
