...
| `image.tag`         | SonarQube&trade; image tag (immutable tags are recommended)                                                      | `10.0.0-debian-11-r0` |
...
| `caCerts.image.tag`                          | Bitnami Shell image tag (immutable tags are recommended)                                                      | `11-debian-11-r107`     |
...
| `plugins.image.tag`                          | Bitnami Shell image tag (immutable tags are recommended)                                                      | `11-debian-11-r107`     |
...
| `metrics.jmx.image.tag`                             | JMX exporter image tag (immutable tags are recommended)                                                      | `0.18.0-debian-11-r11` |
