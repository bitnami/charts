...
| `postgresql.service.ports.postgresql`  | PostgreSQL service port for the Database                                           | `5432`              |
| `postgresql.persistence.enabled`       | Use PVCs when deploying the PostgreSQL chart                                       | `true`              |
| `postgresql.existingClaim`             | Use an existing PVC when deploying the PostgreSQL chart                            | `""`                |
