...
| `image.tag`         | SonarQube image tag (immutable tags are recommended) | `9.4.0-debian-10-r18` |
...
| `sysctl.image.tag`          | Bitnami Shell image tag (immutable tags are recommended) | `10-debian-10-r429`     |
