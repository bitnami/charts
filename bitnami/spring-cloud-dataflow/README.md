...
| `server.image.tag`                                  | Spring Cloud Dataflow image tag (immutable tags are recommended)                                                                           | `2.11.0-debian-11-r7`                                |
...
| `server.composedTaskRunner.image.tag`               | Spring Cloud Dataflow Composed Task Runner image tag (immutable tags are recommended)                                                      | `2.11.0-debian-11-r13`                               |
...
| `metrics.image.tag`                          | Prometheus Rsocket Proxy image tag (immutable tags are recommended)                                                        | `1.5.2-debian-11-r84`              |
...
| `waitForBackends.image.tag`          | Init container wait-for-backend image tag                                                                                       | `1.28.2-debian-11-r15` |
...
| `mariadb.image.tag`                       | MariaDB image tag (immutable tags are recommended)                                                      | `10.11.5-debian-11-r49` |
