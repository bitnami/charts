...
| `server.image.tag`                                  | Spring Cloud Dataflow image tag (immutable tags are recommended)                                                                           | `2.10.0-debian-11-r18`                               |
...
| `server.composedTaskRunner.image.tag`               | Spring Cloud Dataflow Composed Task Runner image tag (immutable tags are recommended)                                                      | `2.10.1-debian-11-r3`                                |
...
| `skipper.image.tag`                          | Spring Cloud Skipper image tag (immutable tags are recommended)                                                      | `2.9.1-debian-11-r2`           |
...
| `metrics.image.tag`                          | Prometheus Rsocket Proxy image tag (immutable tags are recommended)                                                        | `1.5.0-debian-11-r65`              |
...
| `waitForBackends.image.tag`          | Init container wait-for-backend image tag                                                                                       | `1.25.6-debian-11-r14` |
