...
| `image.tag`         | WordPress image tag (immutable tags are recommended) | `5.9.3-debian-10-r36`     |
...
| `volumePermissions.image.tag`                 | Bitnami Shell image tag (immutable tags are recommended)                                        | `10-debian-10-r418`     |
...
| `metrics.image.tag`                       | NGINX Prometheus exporter image tag (immutable tags are recommended)         | `0.10.0-debian-10-r133`  |
