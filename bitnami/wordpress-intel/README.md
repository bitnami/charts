...
| `image.tag`         | WordPress image tag (immutable tags are recommended)                                                      | `6.0.3-debian-11-r5`      |
...
| `metrics.image.tag`                       | NGINX Prometheus exporter image tag (immutable tags are recommended)                                                      | `0.11.0-debian-11-r16`   |
