...
| `image.tag`         | WordPress image tag (immutable tags are recommended)                                                      | `6.1.0-debian-11-r3`      |
...
| `metrics.image.tag`                       | NGINX Prometheus exporter image tag (immutable tags are recommended)                                                      | `0.11.0-debian-11-r18`   |
