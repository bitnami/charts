...
| `ingressClassResource.name`            | Name of the ingress class to route through this controller                                                                                         | `nginx`                            |
| `ingressClassResource.enabled`         | Create the IngressClass resource                                                                                                                   | `true`                             |
| `ingressClassResource.default`         | Set the created IngressClass as default IngressClass                                                                                               | `false`                            |
