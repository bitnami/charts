...
| `image.tag`                            | Nginx Ingress Controller image tag (immutable tags are recommended)                                                                                | `1.3.1-debian-11-r7`               |
...
| `defaultBackend.image.tag`                             | Default backend image tag (immutable tags are recommended)                                                      | `1.22.0-debian-11-r38` |
