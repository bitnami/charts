...
| `image.tag`                   | Nginx Ingress Controller image tag (immutable tags are recommended)                                                                                | `1.0.1-debian-10-r0`               |
...
| `defaultBackend.image.tag`                          | Default backend image tag (immutable tags are recommended)                                | `1.21.3-debian-10-r14` |
