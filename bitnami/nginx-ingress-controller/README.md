...
| `image.tag`                            | Nginx Ingress Controller image tag (immutable tags are recommended)                                                                                | `1.7.0-debian-11-r0`               |
...
| `defaultBackend.image.tag`                             | Default backend image tag (immutable tags are recommended)                                                      | `1.22.1-debian-11-r52` |
