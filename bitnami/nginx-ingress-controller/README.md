...
| `image.tag`                            | Nginx Ingress Controller image tag (immutable tags are recommended)                                                                                | `1.2.1-debian-10-r0`               |
...
| `defaultBackend.image.tag`                             | Default backend image tag (immutable tags are recommended)                                            | `1.21.6-debian-10-r123` |
