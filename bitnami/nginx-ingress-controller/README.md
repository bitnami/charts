...
| `image.tag`                            | Nginx Ingress Controller image tag (immutable tags are recommended)                                                                                | `1.8.1-debian-11-r44`              |
...
| `defaultBackend.image.tag`                             | Default backend image tag (immutable tags are recommended)                                                      | `1.25.2-debian-11-r0` |
