...
| `image.tag`          | NGINX image tag (immutable tags are recommended)                                                      | `0.4.7-debian-11-r34` |
...
| `cloneStaticSiteFromGit.image.tag`         | Git image tag (immutable tags are recommended)                                                      | `2.37.3-debian-11-r0` |
...
| `metrics.image.tag`                        | NGINX Prometheus exporter image tag (immutable tags are recommended)                                                      | `0.10.0-debian-11-r31`   |
