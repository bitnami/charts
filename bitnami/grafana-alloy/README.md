...
| `daemonsetAnnotations`                    | Annotations for Grafana Alloy daemonset                                                                                                        | `{}`            |
| `deploymentAnnotations`                   | Annotations for Grafana Alloy deployment                                                                                                       | `{}`            |
| `statefulsetAnnotations`                  | Annotations for Grafana Alloy statefulset                                                                                                      | `{}`            |
...
| `alloy.resourceType`                                      | Type of controller to use for deploying Grafana Alloy in the cluster.                                                                                                                                                                | `daemonset`                     |
| `alloy.replicaCount`                                      | Number of pods to deploy. Ignored when alloy.resourceType is 'daemonset'.                                                                                                                                                            | `1`                             |
...
| `alloy.mounts.dockercontainers`                           | Mount /var/lib/docker/containers from the host into the container for log                                                                                                                                                            | `false`                         |
...
| `alloy.extraVolumes`                                      | Optionally specify extra list of additional volumes for the Grafana Alloy pods                                                                                                                                                       | `[]`                            |
...
| `configReloader.extraVolumes`                                      | Optionally specify extra list of additional volumes for the extraEnvVarsSecret pods                                                                                                                                                                       | `[]`                                       |
...
| `service.ports.https`                   | Grafana Alloy service HTTPS port                                                                                                 | `443`          |
