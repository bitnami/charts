...
| `discourse.containerSecurityContext.capabilities.add`         | List of capabilities to be added                                                                                                                                                                                               | `["CHOWN","CHMOD","FOWNER","SETGID","SETUID","DAC_OVERRIDE"]` |
...
| `sidekiq.containerSecurityContext.capabilities.add`         | List of capabilities to be added                                                                                                                                                                                           | `["CHOWN","CHMOD","FOWNER","SETGID","SETUID","DAC_OVERRIDE"]` |
