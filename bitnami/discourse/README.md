...
Looking to use Discourse## Prerequisitesreg; in production? Try [VMware Application Catalog](https://bitnami.com/enterprise), the enterprise edition of Bitnami Application Catalog.
...
| `image.tag`                     | Discourse image tag                                                                                                      | `3.0.3-debian-11-r11` |
