...
| `hub.image.tag`                             | Hub image tag (immutabe tags are recommended)                                             | `1.4.2-debian-10-r16` |
...
| `proxy.image.tag`                             | Proxy image tag (immutable tags are recommended)                                          | `4.5.0-debian-10-r14`             |
...
| `singleuser.image.tag`                          | Single User image tag (immutabe tags are recommended)                                               | `1.4.1-debian-10-r82`                |
...
| `auxiliaryImage.tag`         | Auxiliary image tag (immutabe tags are recommended) | `10-debian-10-r151`     |
