...
| `hub.image.tag`                             | Hub image tag (immutable tags are recommended)                                                                           | `1.5.0-debian-11-r34` |
...
| `proxy.image.tag`                             | Proxy image tag (immutable tags are recommended)                                                                         | `4.5.2-debian-11-r5`              |
...
| `singleuser.image.tag`                          | Single User image tag (immutabe tags are recommended)                                                       | `1.5.0-debian-11-r35`                |
...
| `auxiliaryImage.tag`         | Auxiliary image tag (immutabe tags are recommended)                                                       | `11-debian-11-r32`      |
