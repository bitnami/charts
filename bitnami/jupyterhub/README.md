...
| `hub.image.tag`                             | Hub image tag (immutable tags are recommended)                                                                           | `3.0.0-debian-11-r20` |
...
| `proxy.image.tag`                             | Proxy image tag (immutable tags are recommended)                                                                         | `4.5.3-debian-11-r25`             |
...
| `singleuser.image.tag`                          | Single User image tag (immutabe tags are recommended)                                                       | `3.0.0-debian-11-r20`                |
...
| `auxiliaryImage.tag`         | Auxiliary image tag (immutabe tags are recommended)                                                       | `11-debian-11-r55`      |
