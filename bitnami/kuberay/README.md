...
| `operator.autoscaling.enabled`                               | Enable autoscaling for operator                                                                                                                             | `false`                            |
| `operator.autoscaling.minReplicas`                           | Minimum number of operator replicas                                                                                                                         | `""`                               |
| `operator.autoscaling.maxReplicas`                           | Maximum number of operator replicas                                                                                                                         | `""`                               |
| `operator.autoscaling.targetCPU`                             | Target CPU utilization percentage                                                                                                                           | `""`                               |
| `operator.autoscaling.targetMemory`                          | Target Memory utilization percentage                                                                                                                        | `""`                               |
...
| `apiserver.autoscaling.enabled`                               | Enable autoscaling for operator                                                                                                                               | `false`                             |
| `apiserver.autoscaling.minReplicas`                           | Minimum number of operator replicas                                                                                                                           | `""`                                |
| `apiserver.autoscaling.maxReplicas`                           | Maximum number of operator replicas                                                                                                                           | `""`                                |
| `apiserver.autoscaling.targetCPU`                             | Target CPU utilization percentage                                                                                                                             | `""`                                |
| `apiserver.autoscaling.targetMemory`                          | Target Memory utilization percentage                                                                                                                          | `""`                                |
