...
| `image.tag`                   | Memcached image tag (immutable tags are recommended)                                                      | `1.6.21-debian-11-r0` |
...
| `volumePermissions.image.tag`                          | Init container volume-permissions image tag (immutable tags are recommended)                                                      | `11-debian-11-r126`          |
...
| `metrics.image.tag`                                    | Memcached exporter image tag (immutable tags are recommended)                                                                     | `0.13.0-debian-11-r4`        |
