...
| `image.tag`                   | Memcached image tag (immutable tags are recommended)                                                      | `1.6.21-debian-11-r58` |
...
| `metrics.image.tag`                                    | Memcached exporter image tag (immutable tags are recommended)                                                                     | `0.13.0-debian-11-r71`       |
