...
| `milvus.image.tag`                                          | Milvus image tag (immutable tags are recommended)                                                                                                   | `2.2.14-debian-11-r37` |
...
| `attu.image.tag`                                         | Attu image tag (immutable tags are recommended)                                                      | `2.3.1-debian-11-r22` |
