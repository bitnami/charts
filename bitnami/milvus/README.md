...
| `milvus.auth.rootOldPassword`                  | Milvus old root password, default is Milvus                                                                                                         | `Milvus`                   |
| `milvus.auth.rootNewPassword`                  | Milvus new root password, used for initJob to change root password                                                                                  | `""`                       |
...
| `milvus.auth.existingSecretRootOldPasswordKey` | Name of the secret key containing the Milvus root old password                                                                                      | `""`                       |
| `milvus.auth.existingSecretRootNewPasswordKey` | Name of the secret key containing the Milvus root new password                                                                                      | `""`                       |
...
| `queryNode.resourcesPreset`                                   | Set container resources according to one common preset (allowed values: none, nano, small, medium, large, xlarge, 2xlarge). This is ignored if queryNode.resources is set (queryNode.resources is recommended for production). | `none`           |
...
| `indexNode.resourcesPreset`                                   | Set container resources according to one common preset (allowed values: none, nano, small, medium, large, xlarge, 2xlarge). This is ignored if indexNode.resources is set (indexNode.resources is recommended for production). | `none`           |
...
| `attu.resourcesPreset`                                   | Set container resources according to one common preset (allowed values: none, nano, small, medium, large, xlarge, 2xlarge). This is ignored if attu.resources is set (attu.resources is recommended for production). | `none`                 |
