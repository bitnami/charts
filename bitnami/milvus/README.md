...
| `milvus.image.tag`                                          | Milvus image tag (immutable tags are recommended)                                                                                                   | `2.2.14-debian-11-r2` |
...
| `initJob.image.tag`                                         | PyMilvus image tag (immutable tags are recommended)                                                                                                 | `2.3.0-debian-11-r2`  |
...
| `attu.image.tag`                                         | Attu image tag (immutable tags are recommended)                                                      | `2.2.8-debian-11-r17` |
...
| `waitContainer.image.tag`                                         | Init container wait-container image tag                                                                                       | `11-debian-11-r48` |
