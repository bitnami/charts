...
### Mix Coordinator Deployment Parameters

| Name                                                            | Description                                                                                                                                                                                                                               | Value            |
| --------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------- |
| `coordinator.enabled`                                           | Enable Mix Coordinator deployment                                                                                                                                                                                                         | `true`           |
| `coordinator.extraEnvVars`                                      | Array with extra environment variables to add to data coordinator nodes                                                                                                                                                                   | `[]`             |
| `coordinator.extraEnvVarsCM`                                    | Name of existing ConfigMap containing extra env vars for data coordinator nodes                                                                                                                                                           | `""`             |
| `coordinator.extraEnvVarsSecret`                                | Name of existing Secret containing extra env vars for data coordinator nodes                                                                                                                                                              | `""`             |
...
| `coordinator.extraConfigExistingConfigMap`                      | name of a ConfigMap with existing configuration for the Dashboard                                                                                                                                                                         | `""`             |
...
| `coordinator.replicaCount`                                      | Number of Mix Coordinator replicas to deploy                                                                                                                                                                                              | `1`              |
| `coordinator.containerPorts.grpc`                               | GRPC port for Mix Coordinator                                                                                                                                                                                                             | `19530`          |
| `coordinator.containerPorts.metrics`                            | Metrics port for Mix Coordinator                                                                                                                                                                                                          | `9091`           |
| `coordinator.livenessProbe.enabled`                             | Enable livenessProbe on Mix Coordinator nodes                                                                                                                                                                                             | `true`           |
...
| `coordinator.readinessProbe.enabled`                            | Enable readinessProbe on Mix Coordinator nodes                                                                                                                                                                                            | `true`           |
...
| `coordinator.startupProbe.enabled`                              | Enable startupProbe on Mix Coordinator containers                                                                                                                                                                                         | `false`          |
...
| `coordinator.podSecurityContext.enabled`                        | Enabled Mix Coordinator pods' Security Context                                                                                                                                                                                            | `true`           |
...
| `coordinator.podSecurityContext.fsGroup`                        | Set Mix Coordinator pod's Security Context fsGroup                                                                                                                                                                                        | `1001`           |
...
| `coordinator.lifecycleHooks`                                    | for the data coordinator container(s) to automate configuration before or after startup                                                                                                                                                   | `{}`             |
...
| `coordinator.hostAliases`                                       | data coordinator pods host aliases                                                                                                                                                                                                        | `[]`             |
| `coordinator.podLabels`                                         | Extra labels for data coordinator pods                                                                                                                                                                                                    | `{}`             |
| `coordinator.podAnnotations`                                    | Annotations for data coordinator pods                                                                                                                                                                                                     | `{}`             |
| `coordinator.podAffinityPreset`                                 | Pod affinity preset. Ignored if `data coordinator.affinity` is set. Allowed values: `soft` or `hard`                                                                                                                                      | `""`             |
| `coordinator.podAntiAffinityPreset`                             | Pod anti-affinity preset. Ignored if `data coordinator.affinity` is set. Allowed values: `soft` or `hard`                                                                                                                                 | `soft`           |
| `coordinator.nodeAffinityPreset.type`                           | Node affinity preset type. Ignored if `data coordinator.affinity` is set. Allowed values: `soft` or `hard`                                                                                                                                | `""`             |
| `coordinator.nodeAffinityPreset.key`                            | Node label key to match. Ignored if `data coordinator.affinity` is set                                                                                                                                                                    | `""`             |
| `coordinator.nodeAffinityPreset.values`                         | Node label values to match. Ignored if `data coordinator.affinity` is set                                                                                                                                                                 | `[]`             |
| `coordinator.affinity`                                          | Affinity for Mix Coordinator pods assignment                                                                                                                                                                                              | `{}`             |
| `coordinator.nodeSelector`                                      | Node labels for Mix Coordinator pods assignment                                                                                                                                                                                           | `{}`             |
| `coordinator.tolerations`                                       | Tolerations for Mix Coordinator pods assignment                                                                                                                                                                                           | `[]`             |
...
| `coordinator.priorityClassName`                                 | Mix Coordinator pods' priorityClassName                                                                                                                                                                                                   | `""`             |
| `coordinator.schedulerName`                                     | Kubernetes pod scheduler registry                                                                                                                                                                                                         | `""`             |
| `coordinator.updateStrategy.type`                               | Mix Coordinator statefulset strategy type                                                                                                                                                                                                 | `RollingUpdate`  |
| `coordinator.updateStrategy.rollingUpdate`                      | Mix Coordinator statefulset rolling update configuration parameters                                                                                                                                                                       | `{}`             |
| `coordinator.extraVolumes`                                      | Optionally specify extra list of additional volumes for the Mix Coordinator pod(s)                                                                                                                                                        | `[]`             |
| `coordinator.extraVolumeMounts`                                 | Optionally specify extra list of additional volumeMounts for the Mix Coordinator container(s)                                                                                                                                             | `[]`             |
| `coordinator.sidecars`                                          | Add additional sidecar containers to the Mix Coordinator pod(s)                                                                                                                                                                           | `[]`             |
| `coordinator.enableDefaultInitContainers`                       | Deploy default init containers                                                                                                                                                                                                            | `true`           |
| `coordinator.initContainers`                                    | Add additional init containers to the Mix Coordinator pod(s)                                                                                                                                                                              | `[]`             |
| `coordinator.serviceAccount.create`                             | Enable creation of ServiceAccount for Mix Coordinator pods                                                                                                                                                                                | `true`           |
...
### Mix Coordinator Autoscaling configuration
...
| `coordinator.autoscaling.hpa.enabled`                 | Enable HPA for Milvus Data Plane                                                                                                                                       | `false` |
| `coordinator.autoscaling.hpa.annotations`             | Annotations for HPA resource                                                                                                                                           | `{}`    |
| `coordinator.autoscaling.hpa.minReplicas`             | Minimum number of Milvus Data Plane replicas                                                                                                                           | `""`    |
| `coordinator.autoscaling.hpa.maxReplicas`             | Maximum number of Milvus Data Plane replicas                                                                                                                           | `""`    |
...
### Mix Coordinator Traffic Exposure Parameters

| Name                                                | Description                                                      | Value       |
| --------------------------------------------------- | ---------------------------------------------------------------- | ----------- |
| `coordinator.service.type`                          | Mix Coordinator service type                                     | `ClusterIP` |
| `coordinator.service.ports.grpc`                    | Mix Coordinator GRPC service port                                | `19530`     |
| `coordinator.service.ports.metrics`                 | Mix Coordinator Metrics service port                             | `9091`      |
| `coordinator.service.nodePorts.grpc`                | Node port for GRPC                                               | `""`        |
...
| `coordinator.service.clusterIP`                     | Mix Coordinator service Cluster IP                               | `""`        |
| `coordinator.service.loadBalancerIP`                | Mix Coordinator service Load Balancer IP                         | `""`        |
| `coordinator.service.loadBalancerSourceRanges`      | Mix Coordinator service Load Balancer sources                    | `[]`        |
| `coordinator.service.externalTrafficPolicy`         | Mix Coordinator service external traffic policy                  | `Cluster`   |
| `coordinator.service.annotations`                   | Additional custom annotations for Mix Coordinator service        | `{}`        |
| `coordinator.service.extraPorts`                    | Extra ports to expose in the Mix Coordinator service             | `[]`        |
...
### Mix Coordinator Metrics Parameters
...
| `streamingNode.extraConfigExistingConfigMap`                      | name of a ConfigMap with existing configuration for the Dashboard                                                                                                                                                                             | `""`             |
...
| `streamingNode.autoscaling.hpa.enabled`                 | Enable HPA for Milvus Data Plane                                                                                                                                       | `false` |
| `streamingNode.autoscaling.hpa.annotations`             | Annotations for HPA resource                                                                                                                                           | `{}`    |
| `streamingNode.autoscaling.hpa.minReplicas`             | Minimum number of Milvus Data Plane replicas                                                                                                                           | `""`    |
| `streamingNode.autoscaling.hpa.maxReplicas`             | Maximum number of Milvus Data Plane replicas                                                                                                                           | `""`    |
