...
| `milvus.image.tag`                                          | Milvus image tag (immutable tags are recommended)                                                                                                   | `2.2.10-debian-11-r7` |
...
| `initJob.image.tag`                                         | PyMilvus image tag (immutable tags are recommended)                                                                                                 | `2.2.13-debian-11-r3` |
...
| `attu.image.tag`                                         | Attu image tag (immutable tags are recommended)                                                      | `2.2.7-debian-11-r2` |
...
| `waitContainer.image.tag`                                         | Init container wait-container image tag                                                                                       | `11-debian-11-r133`     |
