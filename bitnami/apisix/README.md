...
| `image.tag`              | APISIX image tag (immutable tags are recommended)                                                                                                 | `3.4.0-debian-11-r0` |
...
| `dashboard.image.tag`                                         | APISIX Dashboard image tag (immutable tags are recommended)                                                                                                 | `3.0.1-debian-11-r18`      |
...
| `ingressController.image.tag`                                         | APISIX Ingress Controller image tag (immutable tags are recommended)                                                                                                 | `1.6.1-debian-11-r18`               |
...
| `waitContainer.image.tag`                                         | Init container wait-container image tag                                                                                       | `11-debian-11-r131`     |
