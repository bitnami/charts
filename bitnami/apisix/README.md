...
| `image.tag`              | APISIX image tag (immutable tags are recommended)                                                                                                 | `3.6.0-debian-11-r2` |
...
| `dashboard.image.tag`                                         | APISIX Dashboard image tag (immutable tags are recommended)                                                                                                 | `3.0.1-debian-11-r133`     |
...
| `ingressController.image.tag`                                         | APISIX Ingress Controller image tag (immutable tags are recommended)                                                                                                 | `1.7.0-debian-11-r13`               |
