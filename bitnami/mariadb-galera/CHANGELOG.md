...
* [bitnami/mariadb-galera] :zap: :arrow_up: Update dependency references ([#34625](https://github.com/bitnami/charts/pull/34625))
...
* [bitnami/mariadb-galera] Release 3.0.2 updating components versions ([5e4a890](https://github.com/bitnami/charts/commit/5e4a89043edd47bbce2f0e799240091f6829e6ca))
...
* [bitnami/mariadb-galera] Release 2.0.3 updating components versions ([042ebc0](https://github.com/bitnami/charts/commit/042ebc074406c3fcf95bd4316b5e9dedd6296b06))
...
* [bitnami/mariadb-galera] Release 0.6.2 updating components versions ([e3433ff](https://github.com/bitnami/charts/commit/e3433ff78798cb35fc3d4a417fedf828b76c4428))

## <small>0.6.1 (2019-12-31)</small>

* 'nil' to Default description ([7018997](https://github.com/bitnami/charts/commit/70189973e398e2e3637b47ddf7ffb0df8145280f))
* [mariadb-galera] readme fixes ([e4c422c](https://github.com/bitnami/charts/commit/e4c422cdeb599367878dde183ed3543d43ba6284)), closes [#1789](https://github.com/bitnami/charts/issues/1789)

## 0.6.0 (2019-12-26)

* Added extraVolumes and extraVolumeMounts ([2f4736a](https://github.com/bitnami/charts/commit/2f4736a05a41ebceb70e8fdd001861eae7e93156))

## <small>0.5.6 (2019-12-19)</small>

* [bitnami/mariadb-galera] Release 0.5.6 updating components versions ([ba7b512](https://github.com/bitnami/charts/commit/ba7b51224578e8d4aeffa4053cf452ad2eec5283))

## <small>0.5.5 (2019-12-18)</small>

* [bitnami/mariadb-galera] Release 0.5.5 updating components versions ([4a7200b](https://github.com/bitnami/charts/commit/4a7200b0fafe17ac86e1c4f7decc910352a6002a))

## <small>0.5.4 (2019-12-12)</small>

* [bitnami/mariadb-galera] Release 0.5.4 updating components versions ([c967b6b](https://github.com/bitnami/charts/commit/c967b6b1a13f593c37a7f498a5f17c7fa9e56b61))

## <small>0.5.3 (2019-12-08)</small>

* [bitnami/mariadb-galera] Release 0.5.3 updating components versions ([5b44cb2](https://github.com/bitnami/charts/commit/5b44cb2291fb4e2b53585f43af04064f306c243b))

## <small>0.5.2 (2019-11-20)</small>

* [bitnami/mariadb-galera] Lint chart ([1fc6f72](https://github.com/bitnami/charts/commit/1fc6f72b921b78bfe206d8b0595e0508eb656a13))

## <small>0.5.1 (2019-11-08)</small>

* [bitnami/mariadb-galera] Release 0.5.1 updating components versions ([6c3d74d](https://github.com/bitnami/charts/commit/6c3d74d438152a1ccb4ec399d2a207b23fe44885))

## 0.5.0 (2019-10-31)

* add `plugin_dir` configuration to the mariadbConfiguration ([9a10098](https://github.com/bitnami/charts/commit/9a10098246ed3e5baa11b56d0277789a8c1faa84))
* add note about `.extraFlags` parameter ([7db0a42](https://github.com/bitnami/charts/commit/7db0a42ad0e84a1586250b45fe3f80df07df2f09))
* bump chart version ([38f5cd4](https://github.com/bitnami/charts/commit/38f5cd4407a69db496708e46afd370f7dd26f9de))
...
* [bitnami/mariadb-galera] Release 0.4.1 updating components versions ([ef982ea](https://github.com/bitnami/charts/commit/ef982ea23bb62ebf3aefba7a685875677600292d))

## 0.4.0 (2019-10-10)

* bump minor version of chart ([7231810](https://github.com/bitnami/charts/commit/723181009b48e2309a6cee32c8f851d5751c79f3))

## <small>0.3.1 (2019-10-10)</small>

* [bitnami/mariadb-galera] adds `clusterDomain` chart parameter ([cd09cec](https://github.com/bitnami/charts/commit/cd09cecfeeba70de37f6c7a785b035f16c19a7d4)), closes [#1459](https://github.com/bitnami/charts/issues/1459)
* [bitnami/mariadb-galera] Support json values in extraInitContainers ([f8bc51b](https://github.com/bitnami/charts/commit/f8bc51bef8d5cca699f8e9ffb9636dfc89d6dd2a))
* fixup! [bitnami/mariadb-galera] Allow to set additional containers ([68b1e14](https://github.com/bitnami/charts/commit/68b1e144d2966659ad8062397bc6e7dd136f06f1))
* fixup! fixup! [bitnami/mariadb-galera] Allow to set additional containers ([7e870c6](https://github.com/bitnami/charts/commit/7e870c621bfe5121fbdf31241ff6aebc6771f3cf))

## 0.3.0 (2019-09-30)

* [bitnami/mariadb-galera] Allow to set additional containers ([be912f6](https://github.com/bitnami/charts/commit/be912f66b1b436646a1b6ad3bd27e86888a7c4ce))
...
* [bitnami/mariadb-galera] Fix mariadb-galera.serviceAccountName function ([7584c84](https://github.com/bitnami/charts/commit/7584c841fcec119c350083ddf85e9f06d963d4f1))

## <small>0.2.6 (2019-09-11)</small>

* [bitnami/mariadb-galera] Release 0.2.6 updating components versions ([99af233](https://github.com/bitnami/charts/commit/99af233dbe43ffe42a50bf2ad8c3526df18402c4))

## <small>0.2.5 (2019-09-06)</small>

* [bitnami/mariadb-galera] fix annotations example ([9bfabf6](https://github.com/bitnami/charts/commit/9bfabf6f5de08550f124cf64776f36eb540e5e0d))

## <small>0.2.4 (2019-09-05)</small>

* [bitnami/mariadb-galera] Release 0.2.4 updating components versions ([829d441](https://github.com/bitnami/charts/commit/829d44114160510a85b4027cb2fd92d3e7ae6264))
...
* Bump mariadb-galera version ([c8a1a28](https://github.com/bitnami/charts/commit/c8a1a286b7cdcced0eacc4d3cd4502616522d815))
...
* Fix 'secret.yaml' definition ([f668e2d](https://github.com/bitnami/charts/commit/f668e2da29c2434f6896e696ab8b409c1e2fde2f))
* Update charts versions ([9459dbb](https://github.com/bitnami/charts/commit/9459dbbf98c5572f0b92cd3eef8e12ec83a48397))

## 0.1.0 (2019-08-15)

* [bitnami/mariadb-galera] Update LDAP configuration ([46cb01f](https://github.com/bitnami/charts/commit/46cb01fe0926ccb08f39fe40025116cc8218e8cb))
* Add validations for LDAP & password parameters ([49f775f](https://github.com/bitnami/charts/commit/49f775fdd4457d51f967adf42ba34a6fdef164fe))
* Bump minor version and remove unnecesary backslashes ([cc1bc37](https://github.com/bitnami/charts/commit/cc1bc37b78837019bf2ead4d0f6db82b508e85b5))
* Mode default to values ([b6515ab](https://github.com/bitnami/charts/commit/b6515ab7708987f2364f37925615ef0763d10727))

## <small>0.0.2 (2019-08-13)</small>

* Refactor based on best-practices for charts ([ae8dac1](https://github.com/bitnami/charts/commit/ae8dac12063077a86052d7f97b9aaf32bc0cef4b))
* Update README.md ([c80bd5c](https://github.com/bitnami/charts/commit/c80bd5cf43008b4ddb5bbc0ab550b1396ba0bdef))
* Updated version numbers ([aa0294b](https://github.com/bitnami/charts/commit/aa0294b246340ed44d76f8cac59338ee685fab5e))
* Use 'debian' tags for exporters ([ead58bd](https://github.com/bitnami/charts/commit/ead58bd7fe5c9ddac50a77541bf7c6b3cf1107df))

## <small>0.0.1 (2019-08-12)</small>

* [bitnami/mariadb-galera] new chart for MariaDB Galera Deployment ([1a48333](https://github.com/bitnami/charts/commit/1a48333df85c03d576f357bc82d179e908a2dd2f))
