...
| `image.tag`                                | MariaDB Galera image tag (immutable tags are recommended)                                                                                                                                     | `10.6.4-debian-10-r30`    |
...
| `metrics.image.tag`                        | MariaDB Prometheus exporter image tag (immutable tags are recommended)                                                                                                                        | `0.13.0-debian-10-r136`   |
