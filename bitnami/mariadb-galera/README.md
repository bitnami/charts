...
| `image.tag`                                   | MariaDB Galera image tag (immutable tags are recommended)                                                                                                                                     | `11.1.2-debian-11-r0`     |
...
| `metrics.image.tag`                           | MariaDB Prometheus exporter image tag (immutable tags are recommended)                                                                                                                        | `0.15.0-debian-11-r70`    |
