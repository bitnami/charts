...
| Name                                                        | Description                                                                                                                                                                                                                       | Value               |
| ----------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------- |
| `primary.replicaCount`                                      | Number of MySQL Primary replicas to deploy. Only 0 or 1 is supported, since a MySQL Primary cannot be horizontally scaled the way secondaries can                                                                                 | `1`                 |
