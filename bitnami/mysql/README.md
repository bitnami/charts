...
| Parameter                    | Description                                            | Default                                              |
|------------------------------|--------------------------------------------------------|------------------------------------------------------|
| `primary.networkPolicy.enabled`                       | Enable MySQL primary NetworkPolicy                                                                                                                                                                                                                                                                                                                                                                                                                                                       | `false`                                                       |
| `primary.networkPolicy.allowExternal`                 | Don't require client label for MySQL primary connections                                                                                                                                                                                                                                                                                                                                                                                                                                 | `true`                                                        |
| `primary.networkPolicy.explicitNamespacesSelector`    | A Kubernetes LabelSelector to explicitly select namespaces from which ingress traffic could be allowed to MySQL primary                                                                                                                                                                                                                                                                                                                                                                     | `{}`                                                          |
