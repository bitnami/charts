...
| Name                                                        | Description                                                                                                                                                                                                                       | Value               |
| ----------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------- |
| `primary.replicaCount`                                      | Number of MySQL Primary replicas to deploy. Set to 0 to scale down without deleting the StatefulSet/PVC (e.g. to save costs in non-production environments)                                                                       | `1`                 |
