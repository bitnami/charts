...
| `image.tag`                                   | Thanos image tag (immutable tags are recommended)                                                                   | `0.31.0-debian-11-r14` |
...
| `storegateway.autoscaling.behavior`                              | HPA Behavior                                                                                                                             | `{}`                        |
...
| `ruler.autoscaling.behavior`                              | HPA Behavior                                                                                                                     | `{}`                     |
...
| `receive.autoscaling.behavior`                              | HPA Behavior                                                                                                                     | `{}`                     |
...
| `receiveDistributor.autoscaling.behavior`                              | HPA Behavior                                                                                                                | `{}`            |
