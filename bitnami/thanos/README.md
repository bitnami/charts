...
| `image.tag`                                   | Thanos image tag (immutable tags are recommended)                                                                   | `0.31.0-scratch-r1` |
...
| `ruler.query_url`                                         | Thanos query/query-frontend URL to link in Ruler UI.                                                                             | `http://thanos-query:9090` |
