...
| `query.grpc.server.tls.existingSecret`                    | Existing secret containing your own TLS certificates. In the case that they are not named ca-cert, tls-cert and tls-key you will need to use the keyMapping accordingly. | `{}`                     |
...
| `query.grpc.client.tls.existingSecret`                    | Existing secret containing your own TLS certificates. In the case that they are not named ca-cert, tls-cert and tls-key you will need to use the keyMapping accordingly. | `{}`                     |
