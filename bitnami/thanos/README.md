...
| `metrics.runbookUrl`                                                                    | Prefix for runbook URLs. Use this to override the first part of the runbookURLs that is common to all rules                                                   | `https://github.com/thanos-io/thanos/tree/main/mixin/runbook.md#alert-name-` |
