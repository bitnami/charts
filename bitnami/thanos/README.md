...
| `ruler.alertmanagersConfig`                   | Alertmanager Configuration passed directly to the ruler                                                      | `""`                           |
| `ruler.alertmanagersConfigFile`               | Name of the file containing alertmanager configuration                                                       | `""`                           |
