...
| `image.tag`                                   | Thanos image tag (immutable tags are recommended)                                                                   | `0.30.2-scratch-r4` |
...
| `metrics.serviceMonitor.extraParameters`                                                | Specify additional parameters of the endpoint (e.g. tlsConfig)                                                                                                                           | `{}`    |
