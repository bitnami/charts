...
| `tls.client.keystoreSecretKey`           | The secret key from the existingSecret if 'keystoreSecretKey' key different from the default (zookeeper.keystore.jks)             | `zookeeper.keystore.jks`                                              |
| `tls.client.truststoreSecretKey`         | The secret key from the existingSecret if 'truststoreSecretKey' key different from the default (zookeeper.truststore.jks)         | `zookeeper.truststore.jks`                                            |
...
| `tls.quorum.keystoreSecretKey`           | The secret key from the existingSecret if 'keystoreSecretKey' key different from the default (zookeeper.keystore.jks)             | `zookeeper.keystore.jks`                                              |
| `tls.quorum.truststoreSecretKey`         | The secret key from the existingSecret if 'truststoreSecretKey' key different from the default (zookeeper.truststore.jks)         | `zookeeper.truststore.jks`                                            |
