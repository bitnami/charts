...
| `image.tag`                 | ZooKeeper image tag (immutable tags are recommended)                                                                       | `3.7.0-debian-10-r242`  |
...
| `resources.requests`                    | The requested resources for the ZooKeeper containers                                                                                                                                              | `{}`            |
...
| `volumePermissions.image.tag`                          | Init container volume-permissions image tag (immutable tags are recommended)    | `10-debian-10-r289`     |
