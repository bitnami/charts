...
| `tls.client.existingSecretKeystoreKey`    | The secret key from the tls.client.existingSecret.                                              | `""`                                                                  |
| `tls.client.existingSecretTruststoreKey`  | The secret key from the tls.client.existingSecret.                                              | `""`                                                                  |
...
| `tls.client.passwordsSecretKeystoreKey`   | The secret key from the tls.client.passwordsSecretName.                                         | `""`                                                                  |
| `tls.client.passwordsSecretTruststoreKey` | The secret key from the tls.client.passwordsSecretName.                                         | `""`                                                                  |
...
| `tls.quorum.existingSecretKeystoreKey`    | The secret key from the tls.quorum.existingSecret.                                              | `""`                                                                  |
| `tls.quorum.existingSecretTruststoreKey`  | The secret key from the tls.quorum.existingSecret.                                              | `""`                                                                  |
...
| `tls.quorum.passwordsSecretKeystoreKey`   | The secret key from the tls.quorum.passwordsSecretName.                                         | `""`                                                                  |
| `tls.quorum.passwordsSecretTruststoreKey` | The secret key from the tls.quorum.passwordsSecretName.                                         | `""`                                                                  |
