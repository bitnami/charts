...
| `image.tag`                 | ZooKeeper image tag (immutable tags are recommended)                                                                       | `3.8.0-debian-10-r20`   |
...
| `tls.client.existingSecretKeystoreKey`    | The secret key from the existingSecret if 'existingSecretKeystoreKey' key different from the default (zookeeper.keystore.jks)      | `zookeeper.keystore.jks`                                              |
| `tls.client.existingSecretTruststoreKey`  | The secret key from the existingSecret if 'existingSecretTruststoreKey' key different from the default (zookeeper.truststore.jks)  | `zookeeper.truststore.jks`                                            |
...
| `tls.client.passwordsSecretKeystoreKey`   | The secret key from the passwordsSecretName if 'passwordsSecretKeystoreKey' key different from the default (keystore-password)     | `keystore-password`                                                   |
| `tls.client.passwordsSecretTruststoreKey` | The secret key from the passwordsSecretName if 'passwordsSecretTruststoreKey' key different from the default (truststore-password) | `truststore-password`                                                 |
...
| `tls.quorum.existingSecretKeystoreKey`    | The secret key from the existingSecret if 'existingSecretKeystoreKey' key different from the default (zookeeper.keystore.jks)      | `zookeeper.keystore.jks`                                              |
| `tls.quorum.existingSecretTruststoreKey`  | The secret key from the existingSecret if 'existingSecretTruststoreKey' key different from the default (zookeeper.truststore.jks)  | `zookeeper.truststore.jks`                                            |
...
| `tls.quorum.passwordsSecretKeystoreKey`   | The secret key from the passwordsSecretName if 'passwordsSecretKeystoreKey' key different from the default (keystore-password)     | `keystore-password`                                                   |
| `tls.quorum.passwordsSecretTruststoreKey` | The secret key from the passwordsSecretName if 'passwordsSecretTruststoreKey' key different from the default (truststore-password) | `truststore-password`                                                 |
