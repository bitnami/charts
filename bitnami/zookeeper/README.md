...
| `livenessProbe.probeCommandTimeout`      | Timeout in seconds of the liveness probe command                                                               | 2                                                            |
...
| `readinessProbe.probeCommandTimeout`     | Timeout in seconds of the readiness probe command                                                               | 2                                                            |
