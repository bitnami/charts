...
| `image.tag`                 | ZooKeeper image tag (immutable tags are recommended)                                                                       | `3.8.0-debian-10-r16`   |
...
| `tls.client.keystorePasswordSecretKey`   | The secret key from the passwordsSecretName if 'keystorePasswordSecretKey' key different from the default (keystore-password)     | `keystore-password`                                                   |
| `tls.client.truststorePasswordSecretKey` | The secret key from the passwordsSecretName if 'truststorePasswordSecretKey' key different from the default (truststore-password) | `truststore-password`                                                 |
...
| `tls.quorum.keystorePasswordSecretKey`   | The secret key from the passwordsSecretName if 'keystorePasswordSecretKey' key different from the default (keystore-password)     | `keystore-password`                                                   |
| `tls.quorum.truststorePasswordSecretKey` | The secret key from the passwordsSecretName if 'truststorePasswordSecretKey' key different from the default (truststore-password) | `truststore-password`                                                 |
