...
{{- $messages := append $messages (include "zookeeper.validateValues.client.passwordKeys" .) -}}
{{- $messages := append $messages (include "zookeeper.validateValues.quorum.passwordKeys" .) -}}
...
{{/*
Validate values of ZooKeeper - Quorum TLS password keys
*/}}
{{- define "zookeeper.validateValues.quorum.passwordKeys" -}}
{{- if and .Values.tls.quorum.enabled .Values.tls.quorum.autoGenerated (not .Values.tls.quorum.passwordsSecretName) }}
{{- if eq .Values.tls.quorum.truststorePasswordSecretKey .Values.tls.quorum.keystorePasswordSecretKey }}
zookeeper: tls.quorum.keystorePasswordSecretKey,tls.quorum.truststorePasswordSecretKey
    If not using tls.quorum.passwordsSecretName, tls.quorum.keystorePasswordSecretKey and tls.quorum.truststorePasswordSecretKey
    must be different.
{{- end -}}
{{- end -}}
{{- end -}}
...
{{/*
Validate values of ZooKeeper - Client TLS password keys
*/}}
{{- define "zookeeper.validateValues.client.passwordKeys" -}}
{{- if and .Values.tls.client.enabled .Values.tls.client.autoGenerated (not .Values.tls.client.passwordsSecretName) }}
{{- if eq .Values.tls.client.truststorePasswordSecretKey .Values.tls.client.keystorePasswordSecretKey }}
zookeeper: tls.client.keystorePasswordSecretKey,tls.client.truststorePasswordSecretKey
    If not using tls.client.passwordsSecretName, tls.client.keystorePasswordSecretKey and tls.client.truststorePasswordSecretKey
    must be different.
{{- end -}}
{{- end -}}
{{- end -}}
