...
| `image.tag`         | RabbitMQ image tag (immutable tags are recommended)            | `3.9.9-debian-10-r0` |
...
| `volumePermissions.image.tag`          | Init container volume-permissions image tag                                                                          | `10-debian-10-r249`     |
