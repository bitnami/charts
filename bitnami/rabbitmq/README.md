...
| `image.tag`         | RabbitMQ image tag (immutable tags are recommended)            | `3.9.18-debian-10-r0` |
...
| `ldap.user_dn_pattern`             | Pattern used to translate the provided username into a value to be used for the LDAP bind. DEPRECATED, please use userDnPattern instead              | `""`                                              |
