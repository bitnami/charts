...
| `image.tag`         | RabbitMQ image tag (immutable tags are recommended)                                                      | `3.10.8-debian-11-r4` |
...
| `volumePermissions.image.tag`                          | Init container volume-permissions image tag                                                                                       | `11-debian-11-r38`      |
