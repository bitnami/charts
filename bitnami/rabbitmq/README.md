...
| `image.tag`         | RabbitMQ image tag (immutable tags are recommended)            | `3.9.11-debian-10-r28` |
...
| `volumePermissions.image.tag`          | Init container volume-permissions image tag                                                                          | `10-debian-10-r296`     |
