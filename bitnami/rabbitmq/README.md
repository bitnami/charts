...
| `image.tag`         | RabbitMQ image tag (immutable tags are recommended)            | `3.10.5-debian-11-r9` |
...
| `volumePermissions.image.tag`          | Init container volume-permissions image tag                                                                          | `11-debian-11-r7`       |
