...
| `image.tag`         | RabbitMQ image tag (immutable tags are recommended)                                                      | `3.11.5-debian-11-r2` |
...
| `advancedConfigurationExistingSecret` | Existing secret with the advanced configuration file.                                                                                                                   | `""`                                              |
