...
| `service.nodeDiscoverPort`                        | Node port override for `epmd` port, if serviceType NodePort                                             | `nil`                                                   |
| `service.nodeDistPort`                            | Node port override for `dist` port, if serviceType NodePort                                             | `nil`                                                   |
| `service.nodeManagerPort`                         | Node port override for `stats` port, if serviceType NodePort                                            | `nil`                                                   |
| `service.nodeMetricsPort`                         | Node port override for `metrics` port, if serviceType NodePort                                          | `nil`                                                   |
