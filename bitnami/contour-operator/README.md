...
| `image.tag`                                       | Contour Operator image tag (immutable tags are recommended)                                                              | `1.24.0-scratch-r5`        |
...
| `contourImage.tag`                                | Contour Image tag (immutable tags are recommended)                                                                       | `1.24.2-debian-11-r4`      |
...
| `envoyImage.tag`                                  | Envoy Image tag (immutable tags are recommended)                                                                         | `1.24.4-debian-11-r1`      |
