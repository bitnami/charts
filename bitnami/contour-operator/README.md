...
| `image.tag`                                       | Contour Operator image tag (immutable tags are recommended)                                                              | `1.20.1-scratch-r3`        |
...
| `contourImage.tag`                                | Contour Image tag (immutable tags are recommended)                                                                       | `1.20.1-debian-10-r40`     |
...
| `envoyImage.tag`                                  | Envoy Image tag (immutable tags are recommended)                                                                         | `1.21.1-debian-10-r43`     |
