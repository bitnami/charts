...
| `image.tag`                                       | Contour Operator image tag (immutable tags are recommended)                                                              | `1.24.0-scratch-r4`        |
...
| `contourImage.tag`                                | Contour Image tag (immutable tags are recommended)                                                                       | `1.24.2-debian-11-r0`      |
...
| `envoyImage.tag`                                  | Envoy Image tag (immutable tags are recommended)                                                                         | `1.24.3-debian-11-r4`      |
