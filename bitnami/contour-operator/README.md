...
| `image.tag`                                       | Contour Operator image tag (immutable tags are recommended)                                                              | `1.24.0-scratch-r6`        |
...
| `contourImage.tag`                                | Contour Image tag (immutable tags are recommended)                                                                       | `1.24.4-debian-11-r0`      |
...
| `envoyImage.tag`                                  | Envoy Image tag (immutable tags are recommended)                                                                         | `1.24.7-debian-11-r1`      |
