...
| `image.tag`                                                    | Fluentd image tag (immutable tags are recommended)                                                                                                                 | `1.14.3-debian-10-r0`                                      |
...
| `forwarder.service.annotationsHeadless`                        | Provide any additional annotations which may be required on headless service                                                                                       | `{}`                                                       |
