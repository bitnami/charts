...
| `aggregator.ingress.enabled                     | Create Ingress for the Aggregator                                                                              | `false`                                                                                                 |
| `aggregator.ingress.namespace                   | Namespace to which the Ingress should belong to                                                                | `default`                                                                                               |
| `aggregator.ingress.host                        | Host value for the Ingress                                                                                     | `ingress.local`                                                                                         |
| `aggregator.ingress.servicePort                 | ServicePort of the service to which the Ingress should point                                                   | `9880`                                                                                                  |
| `aggregator.ingress.path                        | Path to which the Ingress should point                                                                         | `/`                                                                                                     |
