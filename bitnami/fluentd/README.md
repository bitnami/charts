...
| `forwarder.extraInitContainers`                 | Additional init containers to add to the pods (fluentd forwarder)                                              | `[]`                                                                                                    |
| `forwarder.sidecars`                            | Add additional containers to the pod (fluentd forwarder)                                                       | `[]`                                                                                                    |
...
| `aggregator.extraInitContainers`                | Additional init containers to add to the pods (fluentd aggregator)                                             | `[]`                                                                                                    |
| `aggregator.sidecars`                           | Add additional containers to the pod (fluentd aggregator)                                                      | `[]`                                                                                                    |
