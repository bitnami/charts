...
| `image.tag`                                                    | Fluentd image tag (immutable tags are recommended)                                                                                                                 | `1.14.6-debian-10-r18`                                     |
...
| `tls.enabled`                                                  | Enable TLS/SSL encryption for internal communications                                                                                                              | `false`                                                    |
