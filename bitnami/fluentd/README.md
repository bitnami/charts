...
| `image.tag`                                                    | Fluentd image tag (immutable tags are recommended)                                                                                                                 | `1.15.2-debian-11-r0`                                      |
| `image.digest`                                                 | Fluentd image digest in the way sha256:aa.... Please note this parameter, if set, will override the tag                                                            | `""`                                                       |
...
| `forwarder.image.digest`                                       | Fluentd forwarder image digest in the way sha256:aa.... Please note this parameter, if set, will override the tag                                                  | `""`                                                       |
...
| `forwarder.dnsPolicy`                                          | Pod-specific DNS policy                                                                                                                                            | `Default`                                                  |
...
| `aggregator.image.digest`                                      | Fluentd aggregator image digest in the way sha256:aa.... Please note this parameter, if set, will override the tag                                                 | `""`                                                       |
