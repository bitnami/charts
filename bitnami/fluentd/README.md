...
| `mountedTLS.enabled`                            | Enable the addition of TLS certificates                                                                        | `false`                                                                                                 |
| `mountedTLS.caCertificate`                      | Ca certificate                                                                                                 | Certificate Authority (CA) bundle content                                                               |
| `mountedTLS.certificate`                        | Server certificate                                                                                             | Server certificate content                                                                              |
| `mountedTLS.key`                                | Server Key                                                                                                     | Server private key content                                                                              |
| `mountedTLS.existingSecret`                     | Existing secret with certificate content                                                                       | `nil`                                                                                                   |
...
In this version, `tls.*` settings are renamed to `mountedTLS.*`, and the new `tls.*` settings are used to configure SSL/TLS certificates for the out_forward communications in the Fluentd Forwarder and in_forward in the Fluentd Aggregator.
