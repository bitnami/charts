...
{{- if and .Values.tls.enabled (not .Values.tls.autoGenerated) (or (not .Values.tls.forwarder.existingSecret) (not .Values.tls.aggregator.existingSecret)) }}
fluentd: tls.enabled
    In order to enable TLS, you also need to provide
    an existing secret containing the TLS certificates for both Forwarder and Aggregator, or
...
{{- if and .Values.tls.enabled .Values.tls.autoGenerated (and (not .Values.tls.forwarder.existingSecret) (not .Values.tls.aggregator.existingSecret)) }}
    {{- true -}}
{{- end -}}
{{- end -}}
