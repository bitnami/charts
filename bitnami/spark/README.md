...
| `master.extraVolumeClaimTemplates`                       | Optionally specify extra list of volumesClaimTemplates for the Spark master statefulset                                  | `[]`            |
...
| `worker.extraVolumeClaimTemplates`                       | Optionally specify extra list of volumesClaimTemplates for the Spark worker statefulset                                  | `[]`            |
