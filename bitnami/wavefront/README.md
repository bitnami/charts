...
| `collector.image.tag`                                       | Wavefront collector Image tag (immutable tags are recommended)                                                          | `1.11.0-scratch-r8`                      |
...
| `proxy.image.tag`                                       | Wavefront proxy image tag (immutable tags are recommended)                                                                              | `11.3.0-debian-11-r14`    |
