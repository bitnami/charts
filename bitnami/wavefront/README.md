...
| `collector.image.tag`                                       | Wavefront collector Image tag (immutable tags are recommended)                                                          | `1.11.0-scratch-r7`                      |
...
| `proxy.image.tag`                                       | Wavefront proxy image tag (immutable tags are recommended)                                                                              | `11.3.0-debian-11-r13`    |
