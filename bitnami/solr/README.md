...
| `tls.image.registry`                   | TLS init container image registry                                                                                                                                                | `docker.io`                        |
| `tls.image.repository`                 | TLS init container image repository                                                                                                                                              | `bitnami/solr`                     |
| `tls.image.tag`                        | TLS init container image tag                                                                                                                                                     | `"{TAG_NAME}"`                     |
| `tls.image.pullPolicy`                 | TLS init container image pull policy                                                                                                                                             | `IfNotPresent`                     |
| `tls.image.pullSecrets`                | TLS init container image pull secrets                                                                                                                                            | `[]` (does not add image pull secrets to deployed pods) |
