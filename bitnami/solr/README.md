...
| Name                | Description                                                                          | Value           |
| ------------------- | ------------------------------------------------------------------------------------ | --------------- |
| `nameOverride`      | String to partially override solr.fullname template (will maintain the release name) | `nil`           |
| `fullnameOverride`  | String to fully override solr.fullname template                                      | `nil`           |
...
| `authentication.adminPassword` | Solr admin password. Autogenerated if not provided.           | `nil`                 |
...
| `tls.certificatesSecretName` | Name of the secret that contains the certificates                                | `nil`   |
| `tls.passwordsSecretName`    | Set the name of the secret that contains the passwords for the certificate files | `nil`   |
...
| `ingress.existingSecret`  | The name of an existing Secret in the same namespase to use on the generated Ingress resource         | `nil`                    |
...
| `exporter.extraEnvVarsCM`                        | ConfigMap with extra environment variables                                                                                      | `nil`                                                                         |
| `exporter.extraEnvVarsSecret`                    | Secret with extra environment variables                                                                                         | `nil`                                                                         |
...
| `exporter.service.loadBalancerIP`                | Load balancer IP for the SuiteCRM Service (optional, cloud specific)                                                            | `nil`                                                                         |
