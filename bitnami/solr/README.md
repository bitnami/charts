...
| `image.tag`                      | Solr image tag (immutable tags are recommended)               | `8.11.1-debian-10-r125` |
...
| `metrics.service.type`                    | Solr Prometheus exporter Kubernetes Service type                                                                                     | `ClientIP`                                                                        |
