...
| `interClusterSecret`                                | Nodes that share the same non-empty secret trust each other. The initial user is used as the current user for cluster queries | `same-user`            |
