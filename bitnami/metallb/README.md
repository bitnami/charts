...
| `controller.image.tag`                                   | MetalLB Controller  image tag (immutable tags are recommended)                                                        | `0.10.3-debian-10-r0`        |
...
| `speaker.image.tag`                                   | MetalLB Speaker  image tag (immutable tags are recommended)                                                            | `0.10.2-debian-10-r110`   |
