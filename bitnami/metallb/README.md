...
| `controller.image.tag`                                         | MetalLB Controller  image tag (immutable tags are recommended)                                                                              | `0.12.1-debian-10-r46`       |
...
| `controller.replicaCount`                                      | Number of Metallb controller replicas                                                                                                       | `1`                          |
...
| `controller.terminationGracePeriodSeconds`                     | In seconds, time the given to the Metallb controller pod needs to terminate gracefully                                                      | `""`                         |
...
| `controller.startupProbe.enabled`                              | Enable startupProbe                                                                                                                         | `true`                       |
...
| `speaker.image.tag`                                         | MetalLB Speaker  image tag (immutable tags are recommended)                                                                                 | `0.12.1-debian-10-r46`    |
...
| `speaker.terminationGracePeriodSeconds`                     | In seconds, time the given to the Speaker pod needs to terminate gracefully                                                                 | `""`                      |
