...
| `image.tag`                             | DokuWiki image tag                                                                                                    | `20220731.1.0-debian-11-r60` |
...
| `metrics.image.tag`         | Apache exporter image tag                                                                                       | `0.13.0-debian-11-r0`     |
...
| `certificates.image.tag`                             | Container sidecar image tag                                                                                       | `11-debian-11-r87`                       |
