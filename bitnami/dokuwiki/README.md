...
| `image.tag`                             | DokuWiki image tag                                                                                                    | `20220731.1.0-debian-11-r68` |
...
| `metrics.image.tag`         | Apache exporter image tag                                                                                       | `0.13.0-debian-11-r8`     |
...
| `certificates.image.tag`                             | Container sidecar image tag                                                                                       | `11-debian-11-r97`                       |
