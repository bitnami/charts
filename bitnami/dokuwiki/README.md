...
| `image.tag`                          | DokuWiki image tag                                                                                                    | `20200729.0.0-debian-10-r401` |
...
| `metrics.image.tag`         | Apache exporter image tag                        | `0.10.1-debian-10-r35`    |
...
| `certificates.image.tag`                             | Container sidecar image tag                                          | `10-debian-10-r233`                      |
