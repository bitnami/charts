...
| `image.tag`                             | DokuWiki image tag                                                                                                    | `20200729.0.0-debian-11-r20` |
...
| `metrics.image.tag`         | Apache exporter image tag                        | `0.11.0-debian-11-r23`    |
...
| `certificates.image.tag`                             | Container sidecar image tag                                          | `11-debian-11-r20`                       |
