...
| `controller.image.tag`                             | Controller image tag                                                                                 | `1.4.0-debian-10-r0`   |
...
| `controller.acmesolver.image.tag`                  | Controller image tag                                                                                 | `1.3.1-debian-10-r52`  |
...
| `webhook.image.tag`                             | Webhook image tag                                                                                 | `1.4.0-debian-10-r0`           |
...
| `cainjector.image.tag`                             | CAInjector image tag                                                                                 | `1.4.0-debian-10-r0` |
