...
| `controller.image.tag`                                   | Controller image tag (immutable tags are recommended)                                                      | `1.11.0-debian-11-r11` |
...
| `controller.acmesolver.image.tag`                        | Controller image tag (immutable tags are recommended)                                                      | `1.11.0-debian-11-r10` |
...
| `webhook.image.tag`                                   | Webhook image tag (immutable tags are recommended)                                                      | `1.11.0-debian-11-r10`         |
...
| `cainjector.image.tag`                                   | CAInjector image tag (immutable tags are recommended)                                                      | `1.11.0-debian-11-r9` |
