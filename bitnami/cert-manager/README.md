...
| `controller.image.tag`                                   | Controller image tag (immutable tags are recommended)                                                | `1.8.0-debian-10-r13`  |
...
| `controller.acmesolver.image.tag`                        | Controller image tag (immutable tags are recommended)                                                | `1.8.0-debian-10-r12`  |
...
| `webhook.image.tag`                                   | Webhook image tag (immutable tags are recommended)                                                | `1.8.0-debian-10-r12`          |
...
| `cainjector.image.tag`                                   | CAInjector image tag (immutable tags are recommended)                                                | `1.8.0-debian-10-r13` |
