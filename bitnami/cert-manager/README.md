...
| `controller.image.tag`                             | Controller image tag (immutable tags are recommended)                                                | `1.5.2-debian-10-r1`   |
...
| `controller.acmesolver.image.tag`                  | Controller image tag (immutable tags are recommended)                                                | `1.5.2-debian-10-r0`   |
...
| `webhook.image.tag`                             | Webhook image tag (immutable tags are recommended)                                                | `1.5.2-debian-10-r0`           |
...
| `cainjector.image.tag`                             | CAInjector image tag (immutable tags are recommended)                                                | `1.5.2-debian-10-r0` |
