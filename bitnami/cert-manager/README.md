...
| `controller.image.tag`                             | Controller image tag (immutable tags are recommended)                                                | `1.5.4-debian-10-r25`  |
...
| `controller.acmesolver.image.tag`                  | Controller image tag (immutable tags are recommended)                                                | `1.5.4-debian-10-r25`  |
...
| `webhook.image.tag`                             | Webhook image tag (immutable tags are recommended)                                                | `1.5.4-debian-10-r24`          |
...
| `cainjector.image.tag`                             | CAInjector image tag (immutable tags are recommended)                                                | `1.5.4-debian-10-r24` |
