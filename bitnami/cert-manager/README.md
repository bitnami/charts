...
| `controller.image.tag`                                   | Controller image tag (immutable tags are recommended)                                                      | `1.10.0-debian-11-r10` |
...
| `controller.acmesolver.image.tag`                        | Controller image tag (immutable tags are recommended)                                                      | `1.10.0-debian-11-r9`  |
...
| `webhook.image.tag`                                   | Webhook image tag (immutable tags are recommended)                                                      | `1.10.0-debian-11-r9`          |
...
| `cainjector.image.tag`                                   | CAInjector image tag (immutable tags are recommended)                                                      | `1.10.0-debian-11-r9` |
