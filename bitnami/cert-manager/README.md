...
| `controller.image.tag`                                   | Controller image tag (immutable tags are recommended)                                                      | `1.12.4-debian-11-r0`  |
...
| `controller.acmesolver.image.tag`                        | Controller image tag (immutable tags are recommended)                                                      | `1.12.4-debian-11-r0`  |
...
| `webhook.image.tag`                                   | Webhook image tag (immutable tags are recommended)                                                      | `1.12.4-debian-11-r0`          |
...
| `cainjector.image.tag`                                   | CAInjector image tag (immutable tags are recommended)                                                      | `1.12.4-debian-11-r0` |
