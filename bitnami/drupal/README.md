...
| `image.tag`                             | Drupal Image tag                                                                                                      | `9.3.16-debian-11-r2` |
...
| `volumePermissions.image.tag`          | Init container volume-permissions image tag                                                                                                               | `11-debian-11-r4`       |
...
| `metrics.image.tag`         | Apache exporter image tag                        | `0.11.0-debian-11-r5`     |
...
| `certificates.image.tag`                             | Container sidecar image tag                                          | `11-debian-11-r4`                        |
