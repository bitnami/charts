...
| `image.tag`                          | Drupal Image tag                                                                                                      | `9.2.1-debian-10-r0` |
...
| `metrics.image.tag`         | Apache exporter image tag                        | `0.9.0-debian-10-r25`     |
...
| `certificates.image.tag`                             | Container sidecar image tag                                          | `10-debian-10-r127`                      |
