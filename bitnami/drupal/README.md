...
| `image.tag`                                   | Drupal Image tag                                                                                                       | `10.1.1-debian-11-r0` |
...
| `metrics.image.tag`                        | Apache exporter image tag                                                                                       | `0.13.4-debian-11-r14`    |
...
| `certificates.image.tag`                             | Container sidecar image tag                                                                                       | `11-debian-11-r2`                        |
