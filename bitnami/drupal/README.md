...
| `image.tag`                                   | Drupal Image tag                                                                                                       | `9.4.5-debian-11-r4` |
...
| `volumePermissions.image.tag`          | Init container volume-permissions image tag                                                                                                               | `11-debian-11-r32`      |
...
| `metrics.image.tag`                        | Apache exporter image tag                                                                                       | `0.11.0-debian-11-r37`    |
...
| `certificates.image.tag`                             | Container sidecar image tag                                                                                       | `11-debian-11-r32`                       |
