...
| `image.tag`                                   | Drupal Image tag                                                                                                       | `10.0.9-debian-11-r17` |
...
| `metrics.image.tag`                        | Apache exporter image tag                                                                                       | `0.13.4-debian-11-r6`     |
...
| `certificates.image.tag`                             | Container sidecar image tag                                                                                       | `11-debian-11-r127`                      |
