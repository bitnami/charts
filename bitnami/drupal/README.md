...
| `image.tag`                                   | Drupal Image tag                                                                                                       | `9.4.8-debian-11-r12` |
...
| `metrics.image.tag`                        | Apache exporter image tag                                                                                       | `0.11.0-debian-11-r57`    |
...
| `certificates.image.tag`                             | Container sidecar image tag                                                                                       | `11-debian-11-r48`                       |
