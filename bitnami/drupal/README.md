...
| `image.tag`                                   | Drupal Image tag                                                                                                       | `10.0.9-debian-11-r2` |
...
| `metrics.image.tag`                        | Apache exporter image tag                                                                                       | `0.13.3-debian-11-r5`     |
...
| `certificates.image.tag`                             | Container sidecar image tag                                                                                       | `11-debian-11-r114`                      |
