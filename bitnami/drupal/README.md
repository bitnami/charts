...
Looking to use Drupal in production? Try [VMware Application Catalog](https://bitnami.com/enterprise), the enterprise edition of Bitnami Application Catalog.
...
| `image.tag`                                   | Drupal Image tag                                                                                                       | `10.1.2-debian-11-r26` |
...
| `volumePermissions.image.tag`          | Init container volume-permissions image tag                                                                                                               | `11-debian-11-r51` |
...
| `metrics.image.tag`                        | Apache exporter image tag                                                                                       | `1.0.1-debian-11-r29`     |
...
| `certificates.image.tag`                             | Container sidecar image tag                                                                                       | `11-debian-11-r51`                       |
