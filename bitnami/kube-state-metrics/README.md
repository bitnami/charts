...
| `resources.certificatesigningrequests`      | Enable the `certificatesigningrequests` resource                                                              | `true`                                                     |
| `resources.configmaps`                      | Enable the `configmaps` resource                                                                              | `true`                                                     |
| `resources.cronjobs`                        | Enable the `cronjobs` resource                                                                                | `true`                                                     |
| `resources.daemonsets`                      | Enable the `daemonsets` resource                                                                              | `true`                                                     |
| `resources.deployments`                     | Enable the `deployments` resource                                                                             | `true`                                                     |
| `resources.endpoints`                       | Enable the `endpoints` resource                                                                               | `true`                                                     |
| `resources.horizontalpodautoscalers`        | Enable the `horizontalpodautoscalers` resource                                                                | `true`                                                     |
| `resources.ingresses`                       | Enable the `ingresses` resource                                                                               | `true`                                                     |
| `resources.jobs`                            | Enable the `jobs` resource                                                                                    | `true`                                                     |
| `resources.limitranges`                     | Enable the `limitranges` resource                                                                             | `true`                                                     |
| `resources.mutatingwebhookconfigurations`   | Enable the `mutatingwebhookconfigurations` resource                                                           | `true`                                                     |
| `resources.namespaces`                      | Enable the `namespaces` resource                                                                              | `true`                                                     |
| `resources.networkpolicies`                 | Enable the `networkpolicies` resource                                                                         | `true`                                                     |
| `resources.nodes`                           | Enable the `nodes` resource                                                                                   | `true`                                                     |
| `resources.persistentvolumeclaims`          | Enable the `persistentvolumeclaims` resource                                                                  | `true`                                                     |
| `resources.persistentvolumes`               | Enable the `persistentvolumes` resource                                                                       | `true`                                                     |
| `resources.poddisruptionbudgets`            | Enable the `poddisruptionbudgets` resource                                                                    | `true`                                                     |
| `resources.pods`                            | Enable the `pods` resource                                                                                    | `true`                                                     |
| `resources.replicasets`                     | Enable the `replicasets` resource                                                                             | `true`                                                     |
| `resources.replicationcontrollers`          | Enable the `replicationcontrollers` resource                                                                  | `true`                                                     |
| `resources.resourcequotas`                  | Enable the `resourcequotas` resource                                                                          | `true`                                                     |
| `resources.secrets`                         | Enable the `secrets` resource                                                                                 | `true`                                                     |
| `resources.services`                        | Enable the `services` resource                                                                                | `true`                                                     |
| `resources.statefulsets`                    | Enable the `statefulsets` resource                                                                            | `true`                                                     |
| `resources.storageclasses`                  | Enable the `storageclasses` resource                                                                          | `true`                                                     |
| `resources.verticalpodautoscalers`          | Enable the `verticalpodautoscalers` resource                                                                  | `false`                                                    |
| `resources.validatingwebhookconfigurations` | Enable the `validatingwebhookconfigurations` resource                                                         | `false`                                                    |
| `resources.volumeattachments`               | Enable the `volumeattachments` resource                                                                       | `true`                                                     |
...
This version updates kube-state-metrics to its new major, 2.0.0. There have been some value's name changes to acommodate to the naming used in 2.0.0:
  ...
  - `.Values.collectors` -> `.Values.resources`
