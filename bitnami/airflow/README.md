...
| `airflow.rbac.create`                                                    | Specifies whether RBAC rules should be created                                                                                                                                                                                 | `false`                                                      |
| `airflow.serviceAccount`                                                 | Specifies whether a ServiceAccount should be created                                                                                                                                                                           | `false`                                                      |
| `airflow.serviceAccount.annotations`                                     | Annotations for service   account                                                                                                                                                                                              | `{}`                                                         |
