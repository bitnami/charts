...
| `airflow.worker.resources`                | CPU/Memory resource requests/limits                                                                  | Memory: `256Mi`, CPU: `250m`                                 |
...
| `airflow.web.resources`                   | CPU/Memory resource requests/limits                                                                  | Memory: `256Mi`, CPU: `250m`                                 |
| `airflow.scheduler.resources`             | CPU/Memory resource requests/limits                                                                  | Memory: `256Mi`, CPU: `250m`                                 |
