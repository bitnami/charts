...
| `dags.image.tag`         | Container sidecar image tag                                                                                                                      | `10-debian-10-r236`     |
...
| `web.image.tag`                          | Airflow image tag (immutable tags are recommended)                          | `2.2.1-debian-10-r0` |
...
| `scheduler.image.tag`                        | Airflow Scheduler image tag (immutable tags are recommended)            | `2.2.0-debian-10-r11`       |
...
| `worker.image.tag`                          | Airflow Worker image tag (immutable tags are recommended)                                                            | `2.2.0-debian-10-r11`    |
...
| `git.image.tag`                | Git image tag (immutable tags are recommended)                                         | `2.33.0-debian-10-r72` |
...
| `metrics.image.tag`                    | Airflow Exporter image tag (immutable tags are recommended)               | `0.20210126.0-debian-10-r261` |
