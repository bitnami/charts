...
| `dags.image.tag`         | Init container load-dags image tag (immutable tags are recommended)                                                                            | `10-debian-10-r432`     |
...
| `web.image.tag`                             | Airflow image tag (immutable tags are recommended)                                                                       | `2.3.0-debian-10-r3` |
...
| `scheduler.image.tag`                             | Airflow Scheduler image tag (immutable tags are recommended)                                                             | `2.3.0-debian-10-r18`       |
...
| `worker.image.tag`                             | Airflow Worker image tag (immutable tags are recommended)                                                                | `2.3.0-debian-10-r18`    |
...
| `git.image.tag`                | Git image tag (immutable tags are recommended)                                         | `2.36.1-debian-10-r13` |
...
| `ldap.base`                      | Base of the search, eg. ou=example,o=org. DEPRECATED, please use basedn instead                                                                             | `""`                                                                                                      |
...
| `ldap.tls.CAcertificateSecret`   | Name of the existing secret containing the certificate CA file that will be used by ldap client. DEPRECATED, please use ldap.tls.certificatesSecret instead | `""`                                                                                                      |
...
| `ldap.tls.CAcertificateFilename` | LDAP CA cert filename. DEPRECATED, please use ldap.tls.CAFilename instead                                                                                   | `""`                                                                                                      |
...
| `metrics.image.tag`                             | Airflow exporter image tag (immutable tags are recommended)                                         | `0.20220314.0-debian-10-r68` |
