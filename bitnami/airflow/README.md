...
| `dags.image.tag`         | Init container load-dags image tag (immutable tags are recommended)                                                                            | `10-debian-10-r443`     |
...
| `web.image.tag`                             | Airflow image tag (immutable tags are recommended)                                                                       | `2.3.1-debian-10-r0` |
...
| `scheduler.image.tag`                             | Airflow Scheduler image tag (immutable tags are recommended)                                                             | `2.3.1-debian-10-r0`        |
...
| `worker.image.tag`                             | Airflow Worker image tag (immutable tags are recommended)                                                                | `2.3.1-debian-10-r0`     |
...
| `git.image.tag`                | Git image tag (immutable tags are recommended)                                         | `2.36.1-debian-10-r24` |
...
| `metrics.image.tag`                             | Airflow exporter image tag (immutable tags are recommended)                                         | `0.20220314.0-debian-10-r79` |
