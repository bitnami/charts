...
| `web.image.tag`                             | Airflow image tag (immutable tags are recommended)                                                                       | `2.3.4-debian-11-r0` |
...
| `scheduler.image.tag`                             | Airflow Scheduler image tag (immutable tags are recommended)                                                             | `2.3.3-debian-11-r16`       |
...
| `worker.image.tag`                             | Airflow Worker image tag (immutable tags are recommended)                                                                | `2.3.3-debian-11-r17`    |
...
| `metrics.image.tag`                             | Airflow exporter image tag (immutable tags are recommended)                                                      | `0.20220314.0-debian-11-r30` |
