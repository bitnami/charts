...
| `airflow.web.resources.limits`            | The resources limits for the Worker containers                                                       | `{}`                                                         |
| `airflow.web.resources.requests`          | The requested resources for the Worker containers                                                    | `{}`                                                         |
| `airflow.scheduler.resources.limits`      | The resources limits for the Worker containers                                                       | `{}`                                                         |
| `airflow.scheduler.resources.requests`    | The requested resources for the Worker containers                                                    | `{}`                                                         |
