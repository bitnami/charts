...
| `airflow.worker.resources`                | CPU/Memory resource requests/limits                                                                  | `{}`                                                         |
...
| `airflow.web.resources`                   | CPU/Memory resource requests/limits                                                                  | `{}`                                                         |
| `airflow.scheduler.resources`             | CPU/Memory resource requests/limits                                                                  | `{}`                                                         |
