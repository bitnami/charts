...
| `dags.image.tag`         | Init container load-dags image tag (immutable tags are recommended)                                                                                                       | `11-debian-11-r38`      |
...
| `web.image.tag`                             | Airflow image tag (immutable tags are recommended)                                                                       | `2.3.4-debian-11-r13` |
...
| `scheduler.image.tag`                             | Airflow Scheduler image tag (immutable tags are recommended)                                                             | `2.3.4-debian-11-r13`       |
...
| `worker.image.tag`                             | Airflow Worker image tag (immutable tags are recommended)                                                                | `2.3.4-debian-11-r14`    |
...
| `git.image.tag`                | Git image tag (immutable tags are recommended)                                                      | `2.38.0-debian-11-r0` |
...
| `metrics.image.tag`                             | Airflow exporter image tag (immutable tags are recommended)                                                      | `0.20220314.0-debian-11-r45` |
