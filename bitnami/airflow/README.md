...
| `dags.image.tag`         | Init container load-dags image tag (immutable tags are recommended)                                                                                                       | `11-debian-11-r57`      |
...
| `web.image.tag`                             | Airflow image tag (immutable tags are recommended)                                                                       | `2.5.0-debian-11-r0` |
...
| `scheduler.image.tag`                             | Airflow Scheduler image tag (immutable tags are recommended)                                                             | `2.4.3-debian-11-r5`        |
...
| `worker.image.tag`                             | Airflow Worker image tag (immutable tags are recommended)                                                                | `2.4.3-debian-11-r5`     |
...
| `git.image.tag`                | Git image tag (immutable tags are recommended)                                                      | `2.38.1-debian-11-r15` |
...
| `metrics.image.tag`                             | Airflow exporter image tag (immutable tags are recommended)                                                      | `0.20220314.0-debian-11-r65` |
