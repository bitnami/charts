...
| `dags.image.tag`         | Init container load-dags image tag (immutable tags are recommended)                                                                                                       | `11-debian-11-r118`     |
...
| `web.image.tag`                             | Airflow image tag (immutable tags are recommended)                                                                       | `2.6.1-debian-11-r1` |
...
| `scheduler.image.tag`                             | Airflow Scheduler image tag (immutable tags are recommended)                                                             | `2.6.1-debian-11-r1`        |
...
| `worker.image.tag`                             | Airflow Worker image tag (immutable tags are recommended)                                                                | `2.6.1-debian-11-r1`     |
...
| `git.image.tag`                | Git image tag (immutable tags are recommended)                                                      | `2.40.1-debian-11-r8` |
...
| `metrics.image.tag`                             | Airflow exporter image tag (immutable tags are recommended)                                                      | `0.20220314.0-debian-11-r123` |
