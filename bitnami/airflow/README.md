...
| `ldap.tls.enabled`                        | LDAP Use LDAP SSL                                                                                    | `False`                                                      |
| `ldap.tls.allowSelfSigned`                | LDAP Allow self signed certicates in LDAP ssl                                                        | `True`                                                       |
| `ldap.tls.CAcertificateSecret`            | Name of the certificate that contains the CA cert file                                               | `uid`                                                        |
| `ldap.tls.CAcertificateFilename`          | LDAP CA cert filename                                                                                | `uid`                                                        |
