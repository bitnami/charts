...
| `sentinel.externalAccess.service.loadBalancerIPAnnotaion`                          | Name of annotation to specify fixed IP for service                                                                                                                                                                                          | `""`                             |
...
| `sentinel.externalAccess.service.sentinelPort`                          | Port for the services used to expose redis-server                                                                                                                                                                                          | `26379`                             |
| `sentinel.externalAccess.service.loadBalancerIP`                          | Array of load balancer IPs for each Redis (Length must be the same as sentinel.replicaCount)                                                                | `26379`                             |
...
| `sentinel.externalAccess.service.annotations`                          | Annotations to add to the services used to expose every Pod                                                                | `[]`                             |
