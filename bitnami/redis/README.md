...
| `metrics.enabled`                             | Start a side-car prometheus sentinel exporter                                                                                                       | `false`                                                 |
| `metrics.image.registry`                      | Redis Sentinel exporter image registry                                                                                                              | `docker.io`                                             |
| `metrics.image.repository`                    | Redis Sentinel exporter image name                                                                                                                  | `bitnami/redis-exporter`                                |
| `metrics.image.tag`                           | Redis Sentinel exporter image tag                                                                                                                   | `{TAG_NAME}`                                            |
| `metrics.image.pullPolicy`                    | Image pull policy                                                                                                                                   | `IfNotPresent`                                          |
| `metrics.image.pullSecrets`                   | Specify docker-registry secret names as an array                                                                                                    | `nil`                                                   |
| `metrics.extraArgs`                           | Extra arguments for the binary; possible values [here](https://github.com/leominov/redis_sentinel_exporter#configuration)                           | {}                                                      |
| `metrics.resources`                           | Exporter resource requests/limit                                                                                                                    | Memory: `256Mi`, CPU: `100m`                            |
| `metrics.serviceMonitor.enabled`              | if `true`, creates a Prometheus Operator ServiceMonitor (also requires `metrics.enabled` to be `true`)                                              | `false`                                                 |
| `metrics.serviceMonitor.namespace`            | Optional namespace which Prometheus is running in                                                                                                   | `nil`                                                   |
| `metrics.serviceMonitor.interval`             | How frequently to scrape metrics (use by default, falling back to Prometheus' default)                                                              | `nil`                                                   |
