...
| `master.containerSecurityContext.seLinuxOptions`           | Set SELinux options in container                                                                      | `null`                    |
...
| `replica.containerSecurityContext.seLinuxOptions`           | Set SELinux options in container                                                                        | `null`                    |
...
| `sentinel.containerSecurityContext.seLinuxOptions`           | Set SELinux options in container                                                                                                            | `null`                            |
...
| `metrics.containerSecurityContext.seLinuxOptions`           | Set SELinux options in container                                                                                    | `null`                            |
...
| `volumePermissions.containerSecurityContext.seLinuxOptions` | Set SELinux options in container                                                                                   | `null`                      |
