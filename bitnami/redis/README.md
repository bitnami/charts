...
| `metrics.redisTargetHost`                             | Specify an alternative redis hostname, if you set a local endpoint in hostAliases to match specific redis server certificate CN/SAN for example.    | `localhost`                                             |
...
| `slave.podAffinityPreset`                             | Pod affinity preset. Ignored if `affinity` is set. Allowed values: `soft` or `hard`                                                                 | `""`                                                    |
| `slave.podAntiAffinityPreset`                         | Pod anti-affinity preset. Ignored if `affinity` is set. Allowed values: `soft` or `hard`                                                            | `soft`                                                  |
| `slave.nodeAffinityPreset.type`                       | Node affinity preset type. Ignored if `affinity` is set. Allowed values: `soft` or `hard`                                                           | `""`                                                    |
| `slave.nodeAffinityPreset.key`                        | Node label key to match Ignored if `affinity` is set.                                                                                               | `""`                                                    |
| `slave.nodeAffinityPreset.values`                     | Node label values to match. Ignored if `affinity` is set.                                                                                           | `[]`                                                    |
