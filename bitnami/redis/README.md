...
### Load a module in Redis Open Source 8+ (RediSearch, RedisBloom, RedisJSON, RedisTimeSeries)

Starting from Redis 8 in Redis Open Source, you can use the `commonConfiguration` parameter to specify the modules to load. For example, to load all the modules, you can set the following:
