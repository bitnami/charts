...
| `master.statefulset.extraEnv`                 | Additional environement variables passed to the pod of the master's stateful set set                                                                | `[]`
...
| `slave.statefulset.extraEnv`                  | Additional environement variables passed to the pod of the slave's stateful set                                                                     | `[]`
