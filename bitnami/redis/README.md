...
| `sentinel.service.createMaster`                       | Create master service pointing to the current master                                                                                                | `false`                                                 |
...
| `kubectlImage.command`                                | kubectlImage command to execute                                                                                                                     | []                                                      |
| `kubectlImage.registry`                               | kubectlImage Init container registry                                                                                                                | `docker.io`                                             |
| `kubectlImage.repository`                             | kubectlImage Init container name                                                                                                                    | `bitnami/kubectl`                                       |
| `kubectlImage.tag`                                    | kubectlImage Init container tag                                                                                                                     | `1.17`                                                  |
| `kubectlImage.pullPolicy`                             | kubectlImage Init container pull policy                                                                                                             | `Always`                                                |
