...
| `image.tag`         | Redis&reg; image tag (immutable tags are recommended)                                                      | `7.0.12-debian-11-r1` |
...
| `metrics.image.tag`                          | Redis&reg; Exporter image tag (immutable tags are recommended)                                                      | `1.51.0-debian-11-r9`    |
