...
| `sentinel.service.createMaster`                              | Enable master service pointing to the current master. This is useful when                                                                   | `false`                          |
...
| `kubectlImage.command`                                      | Override default command to inject command (useful when using custom images)                                       | `["cp","/opt/bitnami/kubectl/bin/kubectl","/kubectl"]` |
| `kubectlImage.registry`                                     | kubectl image registry                                                                                             | `REGISTRY_NAME`                                        |
| `kubectlImage.repository`                                   | kubectl image repository                                                                                           | `REPOSITORY_NAME/os-shell`                             |
| `kubectlImage.pullPolicy`                                   | kubectl image pull policysysctl.enabled Enable init container to modify Kernel settings                            | `Always`                                               |
| `kubectlImage.pullSecrets`                                  | kubectl image pull secrets                                                                                         | `[]`                                                   |
