...
| `image.tag`                             | Magento image tag (immutable tags are recommended)                                                                   | `2.4.5-p1-debian-11-r31` |
...
| `mariadb.image.tag`                         | MariaDB image tag (immutable tags are recommended)                                                      | `10.4.27-debian-11-r22` |
...
| `elasticsearch.image.tag`                 | Elasticsearch image tag (immutable tags are recommended)                                                      | `7.17.8-debian-11-r12`  |
