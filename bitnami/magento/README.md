...
| `image.tag`                             | Magento image tag (immutable tags are recommended)                                                                   | `2.4.6-debian-11-r15` |
...
| `mariadb.image.tag`                         | MariaDB image tag (immutable tags are recommended)                                                      | `10.4.28-debian-11-r26` |
...
| `elasticsearch.image.tag`                 | Elasticsearch image tag (immutable tags are recommended)                                                      | `7.17.10-debian-11-r1`  |
