...
| `image.tag`                          | Magento image tag (immutable tags are recommended)                                                                   | `2.4.3-debian-10-r186` |
...
| `mariadb.image.tag`                         | MariaDB image tag (immutable tags are recommended)                                       | `10.4.24-debian-10-r65` |
