...
| `image.tag`                             | Magento image tag (immutable tags are recommended)                                                                   | `2.4.6-debian-11-r93` |
...
| `mariadb.image.tag`                         | MariaDB image tag (immutable tags are recommended)                                                      | `10.6.15-debian-11-r30` |
...
| `elasticsearch.image.tag`                 | Elasticsearch image tag (immutable tags are recommended)                                                      | `7.17.13-debian-11-r8`  |
