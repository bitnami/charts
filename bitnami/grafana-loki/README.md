...
| `loki.image.tag`                      | Grafana Loki image tag (immutable tags are recommended)        | `2.6.1-debian-11-r5`    |
...
| `gateway.image.tag`                             | Nginx image tag (immutable tags are recommended)                                                  | `1.23.1-debian-11-r3` |
...
| `promtail.image.tag`                             | Grafana Promtail image tag (immutable tags are recommended)                                        | `2.6.1-debian-11-r4` |
...
| `memcachedchunks.image.tag`               | Memcached image tag (immutable tags are recommended) | `1.6.15-debian-11-r22` |
...
| `memcachedfrontend.image.tag`               | Memcached image tag (immutable tags are recommended) | `1.6.15-debian-11-r22` |
...
| `memcachedindexqueries.image.tag`               | Memcached image tag (immutable tags are recommended) | `1.6.15-debian-11-r22` |
...
| `memcachedindexwrites.image.tag`               | Memcached image tag (immutable tags are recommended) | `1.6.15-debian-11-r22` |
