...
| `loki.image.tag`                      | Grafana Loki image tag (immutable tags are recommended)                                                      | `2.7.4-debian-11-r0`    |
...
| `gateway.image.tag`                             | Nginx image tag (immutable tags are recommended)                                                      | `1.23.3-debian-11-r29` |
...
| `promtail.image.tag`                             | Grafana Promtail image tag (immutable tags are recommended)                                                      | `2.7.3-debian-11-r7` |
...
| `memcachedchunks.image.tag`               | Memcached image tag (immutable tags are recommended)                                                      | `1.6.18-debian-11-r16` |
...
| `memcachedfrontend.image.tag`               | Memcached image tag (immutable tags are recommended)                                                      | `1.6.18-debian-11-r16` |
...
| `memcachedindexqueries.image.tag`               | Memcached image tag (immutable tags are recommended)                                                      | `1.6.18-debian-11-r16` |
...
| `memcachedindexwrites.image.tag`               | Memcached image tag (immutable tags are recommended)                                                      | `1.6.18-debian-11-r16` |
