...
| `loki.image.tag`                      | Grafana Loki image tag (immutable tags are recommended)                                                      | `2.6.1-debian-11-r18`   |
...
| `gateway.image.tag`                             | Nginx image tag (immutable tags are recommended)                                                      | `1.23.1-debian-11-r18` |
...
| `promtail.image.tag`                             | Grafana Promtail image tag (immutable tags are recommended)                                                      | `2.6.1-debian-11-r17` |
...
| `volumePermissions.image.tag`                          | Bitnami Shell image tag (immutable tags are recommended)                                                      | `11-debian-11-r32`      |
...
| `memcachedchunks.image.tag`               | Memcached image tag (immutable tags are recommended)                                                      | `1.6.17-debian-11-r3` |
...
| `memcachedfrontend.image.tag`               | Memcached image tag (immutable tags are recommended)                                                      | `1.6.17-debian-11-r3` |
...
| `memcachedindexqueries.image.tag`               | Memcached image tag (immutable tags are recommended)                                                      | `1.6.17-debian-11-r3` |
...
| `memcachedindexwrites.image.tag`               | Memcached image tag (immutable tags are recommended)                                                      | `1.6.17-debian-11-r3` |
