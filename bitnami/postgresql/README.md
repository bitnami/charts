...
| `backup.cronjob.podAffinityPreset`                                 | PostgreSQL primary pod affinity preset. Ignored if `backup.cronjob.affinity` is set. Allowed values: `soft` or `hard`                                                                                                                           | `""`                                                                                                                                                                                 |
| `backup.cronjob.podAntiAffinityPreset`                             | PostgreSQL backup job pod anti-affinity preset. Ignored if `backup.cronjob.affinity` is set. Allowed values: `soft` or `hard`                                                                                                                   | `soft`                                                                                                                                                                               |
| `backup.cronjob.nodeAffinityPreset.type`                           | PostgreSQL backup job node affinity preset type. Ignored if `backup.cronjob.affinity` is set. Allowed values: `soft` or `hard`                                                                                                                  | `""`                                                                                                                                                                                 |
| `backup.cronjob.nodeAffinityPreset.key`                            | PostgreSQL backup job node label key to match Ignored if `backup.cronjob.affinity` is set.                                                                                                                                                      | `""`                                                                                                                                                                                 |
| `backup.cronjob.nodeAffinityPreset.values`                         | PostgreSQL backup job node label values to match. Ignored if `backup.cronjob.affinity` is set.                                                                                                                                                  | `[]`                                                                                                                                                                                 |
| `backup.cronjob.affinity`                                          | Affinity for PostgreSQL backup job pods assignment                                                                                                                                                                                              | `{}`                                                                                                                                                                                 |
