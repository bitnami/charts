...
| `primary.extraVolumes`                        | Extra volumes to add to the pods (postgresql primary), the value is evaluated as a template.                                                                                                    | `[]`                        |
...
| `readReplicas.extraVolumes`                   | Extra volumes to add to the pods (postgresql readReplicas), the value is evaluated as a template.                                                                                               | `[]`                        |
...
| `metrics.serviceMonitor.additionalLabels`     | Additional labels that can be used so ServiceMonitor will be discovered by Prometheus  , the value is evaluated as a template.                                                                   | `{}`                        |
