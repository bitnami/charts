...
| `image.tag`                              | PostgreSQL image tag (immutable tags are recommended)                                                                                                                                                                                                                                                                                         | `14.3.0-debian-10-r13`     |
...
| `ldap.uri`                               | LDAP URL beginning in the form `ldap[s]://host[:port]/basedn`                                                                                                                                                                                                                                                                                 | `""`                       |
...
| `ldap.url`                               | LDAP URL beginning in the form `ldap[s]://host[:port]/basedn`. If provided, all the other LDAP parameters will be ignored.                                                                                                                                                                                                                    | `""`                       |
...
| `metrics.image.tag`                             | PostgreSQL Prometheus Exporter image tag (immutable tags are recommended)             | `0.10.1-debian-10-r123`     |
