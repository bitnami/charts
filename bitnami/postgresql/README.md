...
| `image.tag`                          | PostgreSQL image tag (immutable tags are recommended)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       | `14.2.0-debian-10-r74`     |
...
| `metrics.image.tag`                             | PostgreSQL Prometheus Exporter image tag (immutable tags are recommended)             | `0.10.1-debian-10-r90`      |
