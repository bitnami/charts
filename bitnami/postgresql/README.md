...
> ⚠️ Deploying a new release and setting password may not work in case when previous Posgresql release was deleted through the helm command. In that case, old PVC has an old password, and setting it through helm won't take effect. Refer to  [issue 2061](https://github.com/bitnami/charts/issues/2061) for more details  
