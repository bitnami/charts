...
| `master.service.type`                         | Kubernetes Master Service type (ovverides the service.type for differentiating from slave if desired)                                                                     | `nil`                                                         |
| `master.service.nodePort`                     | Kubernetes Master Service nodePort (ovverides the service.nodePort for differentiating from slave if desired)                                                             | `nil`                                                         |
| `master.service.clusterIP`                    | Kubernetes Master Service clusterIP (ovverides the service.clusterIP for differentiating from slave if desired)                                                           | `nil`                                                         |
...
| `slave.service.type`                          | Kubernetes Slave Service type (ovverides the service.type for differentiating from master if desired)                                                                     | `nil`                                                         |
| `slave.service.nodePort`                      | Kubernetes Slave Service nodePort (ovverides the service.nodePort for differentiating from master if desired)                                                             | `nil`                                                         |
| `slave.service.clusterIP`                     | Kubernetes Slave Service clusterIP (ovverides the service.clusterIP for differentiating from master if desired)                                                           | `nil`                                                         |
