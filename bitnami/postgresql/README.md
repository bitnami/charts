...
| Name                                                        | Description                                                                                                                                                                                                                       | Value                 |
| ----------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------- |
| `primary.replicaCount`                                      | Number of PostgreSQL Primary replicas to deploy. Only 0 or 1 is supported, since a PostgreSQL Primary cannot be horizontally scaled the way readReplicas can                                                                      | `1`                   |
...
| `primary.podSecurityContext.seccompProfile.type`            | Set PostgreSQL primary pod's Security Context seccomp profile                                                                                                                                                                     | `RuntimeDefault`      |
...
| `readReplicas.podSecurityContext.seccompProfile.type`            | Set PostgreSQL read replica pod's Security Context seccomp profile                                                                                                                                                                          | `RuntimeDefault`      |
...
| `backup.cronjob.podSecurityContext.seccompProfile.type`            | Set backup CronJob pod's Security Context seccomp profile                                                                                                                                                                                     | `RuntimeDefault`                                                                                                                                                                                                                                   |
...
| `passwordUpdateJob.podSecurityContext.seccompProfile.type`            | Set credential init job pod's Security Context seccomp profile                                                                                                                                                                                        | `RuntimeDefault` |
