...
| `image.tag`                             | Apache image tag (immutable tags are recommended)                                                                        | `2.4.54-debian-11-r29` |
...
| `git.tag`                               | Git image tag (immutable tags are recommended)                                                                           | `2.37.2-debian-11-r5`  |
...
| `metrics.image.tag`                        | Apache Exporter image tag (immutable tags are recommended)                                                                                | `0.11.0-debian-11-r34`    |
