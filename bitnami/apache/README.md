...
| `image.tag`                             | Apache image tag (immutable tags are recommended)                                                                        | `2.4.57-debian-11-r116` |
...
| `git.tag`                               | Git image tag (immutable tags are recommended)                                                                           | `2.41.0-debian-11-r58`  |
