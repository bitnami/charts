...
| `metrics.scrapeUri`                           | Apache Exporter scrape_uri. Default scrape_uri is `'http://status.localhost:{{ .Values.containerPorts.http }}/server-status/?auto'` if this variable is empty.                                                                    | `""`                              |
