...
| `image.tag`                             | Apache image tag (immutable tags are recommended)                                                                        | `2.4.55-debian-11-r0`  |
...
| `git.tag`                               | Git image tag (immutable tags are recommended)                                                                           | `2.39.0-debian-11-r11` |
