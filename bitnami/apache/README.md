...
| `image.tag`                             | Apache image tag (immutable tags are recommended)                                                                        | `2.4.57-debian-11-r163` |
...
| `metrics.image.tag`                        | Apache Exporter image tag (immutable tags are recommended)                                                                                | `1.0.1-debian-11-r47`     |
