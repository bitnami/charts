...
| `image.tag`                             | Apache image tag (immutable tags are recommended)                                                                        | `2.4.54-debian-11-r62` |
...
| `git.tag`                               | Git image tag (immutable tags are recommended)                                                                           | `2.38.1-debian-11-r16` |
...
| `metrics.image.tag`                        | Apache Exporter image tag (immutable tags are recommended)                                                                                | `0.11.0-debian-11-r68`    |
