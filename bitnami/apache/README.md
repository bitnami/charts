...
| `image.tag`                             | Apache image tag (immutable tags are recommended)                                                                        | `2.4.57-debian-11-r14` |
...
| `git.tag`                               | Git image tag (immutable tags are recommended)                                                                           | `2.40.1-debian-11-r3`  |
