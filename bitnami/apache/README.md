...
| `image.tag`                             | Apache image tag (immutable tags are recommended)                                                                        | `2.4.54-debian-11-r63` |
...
| `git.tag`                               | Git image tag (immutable tags are recommended)                                                                           | `2.38.1-debian-11-r17` |
