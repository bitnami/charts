...
| `image.tag`                             | Apache image tag (immutable tags are recommended)                                                                        | `2.4.57-debian-11-r19` |
...
| `git.tag`                               | Git image tag (immutable tags are recommended)                                                                           | `2.40.1-debian-11-r7`  |
...
| `metrics.image.tag`                        | Apache Exporter image tag (immutable tags are recommended)                                                                                | `0.13.3-debian-11-r8`     |
