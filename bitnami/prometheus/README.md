...
| `server.rbac.includeDefaultRules`                                 | Specifies whether to include default rules from official prometheus helm chart, https://github.com/prometheus-community/helm-charts/blob/main/charts/prometheus/templates/clusterrole.yaml                                                    | `true`                       |
