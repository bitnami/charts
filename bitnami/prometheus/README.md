...
| `alertmanager.image.tag`                                       | Alertmanager image tag (immutable tags are recommended)                                                                                                 | `0.25.0-debian-11-r163`         |
...
| `server.image.tag`                                                | Prometheus image tag (immutable tags are recommended)                                                                                                                                       | `2.46.0-debian-11-r0`      |
...
| `server.thanos.image.tag`                                         | Thanos image tag                                                                                                                                                                            | `0.31.0-scratch-r12`       |
