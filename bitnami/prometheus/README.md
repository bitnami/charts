...
| `server.image.tag`                                                | Prometheus image tag (immutable tags are recommended)                                                                                                                                       | `2.47.0-debian-11-r26`     |
...
| `server.thanos.image.tag`                                         | Thanos image tag                                                                                                                                                                            | `0.32.3-debian-11-r11`     |
