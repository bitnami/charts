...
| `alertmanager.image.tag`                                       | Alertmanager image tag (immutable tags are recommended)                                                                                                 | `0.26.0-debian-11-r11`          |
...
| `server.image.tag`                                                | Prometheus image tag (immutable tags are recommended)                                                                                                                                       | `2.47.0-debian-11-r0`      |
...
| `server.thanos.image.tag`                                         | Thanos image tag                                                                                                                                                                            | `0.32.2-debian-11-r2`      |
