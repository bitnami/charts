...
| `alertmanager.image.tag`                                       | Alertmanager image tag (immutable tags are recommended)                                                                                                 | `0.25.0-debian-11-r188`         |
...
| `server.image.tag`                                                | Prometheus image tag (immutable tags are recommended)                                                                                                                                       | `2.46.0-debian-11-r23`     |
...
| `server.thanos.image.tag`                                         | Thanos image tag                                                                                                                                                                            | `0.31.0-debian-11-r15`     |
