...
| `server.thanos.extraEnvVars`                                      | Array with extra environment variables to add to server.thanos nodes                                                                                                                                                                          | `[]`                         |
| `server.thanos.extraEnvVarsCM`                                    | Name of existing ConfigMap containing extra env vars for server.thanos nodes                                                                                                                                                                  | `""`                         |
| `server.thanos.extraEnvVarsSecret`                                | Name of existing Secret containing extra env vars for server.thanos nodes                                                                                                                                                                     | `""`                         |
