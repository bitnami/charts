...
| `alertmanager.image.tag`                                       | Alertmanager image tag (immutable tags are recommended)                                                                                                 | `0.25.0-debian-11-r183`         |
...
| `server.image.tag`                                                | Prometheus image tag (immutable tags are recommended)                                                                                                                                       | `2.46.0-debian-11-r20`     |
...
| `server.thanos.image.tag`                                         | Thanos image tag                                                                                                                                                                            | `0.31.0-debian-11-r14`     |
