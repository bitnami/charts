...
| `image.tag`                             | NodeJS image tag (immutable tags are recommended)                                         | `14.18.1-debian-10-r12` |
...
| `volumePermissions.image.tag`          | Init container volume-permissions image tag (immutable tags are recommended) | `10-debian-10-r232`     |
