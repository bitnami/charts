...
| `image.tag`                                   | NodeJS image tag (immutable tags are recommended)                                                                        | `16.14.2-debian-10-r36` |
...
| `git.image.tag`                | Git image tag (immutable tags are recommended)                 | `2.36.0-debian-10-r2`                        |
