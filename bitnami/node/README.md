...
| `image.tag`                             | NodeJS image tag (immutable tags are recommended)                                         | `14.17.4-debian-10-r0` |
...
| `git.image.tag`                | Git image tag (immutable tags are recommended)      | `2.32.0-debian-10-r46`                       |
