...
| `image.tag`                             | NodeJS image tag (immutable tags are recommended)                                         | `14.17.5-debian-10-r13` |
...
| `git.image.tag`                | Git image tag (immutable tags are recommended)      | `2.33.0-debian-10-r8`                        |
