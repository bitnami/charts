...
| `image.tag`                                   | NodeJS image tag (immutable tags are recommended)                                                                        | `16.14.2-debian-10-r20` |
...
| `git.image.tag`                | Git image tag (immutable tags are recommended)                 | `2.35.1-debian-10-r66`                       |
