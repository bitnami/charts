...
| `image.tag`                            | phpBB Image tag (immutable tags are recommended)                                                                                                          | `3.3.5-debian-10-r0`    |
...
| `metrics.image.tag`         | Apache exporter image tag (immutable tags are recommended) | `0.10.1-debian-10-r12`    |
