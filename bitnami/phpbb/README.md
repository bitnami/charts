...
| `image.tag`                             | phpBB image tag (immutable tags are recommended)                                                                                                          | `3.3.9-debian-11-r21`   |
...
| `metrics.image.tag`         | Apache exporter image tag (immutable tags are recommended)                                                      | `0.11.0-debian-11-r87`    |
