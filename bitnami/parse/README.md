...
| `server.image.tag`                                       | Parse image tag (immutable tags are recommended)                                                                         | `6.3.0-debian-11-r0` |
...
| `dashboard.image.tag`                                       | Dashboard image tag (immutable tags are recommended)                                                                     | `5.2.0-debian-11-r0`      |
