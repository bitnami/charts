...
| `server.image.tag`                                       | Parse image tag (immutable tags are recommended)                                                                         | `6.0.0-debian-11-r14` |
...
| `dashboard.image.tag`                                       | Dashboard image tag (immutable tags are recommended)                                                                     | `5.0.0-debian-11-r45`     |
