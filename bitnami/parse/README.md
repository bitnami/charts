...
| `server.image.tag`                                       | Parse image tag (immutable tags are recommended)                                                                         | `6.0.0-debian-11-r11` |
...
| `dashboard.image.tag`                                       | Dashboard image tag (immutable tags are recommended)                                                                     | `5.0.0-debian-11-r43`     |
