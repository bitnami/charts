...
| `server.image.tag`                                       | Parse image tag (immutable tags are recommended)                                                                         | `5.2.0-debian-10-r34` |
...
| `dashboard.image.tag`                                       | Dashboard image tag (immutable tags are recommended)                                                                     | `3.3.0-debian-10-r112`    |
