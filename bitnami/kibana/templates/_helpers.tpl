...
kibana: tls.enabled
    In order to enable HTTPS for Kibana, you also need to provide
...
kibana: missing-kibana-credentials
    You specified Elasticsearch authentication is enabled but didn't provide
    credentials for the Kibana server.
{{- end -}}
{{- end -}}
...
kibana: missing-elasticsearch-trusted-ca
    You configured communication with Elasticsearch REST API using HTTPS and verification enabled
    but no Truststore or CA certificate was provided.
{{- end -}}
{{- end -}}
