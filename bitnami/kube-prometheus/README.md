...
| `prometheus.sampleLimit`                                              | Per-scrape max number of scraped samples. Requires Prometheus v2.45.0 and newer                                                  | `0`                       |
| `prometheus.enforcedSampleLimit`                                      | Override sampleLimits set by ServiceMonitor, PodMonitor or Probe objects                                                         | `0`                       |
...
| `prometheus.thanos.image.tag`                                         | Thanos image tag                                                                                                                 | `0.31.0-scratch-r12`      |
