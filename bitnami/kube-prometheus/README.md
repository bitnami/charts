...
| `operator.image.tag`                                                                  | Prometheus Operator image tag (immutable tags are recommended)                                                         | `0.64.0-debian-11-r0`         |
...
| `prometheus.scrapeInterval`                                           | Interval between consecutive scrapes                                                                                             | `1m`                      |
| `prometheus.evaluationInterval`                                       | Interval between consecutive evaluations                                                                                         | `1m`                      |
...
| `alertmanager.image.tag`                                         | Prometheus image tag (immutable tags are recommended)                                                                                                                                                                                                                                                      | `0.25.0-debian-11-r33`   |
...
| `blackboxExporter.image.tag`                                   | Blackbox Exporter image tag (immutable tags are recommended)                                                      | `0.23.0-debian-11-r39`      |
