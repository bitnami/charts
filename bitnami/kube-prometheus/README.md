...
| `operator.image.tag`                                                                  | Prometheus Operator image tag (immutable tags are recommended)                                                         | `0.68.0-debian-11-r0`         |
...
| `prometheus.image.tag`                                                | Prometheus image tag (immutable tags are recommended)                                                                            | `2.47.0-debian-11-r0`     |
...
| `prometheus.thanos.image.tag`                                         | Thanos image tag                                                                                                                 | `0.32.2-debian-11-r5`     |
...
| `alertmanager.image.tag`                                         | Prometheus image tag (immutable tags are recommended)                                                                                                                                                                                                                                                      | `0.26.0-debian-11-r14`   |
...
| `blackboxExporter.image.tag`                                   | Blackbox Exporter image tag (immutable tags are recommended)                                                      | `0.24.0-debian-11-r109`     |
