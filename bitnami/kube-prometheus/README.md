...
| `prometheus.web`                                                      | WebTLSConfig defines the TLS parameters for HTTPS                                                          | `{}`                     |
| `prometheus.enableFeatures`                                           | EnableFeatures API enables access to Prometheus disabled features.                                         | `[]`                     |
