...
| `operator.image.tag`                                                                  | Prometheus Operator image tag (immutable tags are recommended)                                                         | `0.61.0-debian-11-r0`         |
...
| `prometheus.image.tag`                                                | Prometheus image tag (immutable tags are recommended)                                                                            | `2.40.2-debian-11-r1`     |
...
| `alertmanager.image.tag`                                         | Prometheus image tag (immutable tags are recommended)                                                                                                                                                                                                                                                      | `0.24.0-debian-11-r60`   |
...
| `blackboxExporter.image.tag`                                   | Blackbox Exporter image tag (immutable tags are recommended)                                                      | `0.22.0-debian-11-r37`      |
