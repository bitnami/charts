...
| `operator.image.tag`                                                                  | Prometheus Operator Image tag (immutable tags are recommended)                                                         | `0.57.0-debian-11-r4`         |
...
| `prometheus.image.tag`                                                | Prometheus Image tag (immutable tags are recommended)                                                                            | `2.36.1-debian-11-r2`     |
...
| `prometheus.thanos.image.tag`                                         | Thanos image tag                                                                                                                 | `0.26.0-scratch-r4`       |
...
| `alertmanager.image.tag`                                         | Prometheus Image tag (immutable tags are recommended)                                                                                                                                                                                                                                                      | `0.24.0-debian-11-r5`    |
...
| `blackboxExporter.image.tag`                                   | Blackbox Exporter Image tag (immutable tags are recommended)                                               | `0.21.0-debian-11-r5`       |
