...
| `operator.image.tag`                                                                  | Prometheus Operator image tag (immutable tags are recommended)                                                         | `0.67.1-debian-11-r19`        |
...
| `prometheus.image.tag`                                                | Prometheus image tag (immutable tags are recommended)                                                                            | `2.46.0-debian-11-r25`    |
...
| `prometheus.thanos.image.tag`                                         | Thanos image tag                                                                                                                 | `0.32.0-debian-11-r0`     |
...
| `alertmanager.image.tag`                                         | Prometheus image tag (immutable tags are recommended)                                                                                                                                                                                                                                                      | `0.26.0-debian-11-r0`    |
...
| `blackboxExporter.image.tag`                                   | Blackbox Exporter image tag (immutable tags are recommended)                                                      | `0.24.0-debian-11-r94`      |
