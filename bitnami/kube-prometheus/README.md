...
| `operator.image.tag`                                                                  | Prometheus Operator Image tag (immutable tags are recommended)                                                         | `0.51.1-debian-10-r0`         |
...
| `prometheus.image.tag`                                                | Prometheus Image tag (immutable tags are recommended)                                                                            | `2.30.0-debian-10-r13`   |
...
| `prometheus.thanos.image.tag`                                         | Thanos image tag                                                                                                                 | `0.23.0-scratch-r0`      |
...
| `alertmanager.image.tag`                                         | Prometheus Image tag (immutable tags are recommended)                                                                            | `0.23.0-debian-10-r33`   |
