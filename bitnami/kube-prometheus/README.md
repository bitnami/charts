...
| `operator.image.tag`                                                                  | Prometheus Operator image tag (immutable tags are recommended)                                                         | `0.66.0-debian-11-r8`         |
...
| `prometheus.image.tag`                                                | Prometheus image tag (immutable tags are recommended)                                                                            | `2.45.0-debian-11-r2`     |
...
| `alertmanager.image.tag`                                         | Prometheus image tag (immutable tags are recommended)                                                                                                                                                                                                                                                      | `0.25.0-debian-11-r65`   |
...
| `blackboxExporter.image.tag`                                   | Blackbox Exporter image tag (immutable tags are recommended)                                                      | `0.24.0-debian-11-r16`      |
