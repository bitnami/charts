...
| `prometheus.ingress.hosts`                                            | The list of hostnames to be covered with this ingress record.                                                                    | `[]`                   |
| `prometheus.ingress.tls`                                              | The tls configuration for the ingress                                                                                            | `{}`                   |
...
| `alertmanager.ingress.hosts`                                     | The list of hostnames to be covered with this ingress record.                                                                    | `[]`                    |
| `alertmanager.ingress.tls`                                       | The tls configuration for the ingress                                                                                            | `{}`                    |
