...
| `service.headless.ipFamilies`                                                    | IP families for the headless service                                                                                                                                                                                                                                        | `["IPv4"]`                |
| `service.headless.ipFamilyPolicy`                                                | IP family policy for the headless service                                                                                                                                                                                                                                   | `SingleStack`             |
...
| `externalAccess.controller.service.ipFamilies`                                   | IP families for the external controller service                                                                                                                                                                                                                             | `["IPv4"]`                |
| `externalAccess.controller.service.ipFamilyPolicy`                               | IP family policy for the external controller service                                                                                                                                                                                                                        | `SingleStack`             |
...
| `externalAccess.broker.service.ipFamilies`                                       | IP families for the external broker service                                                                                                                                                                                                                                 | `["IPv4"]`                |
| `externalAccess.broker.service.ipFamilyPolicy`                                   | IP family policy for the external broker service                                                                                                                                                                                                                            | `SingleStack`             |
...
| `metrics.jmx.service.ipFamilies`                                | IP families for the jmx metrics service                                                                                                                                                                                                   | `["IPv4"]`                                                                              |
| `metrics.jmx.service.ipFamilyPolicy`                            | IP family policy for the jmx metrics service                                                                                                                                                                                              | `SingleStack`                                                                           |
