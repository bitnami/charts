...
| `externalAccess.controller.service.advertisedExternalPort`                       | Overwrite port that would be used in advertised.listeners for domain set in externalAccess.controller.service.domain when service type is NodePort                                                                                                                          | `""`                      |
...
| `externalAccess.broker.service.advertisedExternalPort`                           | Overwrite port that would be used in advertised.listeners for domain set in externalAccess.broker.service.domain when service type is NodePort                                                                                                                              | `""`                      |
