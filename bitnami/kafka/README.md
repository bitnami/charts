...
| `image.tag`                                | Kafka image tag (immutable tags are recommended)                                                                                                                                    | `3.1.0-debian-10-r60`                |
...
| `externalAccess.autoDiscovery.image.tag`          | Init container auto-discovery image tag (immutable tags are recommended)                          | `1.23.6-debian-10-r22` |
...
| `volumePermissions.image.tag`                          | Init container volume-permissions image tag (immutable tags are recommended)    | `10-debian-10-r379`     |
...
| `metrics.kafka.image.tag`                                   | Kafka exporter image tag (immutable tags are recommended)                                                                        | `1.4.2-debian-10-r188`                                                                  |
...
| `metrics.jmx.image.tag`                                     | JMX exporter image tag (immutable tags are recommended)                                                                          | `0.16.1-debian-10-r251`                                                                 |
...
| `metrics.jmx.port`                                          | JMX application exporter port - Default conflicts with Kafka CLI                                                                 | `5555`                                                                                  |
