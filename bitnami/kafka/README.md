...
| `image.tag`                                | Kafka image tag (immutable tags are recommended)                                                                                                                                    | `3.1.1-debian-10-r0`                |
...
| `metrics.kafka.image.tag`                                   | Kafka exporter image tag (immutable tags are recommended)                                                                        | `1.4.2-debian-10-r233`                                                                  |
...
| `metrics.jmx.image.tag`                                     | JMX exporter image tag (immutable tags are recommended)                                                                          | `0.16.1-debian-10-r296`                                                                 |
