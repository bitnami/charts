...
| `image.tag`                                       | Kafka image tag (immutable tags are recommended)                                                                                                                                    | `3.5.0-debian-11-r0`                |
...
| `externalAccess.autoDiscovery.image.tag`          | Init container auto-discovery image tag (immutable tags are recommended)                                                                  | `1.25.11-debian-11-r3` |
...
| `volumePermissions.image.tag`                          | Init container volume-permissions image tag (immutable tags are recommended)                                                      | `11-debian-11-r129`     |
...
| `metrics.kafka.image.tag`                                   | Kafka exporter image tag (immutable tags are recommended)                                                                        | `1.7.0-debian-11-r10`                                                                   |
...
| `metrics.jmx.image.tag`                                     | JMX exporter image tag (immutable tags are recommended)                                                                          | `0.18.0-debian-11-r33`                                                                  |
