...
| `image.tag`                                       | Kafka image tag (immutable tags are recommended)                                                                                                                                    | `3.2.1-debian-11-r16`               |
...
| `externalAccess.autoDiscovery.image.tag`          | Init container auto-discovery image tag (immutable tags are recommended)                                   | `1.25.0-debian-11-r4` |
...
| `volumePermissions.image.tag`                          | Init container volume-permissions image tag (immutable tags are recommended)                                                      | `11-debian-11-r35`      |
...
| `metrics.kafka.image.tag`                                   | Kafka exporter image tag (immutable tags are recommended)                                                                        | `1.6.0-debian-11-r8`                                                                    |
...
| `metrics.jmx.image.tag`                                     | JMX exporter image tag (immutable tags are recommended)                                                                          | `0.17.1-debian-11-r1`                                                                   |
