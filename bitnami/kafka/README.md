...
| `controller.heapOpts`                                          | Kafka Java Heap configuration for controller-eligible nodes                                                                                                                                                                             | `-XX:InitialRAMPercentage=75 -XX:MaxRAMPercentage=75` |
...
| `controller.podSecurityContext.seccompProfile.type`            | Set Kafka pod's Security Context seccomp profile                                                                                                                                                                                        | `RuntimeDefault`                                      |
...
| `controller.containerSecurityContext.seccompProfile.type`      | Set Kafka containers' Security Context seccomp profile                                                                                                                                                                                  | `RuntimeDefault`                                      |
...
| `broker.heapOpts`                                          | Kafka Java Heap configuration for broker-only nodes                                                                                                                                                                             | `-XX:InitialRAMPercentage=75 -XX:MaxRAMPercentage=75` |
...
| `broker.containerSecurityContext.seccompProfile.type`      | Set Kafka containers' Security Context seccomp profile                                                                                                                                                                          | `RuntimeDefault`                                      |
...
| `metrics.jmx.containerSecurityContext.seccompProfile.type`      | Set Prometheus JMX exporter containers' Security Context seccomp profile                                                                                                                                                                  | `RuntimeDefault`                                                                        |
...
| `metrics.jmx.service.ipFamilies`                                | IP families for the jmx metrics service                                                                                                                                                                                                   | `[]`                                                                                    |
| `metrics.jmx.service.ipFamilyPolicy`                            | IP family policy for the jmx metrics service                                                                                                                                                                                              | `""`                                                                                    |
...
| `provisioning.waitForKafka`                                      | Whether an init container should be created to wait until Kafka is ready before provisioning                                                                                                                                                | `true`                |
...
| `provisioning.containerSecurityContext.seccompProfile.type`      | Set Kafka provisioning containers' Security Context seccomp profile                                                                                                                                                                          | `RuntimeDefault`      |
