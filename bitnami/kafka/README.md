...
| `image.tag`                                       | Kafka image tag (immutable tags are recommended)                                                                                                                                    | `3.2.0-debian-11-r10`               |
...
| `metrics.kafka.image.tag`                                   | Kafka exporter image tag (immutable tags are recommended)                                                                        | `1.4.2-debian-11-r10`                                                                   |
...
| `metrics.jmx.image.tag`                                     | JMX exporter image tag (immutable tags are recommended)                                                                          | `0.17.0-debian-11-r10`                                                                  |
