...
| `image.tag`                                       | Kafka image tag (immutable tags are recommended)                                                                                                                                    | `3.2.3-debian-11-r0`                |
...
| `externalAccess.autoDiscovery.image.tag`          | Init container auto-discovery image tag (immutable tags are recommended)                                   | `1.25.1-debian-11-r0` |
...
| `volumePermissions.image.tag`                          | Init container volume-permissions image tag (immutable tags are recommended)                                                      | `11-debian-11-r36`      |
...
| `metrics.kafka.image.tag`                                   | Kafka exporter image tag (immutable tags are recommended)                                                                        | `1.6.0-debian-11-r9`                                                                    |
