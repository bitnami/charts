...
| `externalAccess.service.loadBalancerNames`        | Array of load balancer names for each Kafka broker.If this paramater is not defined, IP addresss will be used for external access. Length must be the same as replicaCount    | `[]`                  |
