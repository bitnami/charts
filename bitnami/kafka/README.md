...
| `containerSecurityContext.enabled`   | Kafka containers' Security Context                                                                                                                                                            | `false`         |
...
| `metrics.kafka.containerSecurityContext.enabled`            | Prometheus Kafka Exporter security context                                                                                       | `false`                                                                                 |
...
| `metrics.jmx.containerSecurityContext.enabled`              | JMX Exporter security context                                                                                                    | `false`                                                                                 |
