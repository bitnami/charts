...
| `metrics.kafka.pdb.create`                                        | Enable/disable a Pod Disruption Budget creation                                                                                                                                                                                               | `false`                                                                                 |
| `metrics.kafka.pdb.minAvailable`                                  | Minimum number/percentage of pods that should remain scheduled                                                                                                                                                                                | `1`                                                                                     |
| `metrics.kafka.pdb.maxUnavailable`                                | Maximum number/percentage of pods that may be made unavailable                                                                                                                                                                                | `""`                                                                                    |
