...
| `serviceAccountName`                 | Name of the service account to use for Kafka pods                                                                                                                                                | `""`            |
...
| `metrics.kafka.serviceAccountName`               | Name of the service account to use for Kafka Exporter pods                                                                | `""`                                                                                    |
