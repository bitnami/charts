...
| `image.tag`                                       | Kafka image tag (immutable tags are recommended)                                                                                                                                    | `3.2.0-debian-10-r3`                |
...
| `externalAccess.autoDiscovery.image.tag`          | Init container auto-discovery image tag (immutable tags are recommended)                          | `1.24.0-debian-10-r4` |
...
| `metrics.kafka.image.tag`                                   | Kafka exporter image tag (immutable tags are recommended)                                                                        | `1.4.2-debian-10-r241`                                                                  |
...
| `metrics.jmx.image.tag`                                     | JMX exporter image tag (immutable tags are recommended)                                                                          | `0.16.1-debian-10-r305`                                                                 |
