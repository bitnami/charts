...
| `image.tag`                           | Kafka image tag (immutable tags are recommended)                                                                                                                                                           | `3.5.1-debian-11-r11` |
...
| `service.ports.client`                                       | Kafka svc port for client connections                                                                                                     | `19092`                 |
| `service.ports.controller`                                   | Kafka svc port for controller connections. It is used if "kraft.enabled: true"                                                            | `19093`                 |
| `service.ports.interbroker`                                  | Kafka svc port for inter-broker connections                                                                                               | `19094`                 |
| `service.ports.external`                                     | Kafka svc port for external connections                                                                                                   | `19095`                 |
...
| `externalAccess.autoDiscovery.image.tag`                     | Init container auto-discovery image tag (immutable tags are recommended)                                                                  | `1.25.12-debian-11-r14` |
...
| `metrics.kafka.image.tag`                                         | Kafka exporter image tag (immutable tags are recommended)                                                                        | `1.7.0-debian-11-r69`                                                                   |
...
| `metrics.jmx.image.tag`                                           | JMX exporter image tag (immutable tags are recommended)                                                                          | `0.19.0-debian-11-r33`                                                                  |
