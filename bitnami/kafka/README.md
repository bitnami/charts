...
| `broker.initContainerResources.limits`                                  | The resources limits for the init container                                                                                                                                                        | `{}`                      |
| `broker.initContainerResources.requests`                                  | The requested resources for the init container                                                                                                                                                       | `{}`                      |
