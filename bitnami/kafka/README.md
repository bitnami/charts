...
| `metrics.jmx.kafkaJmxLocalPort`                                   | JMX local port (for internal use via jconsole).                                                                                                                                                                                               | `36455`                                                                                 |
| `metrics.jmx.unsetDefaultKafkaJMXOpts`                            | Do not render the default chart value for KAFKA_JMX_OPTS.                                                                                                                                                                                     | `false`                                                                                 |
