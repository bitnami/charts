...
| `contour.image.tag`                                           | Contour image tag                                                                                                                  | `1.26.0-debian-11-r16` |
...
| `envoy.image.tag`                                             | Envoy Proxy image tag (immutable tags are recommended)                                                                | `1.26.4-debian-11-r66` |
...
| `defaultBackend.image.tag`                             | Default backend image tag                                                                                       | `1.25.2-debian-11-r45`   |
