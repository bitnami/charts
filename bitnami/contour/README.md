...
| `contour.image.tag`                                           | Contour image tag                                                                                                                  | `1.25.1-debian-11-r0` |
...
| `envoy.contour.resources.limits`                    | Specify resource limits which the container is not allowed to succeed.                                                | `contour.resources.limits`    |
| `envoy.contour.resources.requests`                  | Specify resource requests which the container needs to spawn.                                                         | `contour.resources.requests`  |
...
| `defaultBackend.image.tag`                             | Default backend image tag                                                                                       | `1.25.1-debian-11-r39`   |
