...
| `contour.image.tag`                                           | Contour image tag                                                                                                                  | `1.25.0-debian-11-r73` |
...
| `envoy.image.tag`                                             | Envoy Proxy image tag (immutable tags are recommended)                                                                | `1.26.3-debian-11-r10` |
...
| `defaultBackend.image.tag`                             | Default backend image tag                                                                                       | `1.25.1-debian-11-r37`   |
