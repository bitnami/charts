...
| `contour.resourcesPreset`                                     | Set container resources according to one common preset (allowed values: none, nano, small, medium, large, xlarge, 2xlarge). This is ignored if contour.resources is set (contour.resources is recommended for production). | `none`                    |
...
| `contour.certgen.networkPolicy.extraIngress`                  | Add extra ingress rules to the NetworkPolice                                                                                                                                                                               | `[]`                      |
...
| `contour.networkPolicy.extraIngress`                          | Add extra ingress rules to the NetworkPolice                                                                                                                                                                               | `[]`                      |
...
| `envoy.resourcesPreset`                                                   | Set container resources according to one common preset (allowed values: none, nano, small, medium, large, xlarge, 2xlarge). This is ignored if envoy.resources is set (envoy.resources is recommended for production).                                 | `none`                  |
...
| `envoy.shutdownManager.resourcesPreset`                                   | Set container resources according to one common preset (allowed values: none, nano, small, medium, large, xlarge, 2xlarge). This is ignored if envoy.shutdownManager.resources is set (envoy.shutdownManager.resources is recommended for production). | `none`                  |
...
| `envoy.networkPolicy.extraIngress`                                        | Add extra ingress rules to the NetworkPolice                                                                                                                                                                                                           | `[]`                    |
