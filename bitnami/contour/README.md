...
| `contour.image.tag`                                           | Contour image tag                                                                                                                  | `1.21.1-debian-11-r14` |
...
| `envoy.image.tag`                                   | Envoy Proxy image tag (immutable tags are recommended)                                                                | `1.22.2-debian-11-r14` |
...
| `defaultBackend.image.tag`                             | Default backend image tag                                                                            | `1.23.1-debian-11-r2`    |
