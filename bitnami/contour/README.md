...
| `contour.image.tag`                                           | Contour image tag                                                                                                                  | `1.21.0-debian-11-r0` |
...
| `contour.runtimeClassName`                                    | Name of the runtime class to be used by pod(s)                                                                                     | `""`                  |
...
| `envoy.image.tag`                                   | Envoy Proxy image tag (immutable tags are recommended)                                                                | `1.22.1-debian-11-r0` |
...
| `envoy.runtimeClassName`                            | Name of the runtime class to be used by pod(s)                                                                        | `""`                  |
...
| `defaultBackend.image.tag`                             | Default backend image tag                                                                            | `1.21.6-debian-11-r4`    |
...
| `defaultBackend.runtimeClassName`                      | Name of the runtime class to be used by pod(s)                                                       | `""`                     |
