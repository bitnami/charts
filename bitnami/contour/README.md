...
| `contour.image.tag`                                           | Contour image tag                                                                                                                  | `1.25.0-debian-11-r20` |
...
| `envoy.image.tag`                                                   | Envoy Proxy image tag (immutable tags are recommended)                                                                | `1.26.2-debian-11-r12` |
...
| `envoy.shutdownManager.containerSecurityContext.enabled`            | Envoy shutdownManager Container securityContext                                                                       | `true`                 |
...
| `defaultBackend.image.tag`                             | Default backend image tag                                                                                       | `1.25.1-debian-11-r9`    |
