...
| `configInline.tls.fallback-certificate`           | Defines the name/namespace matching a secret to use as the fallback certificate                                                    | `undefined`                                     |
...
| `contour.image.pullSecrets`                       | Contour Image pull secrets                                                                                                         | `undefined`                                     |
| `contour.hostAliases`                             | Add deployment host aliases                                                                                                        | `undefined`                                     |
| `contour.extraArgs`                               | Extra arguments passed to Contour container                                                                                        | `undefined`                                     |
| `contour.resources.limits`                        | Specify resource limits which the container is not allowed to succeed.                                                             | `undefined`                                     |
| `contour.resources.requests`                      | Specify resource requests which the container needs to spawn.                                                                      | `undefined`                                     |
...
| `contour.nodeAffinityPreset.values`               | Contour Node label values to match. Ignored if `affinity` is set.                                                                  | `undefined`                                     |
| `contour.affinity`                                | Affinity for Contour pod assignment                                                                                                | `undefined`                                     |
| `contour.nodeSelector`                            | Node labels for Contour pod assignment                                                                                             | `undefined`                                     |
| `contour.tolerations`                             | Tolerations for Contour pod assignment                                                                                             | `undefined`                                     |
| `contour.podAnnotations`                          | Contour Pod annotations                                                                                                            | `undefined`                                     |
...
| `contour.service.extraPorts`                      | Extra ports to expose (normally used with the `sidecar` value)                                                                     | `undefined`                                     |
| `contour.initContainers`                          | Attach additional init containers to Contour pods                                                                                  | `undefined`                                     |
| `contour.sidecars`                                | Add additional sidecar containers to the Contour pods                                                                              | `undefined`                                     |
| `contour.extraVolumes`                            | Array to add extra volumes                                                                                                         | `undefined`                                     |
| `contour.extraVolumeMounts`                       | Array to add extra mounts (normally used with extraVolumes)                                                                        | `undefined`                                     |
| `contour.extraEnvVars`                            | Array containing extra env vars to be added to all Contour containers                                                              | `undefined`                                     |
...
| `envoy.image.pullSecrets`                           | Envoy image pull secrets                                                                                              | `undefined`            |
| `envoy.extraArgs`                                   | Extra arguments passed to Envoy container                                                                             | `undefined`            |
| `envoy.hostAliases`                                 | Add deployment host aliases                                                                                           | `undefined`            |
| `envoy.resources.limits`                            | Specify resource limits which the container is not allowed to succeed.                                                | `undefined`            |
| `envoy.resources.requests`                          | Specify resource requests which the container needs to spawn.                                                         | `undefined`            |
| `envoy.kind`                                        | Install as Deployment or DaemonSet                                                                                    | `DaemonSet`            |
| `envoy.replicaCount`                                | Desired number of Controller pods                                                                                     | `1`                    |
| `envoy.updateStrategy`                              | Strategy to use to update Pods                                                                                        | `undefined`            |
...
| `envoy.nodeAffinityPreset.values`                   | Envoy Node label values to match. Ignored if `affinity` is set.                                                       | `undefined`            |
| `envoy.affinity`                                    | Affinity for Envoy pod assignment                                                                                     | `undefined`            |
| `envoy.nodeSelector`                                | Node labels for Envoy pod assignment                                                                                  | `undefined`            |
| `envoy.tolerations`                                 | Tolerations for Envoy pod assignment                                                                                  | `undefined`            |
| `envoy.podAnnotations`                              | Envoy Pod annotations                                                                                                 | `undefined`            |
...
| `envoy.service.externalIPs`                         | Envoy service external IP addresses                                                                                   | `undefined`            |
| `envoy.service.loadBalancerIP`                      | IP address to assign to load balancer (if supported)                                                                  | `""`                   |
| `envoy.service.loadBalancerSourceRanges`            | List of IP CIDRs allowed access to load balancer (if supported)                                                       | `undefined`            |
| `envoy.service.annotations`                         | Annotations for Envoy service                                                                                         | `undefined`            |
...
| `envoy.service.extraPorts`                          | Extra ports to expose (normally used with the `sidecar` value)                                                        | `undefined`            |
...
| `envoy.initContainers`                              | Attach additional init containers to Envoy pods                                                                       | `undefined`            |
| `envoy.extraVolumes`                                | Array to add extra volumes                                                                                            | `undefined`            |
| `envoy.extraVolumeMounts`                           | Array to add extra mounts (normally used with extraVolumes)                                                           | `undefined`            |
| `envoy.extraEnvVars`                                | Array containing extra env vars to be added to all Envoy containers                                                   | `undefined`            |
...
| `defaultBackend.image.pullSecrets`                  | Specify docker-registry secret names as an array                                                     | `undefined`            |
| `defaultBackend.extraArgs`                          | Additional command line arguments to pass to NGINX container                                         | `undefined`            |
| `defaultBackend.containerPort`                      | HTTP container port number                                                                           | `8080`                 |
| `defaultBackend.hostAliases`                        | Add deployment host aliases                                                                          | `undefined`            |
...
| `defaultBackend.resources.limits`                   | The resources limits for the Default backend container                                               | `undefined`            |
| `defaultBackend.resources.requests`                 | The requested resources for the Default backend container                                            | `undefined`            |
...
| `defaultBackend.customLivenessProbe`                | Override default liveness probe, it overrides the default one (evaluated as a template)              | `undefined`            |
| `defaultBackend.customReadinessProbe`               | Override default readiness probe, it overrides the default one (evaluated as a template)             | `undefined`            |
| `defaultBackend.podLabels`                          | Extra labels for Controller pods                                                                     | `undefined`            |
| `defaultBackend.podAnnotations`                     | Annotations for Controller pods                                                                      | `undefined`            |
...
| `defaultBackend.nodeAffinityPreset.values`          | Node label values to match. Ignored if `affinity` is set.                                            | `undefined`            |
| `defaultBackend.affinity`                           | Affinity for pod assignment. Evaluated as a template.                                                | `undefined`            |
| `defaultBackend.nodeSelector`                       | Node labels for pod assignment. Evaluated as a template.                                             | `undefined`            |
| `defaultBackend.tolerations`                        | Tolerations for pod assignment. Evaluated as a template.                                             | `undefined`            |
...
| `prometheus.serviceMonitor.metricRelabelings` | Specify additional relabeling of metrics.                                                                                            | `undefined`              |
| `prometheus.serviceMonitor.relabelings`       | Specify general relabeling.                                                                                                          | `undefined`              |
