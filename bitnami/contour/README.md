...
| `envoy.shutdownManager.extraArgs`                   | Extra arguments passed to  Contour shutdownManager sidecar                                                                                       | `[]`                |
| `envoy.shutdownManager.port`                        | Contour shutdownManager port                                                                                          | `8090`                |
...
| `envoy.readinessProbe.port` | Readiness port | `8002` |
...
| `envoy.startupProbe.port` | Startupprobe port for | `8002` |
