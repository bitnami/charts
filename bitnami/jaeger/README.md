...
| `image.tag`         | Jaeger image tag (immutable tags are recommended)                                                      | `1.46.0-debian-11-r9` |
...
| `cqlshImage.tag`                             | Cassandra image tag (immutable tags are recommended)                                                      | `4.0.10-debian-11-r11` |
