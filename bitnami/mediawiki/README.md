...
| `image.tag`          | MediaWiki image tag (immutable tags are recommended)                                                                                               | `1.39.3-debian-11-r9` |
...
| `metrics.image.tag`                        | Apache exporter image tag (immutable tags are recommended)                                                      | `0.13.3-debian-11-r1`     |
