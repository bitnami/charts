...
| `image.tag`          | MediaWiki image tag (immutable tags are recommended)                 | `1.36.1-debian-10-r25` |
...
| `metrics.image.tag`                       | Apache exporter image tag (immutable tags are recommended)                   | `0.9.0-debian-10-r40`     |
