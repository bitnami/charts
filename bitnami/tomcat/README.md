...
| `image.tag`                   | Tomcat image tag (immutable tags are recommended)                                                      | `10.1.8-debian-11-r3` |
...
| `metrics.jmx.image.tag`                             | JMX exporter image tag (immutable tags are recommended)                                                      | `0.18.0-debian-11-r13`                                                                                                                                                                                              |
