...
| `image.tag`                   | Tomcat image tag (immutable tags are recommended)                    | `10.0.13-debian-10-r0` |
...
| `metrics.jmx.image.tag`               | JMX exporter image tag (immutable tags are recommended)                            | `0.16.1-debian-10-r122`                                                                                                                                                                                             |
