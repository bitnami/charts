...
| `image.tag`                   | Tomcat image tag (immutable tags are recommended)                                                                       | `10.0.22-debian-11-r3` |
| `image.pullPolicy`            | Tomcat image pull policy                                                                                                | `IfNotPresent`         |
| `image.pullSecrets`           | Specify docker-registry secret names as an array                                                                        | `[]`                   |
| `image.debug`                 | Specify if debug logs should be enabled                                                                                 | `false`                |
| `hostAliases`                 | Deployment pod host aliases                                                                                             | `[]`                   |
| `tomcatUsername`              | Tomcat admin user                                                                                                       | `user`                 |
| `existingSecret`              | Name of existing secret to use for Tomcat credentials. `tomcatPassword` will be ignored and picked up from this secret. | `""`                   |
...
| `volumePermissions.image.tag`          | Init container volume-permissions image tag                                 | `11-debian-11-r5`       |
...
| `metrics.jmx.image.tag`                   | JMX exporter image tag (immutable tags are recommended)                                              | `0.17.0-debian-11-r6`                                                                                                                                                                                               |
