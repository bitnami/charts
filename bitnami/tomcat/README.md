...
| `image.tag`                   | Tomcat image tag (immutable tags are recommended)                    | `10.0.10-debian-10-r0` |
...
| `volumePermissions.image.tag`          | Init container volume-permissions image tag                                 | `10-debian-10-r154`     |
