...
| `image.tag`                   | Tomcat image tag (immutable tags are recommended)                                                      | `10.1.5-debian-11-r4` |
...
| `metrics.jmx.image.tag`                             | JMX exporter image tag (immutable tags are recommended)                                                      | `0.17.2-debian-11-r40`                                                                                                                                                                                              |
