...
| `image.tag`                   | Tomcat image tag (immutable tags are recommended)                    | `10.0.22-debian-11-r13` |
...
| `metrics.jmx.image.tag`                   | JMX exporter image tag (immutable tags are recommended)                                              | `0.17.0-debian-11-r14`                                                                                                                                                                                              |
