...
| `catalinaOps`                 | Set Java runtime option used by tomcat JVM                           | `""`                    |
...
| Name                                             | Description                                                                                                                      | Value                                                                                   |
| ------------------------------------------------ | -------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------- |
| `metrics.enabled`                                | Whether or not to enabled metrics                                                                                                | `false`                                                                                 |
...
| `metrics.jmx.port`                               | JMX Exporter Prometheus container port number                                                                                    | `5556`                                                                                  |
| `metrics.jmx.portName`                          | JMX Exporter Prometheus container port name                                                                                      | `metrics`                                                                               |
...
| `metrics.podMonitor.enabled`                     | if `true`, creates a Prometheus Operator ServiceMonitor (requires `metrics.jmx.enabled`)                                         | `false`                                                                                 |
| `metrics.podMonitor.namespace`                   | Namespace in which Prometheus is running                                                                                         | `""`                                                                                    |
...
| `metrics.podMonitor.additionalLabels`            | Additional labels that can be used so podMonitor will be discovered by Prometheus                                                | `{}`                                                                                    |
| `metrics.podMonitor.relabelings`                 | Relabel configuration for the metrics                                                                                            | `[]`                                                                                    |
