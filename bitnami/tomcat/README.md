...
| `image.tag`                   | Tomcat image tag (immutable tags are recommended)                                                      | `10.0.23-debian-11-r7` |
...
| `metrics.jmx.image.tag`                             | JMX exporter image tag (immutable tags are recommended)                                                      | `0.17.0-debian-11-r26`                                                                                                                                                                                              |
