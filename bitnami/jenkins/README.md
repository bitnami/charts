...
| `image.tag`         | Jenkins image tag (immutable tags are recommended)                                                      | `2.387.1-debian-11-r5` |
...
| `agent.image.tag`                                                         | Jenkins image tag (immutable tags are recommended)                                                      | `0.3107.0-debian-11-r10` |
