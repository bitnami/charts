...
| `image.tag`         | Jenkins image tag (immutable tags are recommended)                                                      | `2.387.3-debian-11-r1` |
...
| `agent.image.tag`                                                         | Jenkins image tag (immutable tags are recommended)                                                      | `0.3107.0-debian-11-r23` |
