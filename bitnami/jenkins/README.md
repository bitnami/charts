...
| `image.tag`         | Jenkins image tag (immutable tags are recommended) | `2.319.2-debian-10-r21` |
...
| `volumePermissions.image.tag`                 | Bitnami Shell image tag (immutable tags are recommended)                                        | `10-debian-10-r333`     |
...
| `metrics.image.tag`                          | Jenkins Jenkins Exporter image tag (immutable tags are recommended)                              | `0.20171225.0-debian-10-r699` |
