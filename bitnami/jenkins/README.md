...
| `image.tag`         | Jenkins image tag (immutable tags are recommended)                                                      | `2.401.2-debian-11-r26` |
...
| `agent.image.tag`                                                         | Jenkins image tag (immutable tags are recommended)                                                      | `0.3131.0-debian-11-r37` |
