...
| `server.image.tag`                      | TensorFlow Serving Image tag (immutable tags are recommended)                                                      | `2.13.0-debian-11-r22`       |
...
| `client.image.tag`                      | TensorFlow ResNet image tag (immutable tags are recommended)                                                       | `2.13.0-debian-11-r24`       |
