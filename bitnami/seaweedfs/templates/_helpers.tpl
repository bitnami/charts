...
{{/*
Return true if mTLS certificates are auto-generated
*/}}
{{- define "seaweedfs.security.mTLS.autoGenerated" -}}
{{- if or .Values.security.mTLS.autoGenerated.useHelm .Values.security.mTLS.autoGenerated.useCertManager -}}
    {{- true -}}
{{- end -}}
{{- end -}}
...
{{- if or (include "seaweedfs.security.mTLS.autoGenerated" .) (not (empty .Values.security.mTLS.ca)) -}}
...
{{- if or (include "seaweedfs.security.mTLS.autoGenerated" .) (and (not (empty .Values.security.mTLS.master.cert)) (not (empty .Values.security.mTLS.master.key))) -}}
...
{{- if or (include "seaweedfs.security.mTLS.autoGenerated" .) (and (not (empty .Values.security.mTLS.filer.cert)) (not (empty .Values.security.mTLS.filer.key))) -}}
...
{{- if or (include "seaweedfs.security.mTLS.autoGenerated" .) (and (not (empty .Values.security.mTLS.volume.cert)) (not (empty .Values.security.mTLS.volume.key))) -}}
...
{{- if or (include "seaweedfs.security.mTLS.autoGenerated" .) (and (not (empty .Values.security.mTLS.client.cert)) (not (empty .Values.security.mTLS.client.key))) -}}
...
{{/*
Return true if WebDAV TLS certificates are auto-generated
*/}}
{{- define "seaweedfs.webdav.tls.autoGenerated" -}}
{{- if or .Values.webdav.tls.autoGenerated.useHelm .Values.webdav.tls.autoGenerated.useCertManager -}}
    {{- true -}}
{{- end -}}
{{- end -}}
...
{{- if or (include "seaweedfs.webdav.tls.autoGenerated" .) (and (not (empty .Values.webdav.tls.cert)) (not (empty .Values.webdav.tls.key))) -}}
...
{{- if and .Values.security.enabled .Values.security.mTLS.enabled (include "seaweedfs.security.mTLS.autoGenerated" .) -}}
{{- if and .Values.security.mTLS.autoGenerated.useHelm .Values.security.mTLS.autoGenerated.useCertManager -}}
security.mTLS.autoGenerated
    Both Helm and Cert-Manager cannot be used to auto-generate MTLS certificates.
    Please disable one of the options (--set security.mTLS.autoGenerated.useHelm=false or
    --set security.mTLS.autoGenerated.useCertManager=false).
{{- end -}}
...
security.mTLS.autoGenerated
    ...
    Please disable auto-generated MTLS certificates (--set security.mTLS.autoGenerated=false) or
...
{{- if and .Values.filer.enabled .Values.webdav.enabled .Values.webdav.tls.enabled (include "seaweedfs.webdav.tls.autoGenerated" .) -}}
{{- if and .Values.webdav.tls.autoGenerated.useHelm .Values.webdav.tls.autoGenerated.useCertManager -}}
webdav.tls.autoGenerated
    Both Helm and Cert-Manager cannot be used to auto-generate TLS certificates.
    Please disable one of the options (--set webdav.tls.autoGenerated.useHelm=false or
    --set webdav.tls.autoGenerated.useCertManager=false).
{{- end -}}
