...
| `image.tag`                             | OpenCart image tag (immutable tags are recommended)                                                      | `4.0.2-0-debian-11-r0` |
...
| `certificates.image.tag`                             | Container sidecar image tag (immutable tags are recommended)                                                      | `11-debian-11-r107`                      |
