...
| `image.tag`                             | OpenCart image tag (immutable tags are recommended)                                                      | `4.0.2-2-debian-11-r0` |
...
| `metrics.image.tag`         | Apache exporter image tag (immutable tags are recommended)                                                      | `0.13.4-debian-11-r13`    |
