...
| `image.tag`                             | OpenCart image tag (immutable tags are recommended)                                                      | `4.0.1-1-debian-11-r64` |
...
| `certificates.image.tag`                             | Container sidecar image tag (immutable tags are recommended)                                                      | `11-debian-11-r99`                       |
