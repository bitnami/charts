...
| `server.image.tag`                                         | Vault Server image tag (immutable tags are recommended)                                                                                                 | `1.13.1-debian-11-r6` |
...
| `csiProvider.image.tag`                                                  | Vault CSI Provider image tag (immutable tags are recommended)                                                                                                 | `1.4.0-debian-11-r1`                          |
...
| `injector.image.tag`                                         | Vault Kubernetes Injector image tag (immutable tags are recommended)                                                                                                 | `1.2.1-debian-11-r5` |
