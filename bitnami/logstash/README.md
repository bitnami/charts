...
| `persistence.enabled`                      | Enable Logstash data persistence using PVC, note that Zookeeper persistence is unaffected                            | `true`                                                  |
| `persistence.existingClaim`                | Provide an existing `PersistentVolumeClaim`, the value is evaluated as a template                                    | `nil`                                                   |
| `persistence.storageClass`                 | PVC Storage Class for Logstash data volume                                                                           | `nil`                                                   |
| `persistence.accessMode`                   | PVC Access Mode for Logstash data volume                                                                             | `ReadWriteOnce`                                         |
