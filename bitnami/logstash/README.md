...
| `image.tag`                                   | Logstash image tag (immutable tags are recommended)                                                                               | `8.5.0-debian-11-r0`     |
...
| `autoscaling.enabled`                         | Enable Logstash statefulset autoscaling                                                                                           | `false`                  |
| `autoscaling.minReplicas`                     | Logstash statefulset autoscaling minimum number of replicas                                                                       | `3`                      |
| `autoscaling.maxReplicas`                     | Logstash statefulset autoscaling maximum number of replicas                                                                       | `6`                      |
| `autoscaling.targetCPU`                       | Logstash statefulset autoscaling target CPU percentage                                                                            | `50`                     |
| `autoscaling.targetMemory`                    | Logstash statefulset autoscaling target CPU memory                                                                                | `50`                     |
