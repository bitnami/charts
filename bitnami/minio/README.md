...
| `image.tag`               | MinIO&reg; image tag (immutable tags are recommended)                                                      | `2021.6.17-debian-10-r0` |
...
| `clientImage.tag`         | MinIO&reg; Client image tag (immutable tags are recommended)                                               | `2021.6.13-debian-10-r3` |
...
| `ingress.path`                     | The Path to MinIO(R). You may need to set this to '/*' in order to use this with ALB ingress controllers. | `/`                      |
...
| `volumePermissions.image.tag`                          | Init container volume-permissions image tag (immutable tags are recommended)                                         | `10-debian-10-r109`     |
