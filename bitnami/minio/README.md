...
| `defaultBuckets`           | Comma, semi-colon or space separated list of buckets to create at initialization (only in standalone mode). Do not set this value in distributed mode, as it will cause MinIO&reg; to crash.              | `""`                           |
...
Do not set `defaultBuckets` in distributed mode, as it will cause MinIO&reg; to crash.
