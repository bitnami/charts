...
| `image.tag`                | MinIO&reg; image tag (immutable tags are recommended)                                                                                                                                                            | `2021.10.13-debian-10-r2` |
...
| `clientImage.tag`          | MinIO&reg; Client image tag (immutable tags are recommended)                                                                                                                                                     | `2021.10.7-debian-10-r12` |
