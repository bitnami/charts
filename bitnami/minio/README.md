...
| `image.tag`                | MinIO&reg; image tag (immutable tags are recommended)                                                                                                                                                     | `2022.5.8-debian-10-r0` |
...
| `clientImage.tag`          | MinIO&reg; Client image tag (immutable tags are recommended)                                                                                                                                              | `2022.5.4-debian-10-r4` |
...
| `provisioning.usersExistingSecrets`     | MinIO&reg; users provisioning from existing Kubernetes secrets. Can be used in addition to provisioning.users.                                                                                | `[]`            |
...
| `volumePermissions.image.tag`                          | Init container volume-permissions image tag (immutable tags are recommended)                                         | `10-debian-10-r420`     |
