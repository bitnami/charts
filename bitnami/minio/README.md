...
| `image.tag`                | MinIO&reg; image tag (immutable tags are recommended)                                                                                                                                                     | `2022.6.25-debian-11-r0` |
...
| `clientImage.tag`          | MinIO&reg; Client image tag (immutable tags are recommended)                                                                                                                                              | `2022.6.17-debian-11-r2` |
...
| `persistence.selector`      | Selector to match an existing Persistent Volume for Minio data PVC.  | `{}`                |
