...
| `image.tag`                | MinIO&reg; image tag (immutable tags are recommended)                                                                                                                                                            | `2021.10.27-debian-10-r0` |
...
| `clientImage.tag`          | MinIO&reg; Client image tag (immutable tags are recommended)                                                                                                                                                     | `2021.10.7-debian-10-r20` |
