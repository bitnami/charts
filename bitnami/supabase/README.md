...
| `jwt.autoGenerate.kubectlImage.tag`                                  | Kubectl image tag (immutable tags are recommended)                                                                                                 | `1.26.4-debian-11-r9` |
...
| `auth.image.tag`                                       | Gotrue image tag (immutable tags are recommended)                                                                                                 | `1.0.1-debian-11-r31` |
...
| `rest.image.tag`                                       | PostgREST image tag (immutable tags are recommended)                                                                                                 | `10.2.0-debian-11-r9` |
...
| `studio.image.tag`                                       | Studio image tag (immutable tags are recommended)                                                                                                 | `0.23.4-debian-11-r0`     |
...
| `psqlImage.tag`                                        | PostgreSQL client image tag (immutable tags are recommended)                                    | `15.1.0-debian-11-r38`      |
...
| `postgresql.image.tag`                        | PostgreSQL image tag (immutable tags are recommended)                                                      | `15.1.0-debian-11-r38`                                                                                                       |
