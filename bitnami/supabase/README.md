...
| `jwt.autoGenerate.image.tag`                                         | JWT CLI image tag (immutable tags are recommended)                                                                                                 | `5.0.3-debian-11-r142` |
...
| `jwt.autoGenerate.kubectlImage.tag`                                  | Kubectl image tag (immutable tags are recommended)                                                                                                 | `1.26.7-debian-11-r5`  |
...
| `auth.image.tag`                                       | Gotrue image tag (immutable tags are recommended)                                                                                                 | `1.0.1-debian-11-r145` |
...
| `meta.image.tag`                                       | Supabase Postgres Meta image tag (immutable tags are recommended)                                                                                                 | `0.67.0-debian-11-r18`           |
...
| `realtime.image.tag`                                       | Realtime image tag (immutable tags are recommended)                                                                                                 | `2.19.1-debian-11-r2`       |
...
| `rest.image.tag`                                       | PostgREST image tag (immutable tags are recommended)                                                                                                 | `11.1.0-debian-11-r45` |
...
| `storage.image.tag`                                       | Storage image tag (immutable tags are recommended)                                                                                                 | `0.41.2-debian-11-r14`     |
...
| `studio.image.tag`                                       | Studio image tag (immutable tags are recommended)                                                                                                 | `0.23.6-debian-11-r17`    |
...
| `psqlImage.tag`                                        | PostgreSQL client image tag (immutable tags are recommended)                                    | `15.1.0-debian-11-r118`     |
...
| `postgresql.image.tag`                        | PostgreSQL image tag (immutable tags are recommended)                                                      | `15.1.0-debian-11-r118`                                                                                                      |
