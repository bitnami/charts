...
| `jwt.autoGenerate.image.tag`                                         | JWT CLI image tag (immutable tags are recommended)                                                                                                 | `5.0.3-debian-11-r28` |
...
| `jwt.autoGenerate.kubectlImage.tag`                                  | Kubectl image tag (immutable tags are recommended)                                                                                                 | `1.26.4-debian-11-r8` |
...
| `auth.image.tag`                                       | Gotrue image tag (immutable tags are recommended)                                                                                                 | `1.0.1-debian-11-r30` |
...
| `meta.image.tag`                                       | Supabase Postgres Meta image tag (immutable tags are recommended)                                                                                                 | `0.64.6-debian-11-r9`            |
...
| `realtime.image.tag`                                       | Realtime image tag (immutable tags are recommended)                                                                                                 | `2.13.0-debian-11-r3`       |
...
| `rest.image.tag`                                       | PostgREST image tag (immutable tags are recommended)                                                                                                 | `10.2.0-debian-11-r8` |
...
| `studio.image.tag`                                       | Studio image tag (immutable tags are recommended)                                                                                                 | `0.23.2-debian-11-r17`    |
...
| `psqlImage.tag`                                        | PostgreSQL client image tag (immutable tags are recommended)                                    | `15.1.0-debian-11-r37`      |
...
| `postgresql.image.tag`                        | PostgreSQL image tag (immutable tags are recommended)                                                      | `15.1.0-debian-11-r37`                                                                                                       |
