...
| `versionStoreType`                                  | Set version store type. The chart natively supports JDBC_POSTGRESQL and ROCKSDB. Any other type requires you to add the configuration in configOverrides and secretConfigOverrides.                                  | `JDBC_POSTGRESQL`        |
