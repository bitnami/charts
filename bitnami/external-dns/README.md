...
| `pdb.maxUnavailable`                                | Maximum number/percentage of pods that may be made unavailable. If pdb.minAvailable and pdb.maxUnavailable are empty and pdb.create is true, the maxUnavailable field in PodDisruptionBudget will be set 1        | `""`                           |
