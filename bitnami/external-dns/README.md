...
| `containerSecurityContext.allowPrivilegeEscalation` | Enable privilege escalation or the container                                                                                                                                 | `false`                   |
| `containerSecurityContext.capabilities.drop`        | Linux capabilities to drop                                                                                                                                                   | `["ALL"]`                 |
| `containerSecurityContext.readOnlyRootFilesystem`   | Make containers rootfs ready-only                                                                                                                                            | `true`                    |
| `containerSecurityContext.runAsNonRoot`             | Container must be required to run as non-root                                                                                                                                | `true`                    |
| `podSecurityContext.enabled`                        | Enable pod security context                                                                                                                                                  | `true`                    |
| `podSecurityContext.fsGroup`                        | Group ID for the pod                                                                                                                                                         | `1001`                    |
| `podSecurityContext.runAsUser`                      | User ID for the pod                                                                                                                                                          | `1001`                    |
| `podSecurityContext.seccompProfile.type`            | Seccomp profile to use                                                                                                                                                       | `RuntimeDefault`          |
