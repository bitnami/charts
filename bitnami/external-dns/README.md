...
| `txtEncrypt.enabled`                                | Enable TXT record encrypencryption                                                                                                                                                                         | `true`                         |
| `txtEncrypt.aesKey`                                 | 32-byte AES-256-GCM encryption key. The key must be specified in URL-safe base64 form.                                                                                                                     | `""`                           |
