...
| `transip.apiKey`                              | When using the TransIP provider, specify the API key to use. Mutually exclusive with transip.apiKeySecret.                                                                   | `""`                      |
| `transip.apiKeySecret`                        | When using the TransIP provider, specify the secret containing the API key to use. The secret should have a key named `transip-api-key`.                                     | `""`                      |
