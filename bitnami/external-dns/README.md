...
| `aws.dynamodbTable`                             | When using the AWS provider, sets the DynamoDB table name to use for dynamodb registry (https://github.com/kubernetes-sigs/external-dns/blob/0483ffde22e60436f16be154b9fe1a388a1400d0/docs/registry/dynamodb.md)   | `""`                      |
| `aws.dynamodbRegion`                            | When using the AWS provider, sets the DynamoDB table region to use for dynamodb registry (https://github.com/kubernetes-sigs/external-dns/blob/0483ffde22e60436f16be154b9fe1a388a1400d0/docs/registry/dynamodb.md) | `""`                      |
