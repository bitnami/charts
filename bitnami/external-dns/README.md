...
| `akamai.host`                                 | When using the Akamai provider, sets the EdgeGrid Host                                                                                                                       | `""`                      |
| `akamai.accessToken`                          | When using the Akamai provider, sets the EdgeGrid Access Token                                                                                                               | `""`                      |
| `akamai.clientToken`                          | When using the Akamai provider, sets the EdgeGrid Client Token                                                                                                               | `""`                      |
| `akamai.clientSecret`                         | When using the Akamai provider, sets the EdgeGrid Client Secret                                                                                                              | `""`                      |
| `akamai.secretName`                           | Use an existing secret with key "akamai_client_secret" defined.                                                                                                              | `""`                      |
...
| `linode.secretName`                           | Use an existing secret with key "_api_token" defined.                                                                                                                  | `""`                      |
