...
| `dataplatform.exporter.terminationGracePeriodSeconds`         | In seconds, time the given to the Data Platform Prometheus exporter pod needs to terminate gracefully            | `""`                            |
| `dataplatform.exporter.topologySpreadConstraints`             | Topology Spread Constraints for pod assignment                                                                   | `[]`                            |
| `dataplatform.exporter.lifecycleHooks`                        | for the Data Platform Prometheus exporter container(s) to automate configuration before or after startup         | `{}`                            |
...
| `dataplatform.exporter.initContainers`                        | Add init containers to the Data Platform Prometheus exporter pods                                                | `[]`                            |
| `dataplatform.exporter.sidecars`                              | Add sidecars to the Data Platform Prometheus exporter pods                                                       | `[]`                            |
...
| `dataplatform.exporter.service.clusterIP`                     | Data Platform Prometheus exporter service Cluster IP                                                             | `""`                            |
| `dataplatform.exporter.service.externalTrafficPolicy`         | Data Platform Prometheus exporter service external traffic policy                                                | `Cluster`                       |
...
| `dataplatform.emitter.customLivenessProbe`                    | Override default liveness probeData Platform emitter                                                             | `{}`                            |
| `dataplatform.emitter.customReadinessProbe`                   | Override default readiness probeData Platform emitter                                                            | `{}`                            |
