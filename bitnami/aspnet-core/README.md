...
| `image.tag`          | ASP.NET Core image tag (immutable tags are recommended)                                                      | `7.0.10-debian-11-r5` |
...
| `appFromExternalRepo.publish.image.tag`         | .NET SDK image tag (immutable tags are recommended)                                                      | `7.0.400-debian-11-r5`                               |
