...
| `image.tag`          | ASP.NET Core image tag (immutable tags are recommended)                                                      | `7.0.9-debian-11-r14` |
...
| `appFromExternalRepo.clone.image.tag`           | Git image tag (immutable tags are recommended)                                                           | `2.41.0-debian-11-r50`                               |
...
| `appFromExternalRepo.publish.image.tag`         | .NET SDK image tag (immutable tags are recommended)                                                      | `7.0.306-debian-11-r11`                              |
