...
| `image.tag`                      | Keycloak image tag (immutable tags are recommended)                                                                          | `22.0.3-debian-11-r0`         |
...
| `keycloakConfigCli.image.tag`                             | keycloak-config-cli container image tag                                                                                       | `5.8.0-debian-11-r42`         |
