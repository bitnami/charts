...
| `image.tag`                      | Keycloak image tag (immutable tags are recommended)                                                                          | `19.0.2-debian-11-r7` |
...
| `keycloakConfigCli.image.tag`                             | keycloak-config-cli container image tag                                                                                       | `5.3.1-debian-11-r21`         |
