...
| `image.tag`                      | Keycloak image tag (immutable tags are recommended)                                                                          | `20.0.3-debian-11-r10`        |
...
| `keycloakConfigCli.image.tag`                             | keycloak-config-cli container image tag                                                                                       | `5.5.0-debian-11-r27`         |
