...
| `image.tag`                      | Keycloak image tag (immutable tags are recommended)                                                                          | `18.0.2-debian-11-r14` |
...
| `keycloakConfigCli.image.tag`                             | keycloak-config-cli container image tag                                                         | `5.2.2-debian-11-r1`          |
