...
| `image.tag`                      | Keycloak image tag (immutable tags are recommended)                                                                          | `21.1.2-debian-11-r26`        |
...
| `keycloakConfigCli.image.tag`                             | keycloak-config-cli container image tag                                                                                       | `5.7.0-debian-11-r8`          |
