...
| `auth.tls.image.repository`       | TLS init container image repository                                                                                                                           | `bitnami/keycloak`                                 |
| `auth.tls.image.tag`              | TLS init container image tag                                                                                                                                  | `{TAG_NAME}`                                                  |
| `auth.tls.image.pullPolicy`       | TLS init container image pull policy                                                                                                                          | `IfNotPresent`                                                |
