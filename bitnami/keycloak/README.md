...
| `image.tag`                      | Keycloak image tag (immutable tags are recommended)                                                                          | `21.0.2-debian-11-r8`         |
...
| `keycloakConfigCli.image.tag`                             | keycloak-config-cli container image tag                                                                                       | `5.6.1-debian-11-r14`         |
