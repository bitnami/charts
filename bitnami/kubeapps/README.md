...
| `frontend.image.tag`                             | NGINX image tag (immutable tags are recommended)                                                      | `1.25.2-debian-11-r37` |
...
| `dashboard.image.tag`                             | Dashboard image tag (immutable tags are recommended)                                                      | `2.9.0-debian-11-r5`         |
...
| `apprepository.image.tag`                                   | Kubeapps AppRepository Controller image tag (immutable tags are recommended)                                                                                                                             | `2.9.0-debian-11-r0`                        |
...
| `apprepository.syncImage.tag`                               | Kubeapps Asset Syncer image tag (immutable tags are recommended)                                                                                                                                         | `2.9.0-debian-11-r0`                        |
...
| `authProxy.image.tag`                             | OAuth2 Proxy image tag (immutable tags are recommended)                                                                             | `7.5.1-debian-11-r0`   |
...
| `pinnipedProxy.image.tag`                             | Pinniped Proxy image tag (immutable tags are recommended)                                                      | `2.9.0-debian-11-r0`              |
...
| `kubeappsapis.image.tag`                                                                        | Kubeapps-APIs image tag (immutable tags are recommended)                                                                                                                   | `2.9.0-debian-11-r0`               |
