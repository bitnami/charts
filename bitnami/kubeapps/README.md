...
| `dashboard.image.tag`                             | Dashboard image tag (immutable tags are recommended)                                                      | `2.6.0-debian-11-r0`         |
...
| `apprepository.image.tag`                                   | Kubeapps AppRepository Controller image tag (immutable tags are recommended)                                                                                                                             | `2.6.0-scratch-r1`                          |
...
| `apprepository.syncImage.tag`                               | Kubeapps Asset Syncer image tag (immutable tags are recommended)                                                                                                                                         | `2.6.0-scratch-r2`                          |
...
| `pinnipedProxy.image.tag`                             | Pinniped Proxy image tag (immutable tags are recommended)                                                      | `2.6.0-debian-11-r5`              |
...
| `kubeappsapis.image.tag`                                                                        | Kubeapps-APIs image tag (immutable tags are recommended)                                                                                                                   | `2.6.0-debian-11-r5`               |
