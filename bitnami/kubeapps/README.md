...
| `authProxy.existingOauth2Secret.enabled`          | Specifies whether Kubeapps should use existing secret to get clientID, clientSecret and cookieSecret parameters | `false`                |
| `authProxy.existingOauth2Secret.name`             | Secret name where Oauth2 credentials are present                                                                | `""`                   |
...
| `kubeappsapis.pluginConfig.kappController.packages.v1alpha1.defaultPrereleasesVersionSelection` | Default policy for allowing prereleases containing one of the identifiers                                                                                                  | `[]`                               |
