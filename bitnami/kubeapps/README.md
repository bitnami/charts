...
| `dashboard.image.tag`                             | Dashboard image tag (immutable tags are recommended)                                       | `2.4.0-debian-10-r28`        |
...
| `pinnipedProxy.image.tag`                             | Pinniped Proxy image tag (immutable tags are recommended)                | `2.4.0-debian-10-r35`             |
...
| `kubeappsapis.image.tag`                             | Kubeapps-APIs image tag (immutable tags are recommended)                                                                | `2.4.0-debian-10-r34`   |
