...
| `dashboard.image.tag`                             | Dashboard image tag (immutable tags are recommended)                                         | `2.4.3-debian-10-r37`        |
...
| `apprepository.image.tag`                             | Kubeapps AppRepository Controller image tag (immutable tags are recommended)              | `2.4.3-scratch-r0`                          |
...
| `apprepository.syncImage.tag`                         | Kubeapps Asset Syncer image tag (immutable tags are recommended)                          | `2.4.3-scratch-r0`                          |
...
| `kubeops.image.tag`                             | Kubeops image tag (immutable tags are recommended)                                        | `2.4.3-scratch-r0`         |
...
| `assetsvc.image.tag`                             | Kubeapps Assetsvc image tag (immutable tags are recommended)                              | `2.4.3-scratch-r0`          |
...
| `pinnipedProxy.image.tag`                             | Pinniped Proxy image tag (immutable tags are recommended)                | `2.4.3-debian-10-r39`             |
...
| `kubeappsapis.image.tag`                                                                        | Kubeapps-APIs image tag (immutable tags are recommended)                                  | `2.4.3-debian-10-r39`    |
