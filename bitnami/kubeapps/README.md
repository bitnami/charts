...
| `dashboard.image.tag`                             | Dashboard image tag (immutable tags are recommended)                                                      | `2.6.3-debian-11-r8`         |
...
| `apprepository.image.tag`                                   | Kubeapps AppRepository Controller image tag (immutable tags are recommended)                                                                                                                             | `2.6.3-scratch-r3`                          |
...
| `apprepository.syncImage.tag`                               | Kubeapps Asset Syncer image tag (immutable tags are recommended)                                                                                                                                         | `2.6.3-scratch-r2`                          |
...
| `pinnipedProxy.image.tag`                             | Pinniped Proxy image tag (immutable tags are recommended)                                                      | `2.6.3-debian-11-r8`              |
...
| `kubeappsapis.image.tag`                                                                        | Kubeapps-APIs image tag (immutable tags are recommended)                                                                                                                   | `2.6.3-debian-11-r8`               |
...
> Note: If you are upgrading from 2.3.1 see the [following section](#user-content-upgrading-to-231).
> Note: If you are upgrading from 1.X to 2.X see the [following section](#user-content-upgrading-to-20).
