...
| `config.kubeQPS`                                  | Queries per second limit                                                                                                  | `60`                                |
| `config.kubeBurst`                                | Up to x number of queries allowed. Burst to roughly match your events per minute QPS to be 1/5 of the burst               | `60`                                |
| `config.maxEventAgeSeconds`                       | maximum age of an event that can be processed                                                                             | `10`                                |
