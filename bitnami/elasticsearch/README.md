...
| `image.tag`                                | Elasticsearch image tag (immutable tags are recommended)                                                                                            | `8.2.0-debian-10-r12`          |
...
| `curator.image.tag`                                   | Elasticsearch Curator image tag                                                                                                             | `5.8.4-debian-10-r347`          |
...
| `metrics.image.tag`                             | Metrics exporter image tag                                                                                                     | `1.3.0-debian-10-r202`           |
...
| `sysctlImage.tag`                      | Kernel settings modifier image tag                                                                                                                        | `10-debian-10-r429`     |
