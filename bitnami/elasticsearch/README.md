...
| `global.elasticsearch.service.fullname`               | Full Elasticsearch service name to be referenced by the Kibana subchart (ignored if kibanaEnabled=false)                                                                                                                                                                                                                                                            | `elasticsearch` |
