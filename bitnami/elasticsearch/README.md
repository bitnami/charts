...
| `image.tag`                                | Elasticsearch image tag (immutable tags are recommended)                                                                                            | `8.2.2-debian-11-r0`           |
...
| `master.runtimeClassName`                            | Name of the runtime class to be used by pod(s)                                                                                                     | `""`                |
...
| `data.runtimeClassName`                            | Name of the runtime class to be used by pod(s)                                                                                                   | `""`                |
...
| `coordinating.runtimeClassName`                            | Name of the runtime class to be used by pod(s)                                                                            | `""`            |
...
| `ingest.runtimeClassName`                            | Name of the runtime class to be used by pod(s)                                                                                   | `""`                         |
...
| `curator.image.tag`                                   | Elasticsearch Curator image tag                                                                                                             | `5.8.4-debian-11-r0`            |
...
| `curator.runtimeClassName`                            | Name of the runtime class to be used by pod(s)                                                                                              | `""`                            |
...
| `metrics.image.tag`                             | Metrics exporter image tag                                                                                                     | `1.3.0-debian-11-r0`             |
...
| `sysctlImage.tag`                      | Kernel settings modifier image tag                                                                                                                        | `11-debian-11-r0`       |
