...
| `image.tag`                                | Elasticsearch image tag (immutable tags are recommended)                                                                                            | `7.17.2-debian-10-r20`         |
...
| `curator.image.tag`                                   | Elasticsearch Curator image tag                                                                                                             | `5.8.4-debian-10-r320`          |
...
| `metrics.image.tag`                             | Metrics exporter image tag                                                                                               | `1.3.0-debian-10-r175`           |
...
| `sysctlImage.tag`                      | Kernel settings modifier image tag                                                                                                                        | `10-debian-10-r402`     |
