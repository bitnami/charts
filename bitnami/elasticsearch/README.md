...
| `config`                                          | Elasticsearch node custom configuration. Overrides existing configuration                                                                                         | ``                                                           |
| `extraConfig`                                     | Extra configuration to be appended to Elasticsearch node configuration                                                                                            | ``                                                           |
...
| `metrics.readinessProbe.initialDelaySeconds`      | Delay before readiness probe is initiated (metrics pod)                                                                                                           | `30`                                                         |
| `metrics.readinessProbe.periodSeconds`            | How often to perform the probe (metrics pod)                                                                                                                      | `10`                                                         |
| `metrics.readinessProbe.timeoutSeconds`           | When the probe times out (metrics pod)                                                                                                                            | `5`                                                          |
