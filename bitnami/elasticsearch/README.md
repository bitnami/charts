...
| `master.extraPodSecurityContext`            | Extra security context parameters on pod level. Used if `master.securityContext.enabled` is set to `true`                                                                                                                               | `{}`                |
| `master.extraContainerSecurityContext`      | Extra security context parameters on container level. Used if `master.securityContext.enabled` is set to `true`                                                                                                                         | `{}`                |
...
| `coordinating.extraPodSecurityContext`            | Extra security context parameters on pod level. Used if `coordinating.securityContext.enabled` is set to `true`           | `{}`            |
| `coordinating.extraContainerSecurityContext`      | Extra security context parameters on container level. Used if `coordinating.securityContext.enabled` is set to `true`     | `{}`            |
...
| `data.extraPodSecurityContext`               | Extra security context parameters on pod level. Used if `data.securityContext.enabled` is set to `true`                                           | `{}`                |
| `data.extraContainerSecurityContext`         | Extra security context parameters on container level. Used if `data.securityContext.enabled` is set to `true`                                     | `{}`                |
