...
| `image.tag`                                | Elasticsearch image tag (immutable tags are recommended)                                                                                            | `7.14.1-debian-10-r8`          |
...
| `curator.image.tag`                          | Elasticsearch Curator image tag                                                                   | `5.8.4-debian-10-r117`          |
...
| `metrics.image.tag`                          | Metrics exporter image tag                                                                                | `1.2.1-debian-10-r69`            |
...
| `sysctlImage.tag`                | Kernel settings modifier image tag          | `10-debian-10-r187`     |
