...
| `image.tag`                                | Elasticsearch image tag (immutable tags are recommended)                                                                                            | `8.2.3-debian-11-r4`           |
...
| `curator.image.tag`                                   | Elasticsearch Curator image tag                                                                                                             | `5.8.4-debian-11-r9`            |
...
| `metrics.image.tag`                             | Metrics exporter image tag                                                                                                     | `1.3.0-debian-11-r9`             |
...
| `sysctlImage.tag`                      | Kernel settings modifier image tag                                                                                                                        | `11-debian-11-r8`       |
