...
| `image.tag`                                | Elasticsearch image tag (immutable tags are recommended)                                                                                            | `7.14.1-debian-10-r1`          |
...
| `curator.image.tag`                          | Elasticsearch Curator image tag                                                                   | `5.8.4-debian-10-r111`          |
...
| `metrics.image.tag`                          | Metrics exporter image tag                                                                                | `1.2.1-debian-10-r62`            |
...
| `sysctlImage.tag`                | Kernel settings modifier image tag          | `10-debian-10-r180`     |
