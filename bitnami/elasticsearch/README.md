...
| `master.serviceAccount`                           | Enable creation of ServiceAccount for the master node                                                                                                     | `{ create: false, name: "" }`                                |
...
| `coordinating.serviceAccount`                     | Enable creation of ServiceAccount for the coordinating-only node                                                                                          | `{ create: false, name: ""}`                                 |
...
| `data.serviceAccount`                             | Enable creation of ServiceAccount for the data node                                                                                                       | `{ create: false, name: "" }`                                |
