...
| `image.tag`          | NGINX image tag (immutable tags are recommended)                                                      | `1.25.2-debian-11-r27` |
...
| `cloneStaticSiteFromGit.image.tag`                  | Git image tag (immutable tags are recommended)                                                      | `2.42.0-debian-11-r23` |
...
| `metrics.image.tag`                        | NGINX Prometheus exporter image tag (immutable tags are recommended)                                                                      | `0.11.0-debian-11-r346`  |
