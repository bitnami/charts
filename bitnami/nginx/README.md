...
| `image.tag`          | NGINX image tag (immutable tags are recommended)                                                      | `1.24.0-debian-11-r0` |
...
| `metrics.image.tag`                        | NGINX Prometheus exporter image tag (immutable tags are recommended)                                                                      | `0.11.0-debian-11-r74`   |
