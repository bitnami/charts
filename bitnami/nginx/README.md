...
| `image.tag`          | NGINX image tag (immutable tags are recommended)                     | `1.21.1-debian-10-r25` |
...
| `cloneStaticSiteFromGit.image.tag`         | Git image tag (immutable tags are recommended)                                                    | `2.32.0-debian-10-r51` |
...
| `ldapDaemon.image.tag`                          | LDAP Auth Daemon Image tag (immutable tags are recommended)                              | `0.20200116.0-debian-10-r412`    |
...
| `metrics.image.tag`                    | NGINX Prometheus exporter image tag (immutable tags are recommended)                        | `0.9.0-debian-10-r119`   |
...
The `image.tag` parameter allows specifying which image will be pulled for the chart. Refer to the [chart documentation for more information on this parameter and how to use it with images from a private registry](https://docs.bitnami.com/kubernetes/infrastructure/nginx/configuration/change-image-version/).
