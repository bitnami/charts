...
| `image.tag`          | NGINX image tag (immutable tags are recommended)                     | `1.23.1-debian-11-r0` |
...
| `cloneStaticSiteFromGit.image.tag`         | Git image tag (immutable tags are recommended)                                                    | `2.37.1-debian-11-r2` |
...
| `metrics.image.tag`                        | NGINX Prometheus exporter image tag (immutable tags are recommended)                                                                      | `0.10.0-debian-11-r16`   |
