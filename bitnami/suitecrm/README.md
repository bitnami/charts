...
| `image.tag`                             | SuiteCRM image tag (immutable tags are recommended)                                                      | `7.13.4-debian-11-r33` |
...
| `certificates.image.tag`                             | Container sidecar image tag (immutable tags are recommended)                                                      | `11-debian-11-r45`                       |
