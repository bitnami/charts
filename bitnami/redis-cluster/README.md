...
| `image.tag`                                             | Redis&reg; cluster image tag (immutable tags are recommended)                                                                                       | `7.0.11-debian-11-r27`  |
...
| `volumePermissions.image.tag`                           | Init container volume-permissions image tag                                                                                                         | `11-debian-11-r132`     |
...
| `metrics.image.tag`                                         | Redis&reg; exporter image tag                                                                                                      | `1.51.0-debian-11-r6`    |
...
| `sysctlImage.tag`                                 | sysctlImage Init container tag                                                                                       | `11-debian-11-r132`     |
