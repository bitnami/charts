...
| `image.tag`                             | Redis&trade; cluster image tag (immutable tags are recommended)                                                                                     | `6.2.5-debian-10-r30`   |
...
| `metrics.image.tag`                       | Redis&trade; exporter image tag                                                                                          | `1.26.0-debian-10-r4`    |
...
| `sysctlImage.tag`                | sysctlImage Init container tag                     | `10-debian-10-r172`     |
