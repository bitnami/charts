...
| `image.tag`                                             | Redis&reg; cluster image tag (immutable tags are recommended)                                                                                       | `7.0.6-debian-11-r0`    |
...
| `metrics.image.tag`                                         | Redis&reg; exporter image tag                                                                                                      | `1.45.0-debian-11-r14`   |
