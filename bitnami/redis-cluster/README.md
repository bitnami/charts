...
| `image.tag`                                             | Redis&reg; cluster image tag (immutable tags are recommended)                                                                                       | `7.0.10-debian-11-r0`   |
...
| `metrics.image.tag`                                         | Redis&reg; exporter image tag                                                                                                      | `1.48.0-debian-11-r5`    |
