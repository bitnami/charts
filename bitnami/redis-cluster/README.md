...
| `image.tag`                                             | Redis&reg; cluster image tag (immutable tags are recommended)                                                                                       | `7.0.12-debian-11-r1`   |
...
| `metrics.image.tag`                                         | Redis&reg; exporter image tag                                                                                                      | `1.52.0-debian-11-r25`   |
...
| `sysctlImage.tag`                                 | sysctlImage Init container tag                                                                                       | `11-debian-11-r45` |
