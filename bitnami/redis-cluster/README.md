...
| `image.tag`                                             | Redis&reg; cluster image tag (immutable tags are recommended)                                                                                       | `7.0.7-debian-11-r0`    |
...
| `tls.enabled`                                           | Enable TLS support for replication traffic                                                                                                          | `true`                  |
| `tls.authClients`                                       | Require clients to authenticate or not                                                                                                              | `false`                 |
...
| `metrics.image.tag`                                         | Redis&reg; exporter image tag                                                                                                      | `1.45.0-debian-11-r17`   |
...
| `sysctlImage.tag`                                 | sysctlImage Init container tag                                                                                       | `11-debian-11-r63`      |
