...
| `cluster.nodes`                                 | Total Number of nodes in the Redis<sup>TM</sup> cluster including `replicas`. The cluster has to have at least 3 master nodes, and `nodes = numOfMasterNodes + numOfMasterNodes * replicas`. So `nodes = 6` and `replicas = 1` means 3 master and 3 replica nodes.                                                                                        | `6`            |
