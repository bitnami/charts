...
| `image.tag`                                             | Redis&reg; cluster image tag (immutable tags are recommended)                                                                                       | `7.0.9-debian-11-r6`    |
...
| `metrics.image.tag`                                         | Redis&reg; exporter image tag                                                                                                      | `1.48.0-debian-11-r4`    |
