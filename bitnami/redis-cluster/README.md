...
| `image.tag`                                   | Redis&trade; cluster image tag (immutable tags are recommended)                                                                                     | `6.2.7-debian-10-r22`   |
...
| `metrics.image.tag`                        | Redis&trade; exporter image tag                                                                                                    | `1.37.0-debian-10-r62`   |
