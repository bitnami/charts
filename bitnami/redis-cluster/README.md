...
| `image.tag`                             | Redis&trade; cluster image tag (immutable tags are recommended)                                                                               | `6.2.4-debian-10-r21`   |
...
| `metrics.image.tag`                       | Redis&trade; exporter image tag                                                                                    | `1.24.0-debian-10-r17`   |
