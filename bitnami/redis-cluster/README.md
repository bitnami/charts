...
| `image.tag`                                   | Redis&trade; cluster image tag (immutable tags are recommended)                                                                                     | `6.2.6-debian-10-r193`  |
...
| `volumePermissions.image.tag`                 | Init container volume-permissions image tag                                                                                                         | `10-debian-10-r402`     |
...
| `metrics.image.tag`                        | Redis&trade; exporter image tag                                                                                                    | `1.37.0-debian-10-r33`   |
...
| `sysctlImage.tag`                | sysctlImage Init container tag                     | `10-debian-10-r402`     |
