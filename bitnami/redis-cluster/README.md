...
| `image.tag`                                             | Redis&reg; cluster image tag (immutable tags are recommended)                                                                                       | `7.0.5-debian-11-r9`    |
...
| `metrics.image.tag`                                         | Redis&reg; exporter image tag                                                                                                      | `1.44.0-debian-11-r19`   |
