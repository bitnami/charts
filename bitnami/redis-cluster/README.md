...
| `image.tag`                                   | Redis&reg; cluster image tag (immutable tags are recommended)                                                                                       | `7.0.4-debian-11-r14`   |
...
| `metrics.image.tag`                                         | Redis&reg; exporter image tag                                                                                                      | `1.44.0-debian-11-r3`    |
...
| `sysctlImage.tag`                | sysctlImage Init container tag                                                                                       | `11-debian-11-r33`      |
