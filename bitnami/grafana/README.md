...
| `image.tag`                        | Grafana image tag (immutable tags are recommended)                                | `8.5.0-debian-10-r0` |
...
| `imageRenderer.image.tag`                               | Grafana Image Renderer image tag (immutable tags are recommended)                                                                         | `3.4.2-debian-10-r28`            |
