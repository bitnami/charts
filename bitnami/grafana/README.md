...
| `image.tag`                        | Grafana image tag (immutable tags are recommended)                                | `8.2.2-debian-10-r5` |
...
| `imageRenderer.image.tag`                            | Grafana Image Renderer image tag (immutable tags are recommended)                                       | `3.2.1-debian-10-r13`            |
