...
| `image.tag`                        | Grafana image tag (immutable tags are recommended)                                                                                                   | `8.5.3-debian-10-r5`              |
...
| `ldap.uidField`                    | Field used to match with the user name (uid, samAccountName, cn, etc). This value will be ignored if 'ldap.searchFilter' is set                      | `uid`                             |
...
| `ldap.tls.skipVerify`              | Skip hostname verification                                                                                                                           | `false`                           |
...
| `imageRenderer.image.tag`                                | Grafana Image Renderer image tag (immutable tags are recommended)                                                                         | `3.4.2-debian-10-r60`            |
