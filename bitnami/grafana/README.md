...
| `image.tag`                        | Grafana image tag (immutable tags are recommended)                                                                                                   | `9.0.6-debian-11-r2`              |
...
| `datasources.secretDefinition`     | Contents of a secret defining custom datasource files. Only used if datasources.secretName is empty or undefined.                                    | `{}`                              |
...
| `imageRenderer.image.tag`                                | Grafana Image Renderer image tag (immutable tags are recommended)                                                                         | `3.5.0-debian-11-r7`             |
