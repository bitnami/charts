...
| `image.tag`                        | Grafana image tag (immutable tags are recommended)                                | `8.2.1-debian-10-r0` |
...
| `ingress.tls`                      | Enable TLS configuration for the hostname defined at ingress.hostname parameter. You have to enable either `ingress.selfSigned` or `ingress.certManager` to make TLS work. | `false`                  |
...
| `ingress.certManager`              | Add annotations to use preconfigured cert-manager TLS ACME to provision a certifcate.                                                                                      | `false`                  |
