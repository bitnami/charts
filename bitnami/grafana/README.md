...
| `image.tag`                        | Grafana image tag (immutable tags are recommended)                                | `8.2.4-debian-10-r0` |
...
| `imageRenderer.image.tag`                            | Grafana Image Renderer image tag (immutable tags are recommended)                                       | `3.2.1-debian-10-r33`            |
