...
| `image.tag`                                          | MongoDB(&reg;) Sharded image tag (immutable tags are recommended)                                                                                         | `6.0.8-debian-11-r31`     |
...
| `metrics.image.tag`                                       | MongoDB&reg; exporter image tag                                                                                       | `0.39.0-debian-11-r73`     |
