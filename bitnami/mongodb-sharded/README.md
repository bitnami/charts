...
| `image.tag`                                          | MongoDB(&reg;) Sharded image tag (immutable tags are recommended)                                                                                         | `4.4.13-debian-10-r49`    |
...
| `volumePermissions.image.tag`                        | Init container volume-permissions image tag                                                                                                               | `10-debian-10-r401`       |
...
| `configsvr.livenessProbe.initialDelaySeconds`               | Initial delay seconds for livenessProbe                                                                                               | `10`                                                   |
| `configsvr.livenessProbe.periodSeconds`                     | Period seconds for livenessProbe                                                                                                      | `10`                                                   |
| `configsvr.livenessProbe.timeoutSeconds`                    | Timeout seconds for livenessProbe                                                                                                     | `5`                                                    |
| `configsvr.livenessProbe.failureThreshold`                  | Failure threshold for livenessProbe                                                                                                   | `6`                                                    |
...
| `configsvr.readinessProbe.periodSeconds`                    | Period seconds for readinessProbe                                                                                                     | `10`                                                   |
| `configsvr.readinessProbe.timeoutSeconds`                   | Timeout seconds for readinessProbe                                                                                                    | `5`                                                    |
...
| `configsvr.startupProbe.enabled`                            | Enable readinessProbe                                                                                                                 | `true`                                                 |
| `configsvr.startupProbe.initialDelaySeconds`                | Initial delay seconds for readinessProbe                                                                                              | `10`                                                   |
| `configsvr.startupProbe.periodSeconds`                      | Period seconds for readinessProbe                                                                                                     | `5`                                                    |
| `configsvr.startupProbe.timeoutSeconds`                     | Timeout seconds for readinessProbe                                                                                                    | `2`                                                    |
| `configsvr.startupProbe.failureThreshold`                   | Failure threshold for readinessProbe                                                                                                  | `15`                                                   |
| `configsvr.startupProbe.successThreshold`                   | Success threshold for readinessProbe                                                                                                  | `1`                                                    |
...
| `mongos.startupProbe.enabled`                            | Enable readinessProbe                                                                                                    | `true`          |
| `mongos.startupProbe.initialDelaySeconds`                | Initial delay seconds for readinessProbe                                                                                 | `10`            |
| `mongos.startupProbe.periodSeconds`                      | Period seconds for readinessProbe                                                                                        | `5`             |
| `mongos.startupProbe.timeoutSeconds`                     | Timeout seconds for readinessProbe                                                                                       | `2`             |
| `mongos.startupProbe.failureThreshold`                   | Failure threshold for readinessProbe                                                                                     | `15`            |
| `mongos.startupProbe.successThreshold`                   | Success threshold for readinessProbe                                                                                     | `1`             |
...
| `shardsvr.dataNode.livenessProbe.initialDelaySeconds`               | Initial delay seconds for livenessProbe                                                                                  | `10`                                                   |
| `shardsvr.dataNode.livenessProbe.periodSeconds`                     | Period seconds for livenessProbe                                                                                         | `10`                                                   |
| `shardsvr.dataNode.livenessProbe.timeoutSeconds`                    | Timeout seconds for livenessProbe                                                                                        | `5`                                                    |
| `shardsvr.dataNode.livenessProbe.failureThreshold`                  | Failure threshold for livenessProbe                                                                                      | `6`                                                    |
...
| `shardsvr.dataNode.readinessProbe.periodSeconds`                    | Period seconds for readinessProbe                                                                                        | `10`                                                   |
| `shardsvr.dataNode.readinessProbe.timeoutSeconds`                   | Timeout seconds for readinessProbe                                                                                       | `5`                                                    |
...
| `shardsvr.dataNode.startupProbe.enabled`                            | Enable readinessProbe                                                                                                    | `true`                                                 |
| `shardsvr.dataNode.startupProbe.initialDelaySeconds`                | Initial delay seconds for readinessProbe                                                                                 | `10`                                                   |
| `shardsvr.dataNode.startupProbe.periodSeconds`                      | Period seconds for readinessProbe                                                                                        | `5`                                                    |
| `shardsvr.dataNode.startupProbe.timeoutSeconds`                     | Timeout seconds for readinessProbe                                                                                       | `2`                                                    |
| `shardsvr.dataNode.startupProbe.failureThreshold`                   | Failure threshold for readinessProbe                                                                                     | `15`                                                   |
| `shardsvr.dataNode.startupProbe.successThreshold`                   | Success threshold for readinessProbe                                                                                     | `1`                                                    |
...
| `shardsvr.arbiter.livenessProbe.initialDelaySeconds`               | Initial delay seconds for livenessProbe                                                                                  | `10`            |
| `shardsvr.arbiter.livenessProbe.periodSeconds`                     | Period seconds for livenessProbe                                                                                         | `10`            |
| `shardsvr.arbiter.livenessProbe.timeoutSeconds`                    | Timeout seconds for livenessProbe                                                                                        | `5`             |
| `shardsvr.arbiter.livenessProbe.failureThreshold`                  | Failure threshold for livenessProbe                                                                                      | `6`             |
...
| `shardsvr.arbiter.readinessProbe.periodSeconds`                    | Period seconds for readinessProbe                                                                                        | `10`            |
| `shardsvr.arbiter.readinessProbe.timeoutSeconds`                   | Timeout seconds for readinessProbe                                                                                       | `5`             |
...
| `shardsvr.arbiter.startupProbe.enabled`                            | Enable readinessProbe                                                                                                    | `true`          |
| `shardsvr.arbiter.startupProbe.initialDelaySeconds`                | Initial delay seconds for readinessProbe                                                                                 | `10`            |
| `shardsvr.arbiter.startupProbe.periodSeconds`                      | Period seconds for readinessProbe                                                                                        | `5`             |
| `shardsvr.arbiter.startupProbe.timeoutSeconds`                     | Timeout seconds for readinessProbe                                                                                       | `2`             |
| `shardsvr.arbiter.startupProbe.failureThreshold`                   | Failure threshold for readinessProbe                                                                                     | `15`            |
| `shardsvr.arbiter.startupProbe.successThreshold`                   | Success threshold for readinessProbe                                                                                     | `1`             |
...
| `metrics.image.tag`                                       | MongoDB&reg; exporter image tag                                                    | `0.31.2-debian-10-r11`     |
...
| `metrics.startupProbe.failureThreshold`                   | Failure threshold for readinessProbe                                               | `15`                       |
| `metrics.startupProbe.successThreshold`                   | Success threshold for readinessProbe                                               | `1`                        |
