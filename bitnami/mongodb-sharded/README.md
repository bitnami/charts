...
| `image.tag`                                          | MongoDB(&reg;) Sharded image tag (immutable tags are recommended)                                                                                         | `4.4.13-debian-10-r30`    |
...
| `volumePermissions.image.tag`                        | Init container volume-permissions image tag                                                                                                               | `10-debian-10-r383`       |
...
| `metrics.image.tag`                                       | MongoDB&reg; exporter image tag                                                    | `0.31.1-debian-10-r1`      |
