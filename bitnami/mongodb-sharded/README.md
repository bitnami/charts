...
| `image.tag`                                          | MongoDB(&reg;) Sharded image tag (immutable tags are recommended)                                                                                         | `5.0.9-debian-11-r6`      |
...
| `auth.customPasswordFiles`                           | Use custom password files when `auth.usePasswordFiles` is set to `true`. Define path for keys `root` and `replica`.                                       | `{}`                      |
...
| `metrics.image.tag`                                       | MongoDB&reg; exporter image tag                                                    | `0.33.0-debian-11-r3`      |
