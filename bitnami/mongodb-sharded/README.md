...
| `image.tag`                                          | MongoDB(&reg;) Sharded image tag (immutable tags are recommended)                                                                                         | `6.0.6-debian-11-r0`      |
...
| `metrics.image.tag`                                       | MongoDB&reg; exporter image tag                                                                                       | `0.37.0-debian-11-r28`     |
