...
| `configsvr.livenessProbe.failureThreshold`                  | Failure threshold for livenessProbe                                                                                                   | `12`                                                   |
...
| `configsvr.readinessProbe.failureThreshold`                 | Failure threshold for readinessProbe                                                                                                  | `12`                                                   |
...
| `configsvr.startupProbe.periodSeconds`                      | Period seconds for startupProbe                                                                                                       | `5`                                                    |
| `configsvr.startupProbe.timeoutSeconds`                     | Timeout seconds for startupProbe                                                                                                      | `2`                                                    |
...
| `mongos.livenessProbe.failureThreshold`                  | Failure threshold for livenessProbe                                                                                          | `12`            |
...
| `mongos.readinessProbe.failureThreshold`                 | Failure threshold for readinessProbe                                                                                         | `12`            |
...
| `shardsvr.dataNode.livenessProbe.failureThreshold`                  | Failure threshold for livenessProbe                                                                                      | `12`                                                   |
...
| `shardsvr.dataNode.readinessProbe.failureThreshold`                 | Failure threshold for readinessProbe                                                                                     | `12`                                                   |
...
| `shardsvr.dataNode.startupProbe.periodSeconds`                      | Period seconds for startupProbe                                                                                          | `5`                                                    |
| `shardsvr.dataNode.startupProbe.timeoutSeconds`                     | Timeout seconds for startupProbe                                                                                         | `2`                                                    |
...
| `shardsvr.arbiter.livenessProbe.failureThreshold`                  | Failure threshold for livenessProbe                                                                                      | `12`            |
...
| `shardsvr.arbiter.readinessProbe.failureThreshold`                 | Failure threshold for readinessProbe                                                                                     | `12`            |
...
| `shardsvr.arbiter.startupProbe.periodSeconds`                      | Period seconds for startupProbe                                                                                          | `5`             |
| `shardsvr.arbiter.startupProbe.timeoutSeconds`                     | Timeout seconds for startupProbe                                                                                         | `2`             |
