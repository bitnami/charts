...
| `image.tag`                                          | MongoDB(&reg;) Sharded image tag (immutable tags are recommended)                                                                                         | `4.4.13-debian-10-r46`    |
...
| `volumePermissions.image.tag`                        | Init container volume-permissions image tag                                                                                                               | `10-debian-10-r399`       |
...
| `metrics.image.tag`                                       | MongoDB&reg; exporter image tag                                                    | `0.31.2-debian-10-r9`      |
