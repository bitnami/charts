...
| `configsvr.livenessProbe.periodSeconds`                     | Period seconds for livenessProbe                                                                                                      | `20`                                                   |
| `configsvr.livenessProbe.timeoutSeconds`                    | Timeout seconds for livenessProbe                                                                                                     | `10`                                                   |
...
| `configsvr.readinessProbe.periodSeconds`                    | Period seconds for readinessProbe                                                                                                     | `20`                                                   |
| `configsvr.readinessProbe.timeoutSeconds`                   | Timeout seconds for readinessProbe                                                                                                    | `10`                                                   |
...
| `mongos.livenessProbe.periodSeconds`                     | Period seconds for livenessProbe                                                                                             | `20`            |
| `mongos.livenessProbe.timeoutSeconds`                    | Timeout seconds for livenessProbe                                                                                            | `10`            |
...
| `mongos.readinessProbe.periodSeconds`                    | Period seconds for readinessProbe                                                                                            | `20`            |
| `mongos.readinessProbe.timeoutSeconds`                   | Timeout seconds for readinessProbe                                                                                           | `10`            |
...
| `shardsvr.dataNode.livenessProbe.periodSeconds`                     | Period seconds for livenessProbe                                                                                         | `20`                                                   |
| `shardsvr.dataNode.livenessProbe.timeoutSeconds`                    | Timeout seconds for livenessProbe                                                                                        | `10`                                                   |
...
| `shardsvr.arbiter.livenessProbe.periodSeconds`                     | Period seconds for livenessProbe                                                                                         | `20`            |
| `shardsvr.arbiter.livenessProbe.timeoutSeconds`                    | Timeout seconds for livenessProbe                                                                                        | `10`            |
...
| `shardsvr.arbiter.readinessProbe.periodSeconds`                    | Period seconds for readinessProbe                                                                                        | `20`            |
| `shardsvr.arbiter.readinessProbe.timeoutSeconds`                   | Timeout seconds for readinessProbe                                                                                       | `10`            |
