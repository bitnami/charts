...
| `configsvr.startupProbe.failureThreshold`                   | Failure threshold for startupProbe                                                                                                    | `15`                                                   |
...
| `shardsvr.dataNode.startupProbe.failureThreshold`                   | Failure threshold for startupProbe                                                                                       | `15`                                                   |
...
| `shardsvr.arbiter.startupProbe.failureThreshold`                   | Failure threshold for startupProbe                                                                                       | `15`            |
