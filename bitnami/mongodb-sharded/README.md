...
| `image.tag`                                          | MongoDB(&reg;) Sharded image tag (immutable tags are recommended)                                                                                         | `6.0.3-debian-11-r17`     |
...
| `metrics.image.tag`                                       | MongoDB&reg; exporter image tag                                                                                       | `0.36.0-debian-11-r3`      |
