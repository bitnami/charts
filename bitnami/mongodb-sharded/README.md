...
| `image.tag`                                          | MongoDB(&reg;) Sharded image tag (immutable tags are recommended)                                                                                         | `5.0.9-debian-11-r3`      |
...
| `auth.passwordFile`                                  | sets mountpoint of the password files, if the auth.usePasswordFile is set to `true`                                                                       | {}                        |
...
| `metrics.image.tag`                                       | MongoDB&reg; exporter image tag                                                    | `0.33.0-debian-11-r0`      |
