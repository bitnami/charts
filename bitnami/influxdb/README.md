...
| `image.tag`                                                  | InfluxDB&trade; image tag (immutable tags are recommended)                                                                                                                                                                                                           | `2.7.1-debian-11-r107` |
...
| `backup.uploadProviders.google.image.tag`                          | Google Cloud SDK image tag                                                                                       | `0.443.0-debian-11-r3`     |
...
| `backup.uploadProviders.azure.image.tag`                           | Azure CLI image tag (immutable tags are recommended)                                                             | `2.51.0-debian-11-r18`     |
...
| `backup.uploadProviders.aws.image.tag`                             | AWS CLI image tag (immutable tags are recommended)                                                               | `2.13.11-debian-11-r0`     |
