...
| `image.tag`                                      | InfluxDB&trade; image tag (immutable tags are recommended)                                                                                                                                                                                                           | `2.4.0-debian-11-r19` |
...
| `backup.uploadProviders.google.image.tag`         | Google Cloud SDK image tag                                                                                       | `0.406.0-debian-11-r0`     |
...
| `backup.uploadProviders.azure.image.tag`          | Azure CLI image tag (immutable tags are recommended)                                                             | `2.41.0-debian-11-r2`      |
