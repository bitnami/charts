...
| `image.tag`                                   | InfluxDB&trade; image tag (immutable tags are recommended)                                                                                                                                                                                                           | `2.0.9-debian-10-r1` |
...
| `backup.uploadProviders.azure.image.tag`          | Azure CLI image tag (immutable tags are recommended)                                                    | `2.28.1-debian-10-r21`     |
