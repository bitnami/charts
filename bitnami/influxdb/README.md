...
| `image.tag`                                      | InfluxDB&trade; image tag (immutable tags are recommended)                                                                                                                                                                                                           | `2.4.0-debian-11-r5` |
...
| `backup.uploadProviders.google.image.tag`         | Google Cloud SDK image tag                                                                                       | `0.401.0-debian-11-r1`     |
...
| `backup.uploadProviders.azure.image.tag`          | Azure CLI image tag (immutable tags are recommended)                                                             | `2.40.0-debian-11-r1`      |
