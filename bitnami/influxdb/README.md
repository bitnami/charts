...
| `image.tag`                                      | InfluxDB&trade; image tag (immutable tags are recommended)                                                                                                                                                                                                           | `2.6.1-debian-11-r21` |
...
| `backup.uploadProviders.google.image.tag`         | Google Cloud SDK image tag                                                                                       | `0.419.0-debian-11-r1`     |
...
| `backup.uploadProviders.azure.image.tag`          | Azure CLI image tag (immutable tags are recommended)                                                             | `2.45.0-debian-11-r6`      |
...
| `backup.uploadProviders.aws.image.tag`            | AWS CLI image tag (immutable tags are recommended)                                                               | `2.10.3-debian-11-r0`      |
