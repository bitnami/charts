...
| `image.tag`                                      | InfluxDB&trade; image tag (immutable tags are recommended)                                                                                                                                                                                                           | `2.1.1-debian-10-r39` |
...
| `backup.uploadProviders.google.image.tag`         | Google Cloud SDK image tag                                                                              | `0.367.0-debian-10-r25`    |
...
| `backup.uploadProviders.azure.image.tag`          | Azure CLI image tag (immutable tags are recommended)                                                    | `2.32.0-debian-10-r5`      |
