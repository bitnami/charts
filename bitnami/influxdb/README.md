...
| `image.tag`                                      | InfluxDB&trade; image tag (immutable tags are recommended)                                                                                                                                                                                                           | `2.2.0-debian-10-r40` |
...
| `volumePermissions.image.tag`                 | Init container volume-permissions image tag                                                                       | `10-debian-10-r430`     |
...
| `backup.uploadProviders.google.image.tag`         | Google Cloud SDK image tag                                                                              | `0.386.0-debian-10-r1`     |
...
| `backup.uploadProviders.azure.image.tag`          | Azure CLI image tag (immutable tags are recommended)                                                    | `2.36.0-debian-10-r22`     |
