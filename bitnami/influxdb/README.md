...
| `image.tag`                                      | InfluxDB&trade; image tag (immutable tags are recommended)                                                                                                                                                                                                           | `2.7.1-debian-11-r0` |
...
| `backup.uploadProviders.google.image.tag`         | Google Cloud SDK image tag                                                                                       | `0.428.0-debian-11-r0`     |
...
| `backup.uploadProviders.azure.image.tag`          | Azure CLI image tag (immutable tags are recommended)                                                             | `2.48.1-debian-11-r0`      |
...
| `backup.uploadProviders.aws.image.tag`            | AWS CLI image tag (immutable tags are recommended)                                                               | `2.11.15-debian-11-r2`     |
