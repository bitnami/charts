...
| `backup.retentionDays`                      | retention time in days for backups                                                                                                                                                        | `10`                                                    |
| `backup.annotations`                        | backup annotations                                                                                                                                                                        | `{}`                                                    |  
| `backup.upload.google.enabled`              | enable upload to google storage bucket                                                                                                                                                    | `false`                                                 |
| `backup.upload.google.serviceAccountSecret` | service account secret name                                                                                                                                                               | `"influxdb-backup-gcs-key"`                             |
| `backup.upload.google.serviceAccountSecretKey` | service account secret key                                                                                                                                                             | `"key.json"`                                            |
| `backup.upload.google.bucketname`           | google storage bucket name                                                                                                                                                                | `"gs://bucket/influxdb"`                                |
| `backup.upload.azure.enabled`               | enbale upload to azure storage                                                                                                                                                            | `false`                                                 |
| `backup.upload.azure.storageAccountSecret`  | storage account secret                                                                                                                                                                    | `"influxdb-backup-azure-key"`                           |
| `backup.upload.azure.destination_container` | destination container                                                                                                                                                                     | `"influxdb-container"`                                  |
| `backup.upload.azure.destination_path`      | destination path                                                                                                                                                                          | `""`                                                    |
