...
| `image.tag`                                   | InfluxDB&trade; image tag (immutable tags are recommended)                                                                                                                                                                                                           | `2.0.8-debian-10-r0` |
...
| `volumePermissions.image.tag`                 | Init container volume-permissions image tag                                                                       | `10-debian-10-r160`     |
...
| `backup.uploadProviders.google.image.tag`         | Google Cloud SDK image tag                                                                              | `0.352.0-debian-10-r3`     |
...
| `backup.uploadProviders.azure.image.tag`          | Azure CLI image tag (immutable tags are recommended)                                                    | `2.27.1-debian-10-r2`      |
