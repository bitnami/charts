...
| `backup.restore.enabled`                                           | Enable restore. Should be used when backup is enabled                                                                                                                                                                               | `false`                              |
| `backup.restore.directory`                                         | Restored data path                                                                                                                                                                                                                  | `/restore`                           |
| `backup.restore.existingClaim`                                     | This PVC is used to store restored data. Should be created beforehand.                                                                                                                                                              | `""`                                 |
