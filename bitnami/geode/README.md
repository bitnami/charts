...
| `image.tag`                              | Apache Geode image tag (immutable tags are recommended)                                | `1.15.0-debian-11-r0`                                       |
...
| `metrics.image.tag`                             | Bitnami HAProxy image tag (immutable tags are recommended)                       | `2.6.1-debian-11-r2` |
