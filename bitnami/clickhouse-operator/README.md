...
| `image.debug`                                       | Enable ClickHouse Operator image debug mode                                                                                                                                                                                    | `false`                               |
...
| `clickHouseImage.debug`                             | Enable ClickHouse image debug mode                                                                                                                                                                                             | `false`                               |
...
| `keeperImage.debug`                                 | Enable ClickHouse Keeper image debug mode                                                                                                                                                                                      | `false`                               |
...
| `metrics.image.debug`                                       | Enable ClickHouse Operator Metrics exporter image debug mode                                                                                                                                                                                                    | `false`                               |
