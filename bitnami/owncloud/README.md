...
| `containerPort`                          | Port that should be exposed from the owncloud container                                               | `80`                                                         |
...
| `persistence.owncloud.extraVolumes`      | Specification for any extra Volumes added to the deployment                                           | `{}`                                                         |
| `persistence.owncloud.extraVolumeMounts` | Specification for any extra VolumeMounts added to the deployment                                      | `{}`                                                         |
...
| `extraEnv     `                          | Any extra environment variables to pass on to the pod                                                 | `{}`                                                         |
