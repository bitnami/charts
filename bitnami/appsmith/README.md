...
| Name                                                                        | Description                                                                                                                                                                                                                       | Value                     |
| --------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------- |
| `backend.redirectSidecar.image.registry`                                    | HAProxy image registry                                                                                                                                                                                                            | `REGISTRY_NAME`           |
| `backend.redirectSidecar.image.repository`                                  | HAProxy image repository                                                                                                                                                                                                          | `REPOSITORY_NAME/haproxy` |
| `backend.redirectSidecar.image.digest`                                      | HAProxy image digest in the way sha256:aa.... Please note this parameter, if set, will override the tag                                                                                                                           | `""`                      |
| `backend.redirectSidecar.image.pullPolicy`                                  | HAProxy image pull policy                                                                                                                                                                                                         | `IfNotPresent`            |
| `backend.redirectSidecar.image.pullSecrets`                                 | HAProxy image pull secrets                                                                                                                                                                                                        | `[]`                      |
| `backend.redirectSidecar.containerSecurityContext.enabled`                  | Enabled Appsmith backend redirect sidecar containers' Security Context                                                                                                                                                            | `true`                    |
| `backend.redirectSidecar.containerSecurityContext.seLinuxOptions`           | Set SELinux options in container                                                                                                                                                                                                  | `{}`                      |
| `backend.redirectSidecar.containerSecurityContext.runAsUser`                | Set containers' Security Context runAsUser                                                                                                                                                                                        | `1001`                    |
| `backend.redirectSidecar.containerSecurityContext.runAsGroup`               | Set containers' Security Context runAsGroup                                                                                                                                                                                       | `1001`                    |
| `backend.redirectSidecar.containerSecurityContext.runAsNonRoot`             | Set Appsmith backend redirect sidecar containers' Security Context runAsNonRoot                                                                                                                                                   | `true`                    |
| `backend.redirectSidecar.containerSecurityContext.readOnlyRootFilesystem`   | Set Appsmith backend redirect sidecar containers' Security Context runAsNonRoot                                                                                                                                                   | `true`                    |
| `backend.redirectSidecar.containerSecurityContext.privileged`               | Set backend container's Security Context privileged                                                                                                                                                                               | `false`                   |
| `backend.redirectSidecar.containerSecurityContext.allowPrivilegeEscalation` | Set backend container's Security Context allowPrivilegeEscalation                                                                                                                                                                 | `false`                   |
| `backend.redirectSidecar.containerSecurityContext.capabilities.drop`        | List of capabilities to be dropped                                                                                                                                                                                                | `["ALL"]`                 |
| `backend.redirectSidecar.containerSecurityContext.seccompProfile.type`      | Set container's Security Context seccomp profile                                                                                                                                                                                  | `RuntimeDefault`          |
| `backend.redirectSidecar.command`                                           | Override default container command (useful when using custom images)                                                                                                                                                              | `[]`                      |
| `backend.redirectSidecar.args`                                              | Override default container args (useful when using custom images)                                                                                                                                                                 | `[]`                      |
| `backend.redirectSidecar.lifecycleHooks`                                    | for the Appsmith backend redirect sidecar container(s) to automate configuration before or after startup                                                                                                                          | `{}`                      |
| `backend.redirectSidecar.extraEnvVars`                                      | Array with extra environment variables to add to Appsmith backend redirect sidecar nodes                                                                                                                                          | `[]`                      |
| `backend.redirectSidecar.extraEnvVarsCM`                                    | Name of existing ConfigMap containing extra env vars for Appsmith backend redirect sidecar nodes                                                                                                                                  | `""`                      |
| `backend.redirectSidecar.extraEnvVarsSecret`                                | Name of existing Secret containing extra env vars for Appsmith backend redirect sidecar nodes                                                                                                                                     | `""`                      |
| `backend.redirectSidecar.extraVolumeMounts`                                 | Optionally specify extra list of additional volumeMounts for the Appsmith backend redirect sidecar container(s)                                                                                                                   | `[]`                      |
| `backend.redirectSidecar.containerPorts.http`                               | Appsmith backend redirect sidecar HTTP container port                                                                                                                                                                             | `8080`                    |
| `backend.redirectSidecar.livenessProbe.enabled`                             | Enable livenessProbe on Appsmith backend redirect sidecar containers                                                                                                                                                              | `true`                    |
| `backend.redirectSidecar.livenessProbe.initialDelaySeconds`                 | Initial delay seconds for livenessProbe                                                                                                                                                                                           | `30`                      |
| `backend.redirectSidecar.livenessProbe.periodSeconds`                       | Period seconds for livenessProbe                                                                                                                                                                                                  | `10`                      |
| `backend.redirectSidecar.livenessProbe.timeoutSeconds`                      | Timeout seconds for livenessProbe                                                                                                                                                                                                 | `5`                       |
| `backend.redirectSidecar.livenessProbe.failureThreshold`                    | Failure threshold for livenessProbe                                                                                                                                                                                               | `6`                       |
| `backend.redirectSidecar.livenessProbe.successThreshold`                    | Success threshold for livenessProbe                                                                                                                                                                                               | `1`                       |
| `backend.redirectSidecar.readinessProbe.enabled`                            | Enable readinessProbe on Appsmith backend redirect sidecar containers                                                                                                                                                             | `true`                    |
| `backend.redirectSidecar.readinessProbe.initialDelaySeconds`                | Initial delay seconds for readinessProbe                                                                                                                                                                                          | `30`                      |
| `backend.redirectSidecar.readinessProbe.periodSeconds`                      | Period seconds for readinessProbe                                                                                                                                                                                                 | `10`                      |
| `backend.redirectSidecar.readinessProbe.timeoutSeconds`                     | Timeout seconds for readinessProbe                                                                                                                                                                                                | `5`                       |
| `backend.redirectSidecar.readinessProbe.failureThreshold`                   | Failure threshold for readinessProbe                                                                                                                                                                                              | `6`                       |
| `backend.redirectSidecar.readinessProbe.successThreshold`                   | Success threshold for readinessProbe                                                                                                                                                                                              | `1`                       |
| `backend.redirectSidecar.startupProbe.enabled`                              | Enable startupProbe on Appsmith backend redirect sidecar containers                                                                                                                                                               | `false`                   |
| `backend.redirectSidecar.startupProbe.initialDelaySeconds`                  | Initial delay seconds for startupProbe                                                                                                                                                                                            | `30`                      |
| `backend.redirectSidecar.startupProbe.periodSeconds`                        | Period seconds for startupProbe                                                                                                                                                                                                   | `10`                      |
| `backend.redirectSidecar.startupProbe.timeoutSeconds`                       | Timeout seconds for startupProbe                                                                                                                                                                                                  | `5`                       |
| `backend.redirectSidecar.startupProbe.failureThreshold`                     | Failure threshold for startupProbe                                                                                                                                                                                                | `6`                       |
| `backend.redirectSidecar.startupProbe.successThreshold`                     | Success threshold for startupProbe                                                                                                                                                                                                | `1`                       |
| `backend.redirectSidecar.customLivenessProbe`                               | Custom livenessProbe that overrides the default one                                                                                                                                                                               | `{}`                      |
| `backend.redirectSidecar.customReadinessProbe`                              | Custom readinessProbe that overrides the default one                                                                                                                                                                              | `{}`                      |
| `backend.redirectSidecar.customStartupProbe`                                | Custom startupProbe that overrides the default one                                                                                                                                                                                | `{}`                      |
| `backend.redirectSidecar.resourcesPreset`                                   | Set container resources according to one common preset (allowed values: none, nano, micro, small, medium, large, xlarge, 2xlarge). This is ignored if backend.resources is set (backend.resources is recommended for production). | `nano`                    |
| `backend.redirectSidecar.resources`                                         | Set container requests and limits for different resources like CPU or memory (essential for production workloads)                                                                                                                 | `{}`                      |
