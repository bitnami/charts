...
| `image.tag`                             | Moodle image tag (immutable tags are recommended)                                                                     | `4.1.1-debian-11-r18` |
...
| `volumePermissions.image.tag`          | Init container volume-permissions image tag (immutable tags are recommended)                                                                              | `11-debian-11-r91`      |
...
| `certificates.image.tag`                             | Container sidecar image tag (immutable tags are recommended)                                                      | `11-debian-11-r91`                       |
