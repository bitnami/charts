...
| `image.tag`                             | Moodle image tag (immutable tags are recommended)                                                                     | `4.2.1-debian-11-r33` |
...
| `certificates.image.tag`                             | Container sidecar image tag (immutable tags are recommended)                                                      | `11-debian-11-r22`                       |
