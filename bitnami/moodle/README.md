...
Looking to use Bitnami LMS powered by Moodle## TL;DRtrade; LMS in production? Try [VMware Application Catalog](https://bitnami.com/enterprise), the enterprise edition of Bitnami Application Catalog.
...
| `image.tag`                             | Moodle image tag (immutable tags are recommended)                                                                     | `4.2.0-debian-11-r1` |
...
| `certificates.image.tag`                             | Container sidecar image tag (immutable tags are recommended)                                                      | `11-debian-11-r114`                      |
