...
| `image.tag`                             | Moodle image tag (immutable tags are recommended)                                                                     | `4.2.2-debian-11-r0` |
...
| `metrics.image.tag`                        | Apache exporter image tag (immutable tags are recommended)                                                      | `1.0.1-debian-11-r14`     |
