...
| `image.tag`                             | Moodle image tag (immutable tags are recommended)                                                                     | `4.0.5-debian-11-r0` |
...
| `certificates.image.tag`                             | Container sidecar image tag (immutable tags are recommended)                                                      | `11-debian-11-r51`                       |
