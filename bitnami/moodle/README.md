...
| `image.tag`                             | Moodle image tag (immutable tags are recommended)                                                                     | `4.1.1-debian-11-r19` |
...
| `certificates.image.tag`                             | Container sidecar image tag (immutable tags are recommended)                                                      | `11-debian-11-r92`                       |
