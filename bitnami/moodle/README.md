...
| `image.tag`                             | Moodle image tag (immutable tags are recommended)                                                                     | `4.0.4-debian-11-r9` |
...
| `moodleLang`                            | Moodle site language (install defined lang package)                                                                   | `""`                 |
...
| `metrics.image.tag`                        | Apache exporter image tag (immutable tags are recommended)                                                      | `0.11.0-debian-11-r44`    |
