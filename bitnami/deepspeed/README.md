...
| `image.tag`                         | Deepspeed image tag (immutable tags are recommended)                                                      | `0.10.1-debian-11-r0` |
...
| `gitImage.tag`                         | Git image tag (immutable tags are recommended)                                                                                    | `2.42.0-debian-11-r0`     |
