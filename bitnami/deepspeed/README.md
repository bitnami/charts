...
| `image.tag`                         | Deepspeed image tag (immutable tags are recommended)                                                      | `0.10.0-debian-11-r29` |
...
| `gitImage.tag`                         | Git image tag (immutable tags are recommended)                                                                                    | `2.41.0-debian-11-r71`    |
