...
| `image.tag`                     | image tag (immutable tags are recommended)                                                                                             | `7.9.0-debian-11-r10` |
...
| `volumePermissions.image.tag`                          | Init container volume-permissions image tag (immutable tags are recommended)                                                      | `11-debian-11-r67`      |
