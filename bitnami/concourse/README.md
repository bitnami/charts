...
| `image.tag`                     | image tag (immutable tags are recommended)                                                                                             | `7.10.0-debian-11-r18` |
...
| `volumePermissions.image.tag`                          | Init container volume-permissions image tag (immutable tags are recommended)                                                      | `11-debian-11-r48` |
