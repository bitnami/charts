...
| `web.lisentIp`                                       | IP address on which to listen for HTTP traffic (web UI and API).                                                  | `0.0.0.0`               |
...
| `web.podSecurityPolicy.create`                       | Specifies whether a PodSecurityPolicy should be created (set `podSecurityPolicy.create` to `true` to enable it)   | `false`                 |
| `web.service.type`                                   | For minAvailableikube, set this to ClusterIP, elsewhere use LoadBalancer or NodePort                              | `ClusterIP`             |
| `web.service.clusterIP`                              | When using `web.service.type: ClusterIP`, sets the user-specified cluster IP.                                     | `nil`                   |
| `web.service.loadBalancerIP`                         | When using `web.service.type: LoadBalancer`, sets the user-specified load balancer IP.                            | `nil`                   |
| `web.service.labels`                                 | Additional Labels to be added to the web api service.                                                             | `nil`                   |
| `web.service.annotations`                            | Annotations to be added to the web api service.                                                                   | `{}`                    |
| `web.service.loadBalancerSourceRanges`               | When using `web.service.type: LoadBalancer`, restrict access to the load balancer to particular IPs               | `nil`                   |
| `web.service.NodePort`                               | When using `web.service.type: NodePort`, sets the nodePort for api                                                | `nil`                   |
| `web.service.tlsNodePort`                            | When using `web.service.type: NodePort`, sets the nodePort for api tls                                            | `nil`                   |
...
| `web.tsa.lisentIp`                                   | IP address on which to listen for SSH.                                                                            | `0.0.0.0`               |
| `web.tsa.containerPort`                              | Port on which to listen for SSH.                                                                                  | `2222`                  |
| `web.tsa.debugLisentIp`                              | IP address on which to listen for the pprof debugger endpoints (default: 127.0.0.1)                               | `127.0.0.1`             |
...
| Name                            | Description                                                                                   | Value                    |
| ------------------------------- | --------------------------------------------------------------------------------------------- | ------------------------ |
| `web.ingress.enabled`           | Ingress configuration enabled                                                                 | `true`                   |
...
| `worker.args`                                |                                                                                                                 | `[]`                     |
| `worker.lisentIp`                            | IP address on which to listen for the Garden server.                                                            | `127.0.0.1`              |
...
| `worker.podSecurityPolicy.create`            | Specifies whether a PodSecurityPolicy should be created (set `podSecurityPolicy.create` to `true` to enable it) | `false`                  |
| `worker.podLabels`                           |                                                                                                                 | `{}`                     |
...
| `worker.updateStrategy`                      | web statefulset strategy type                                                                                   | `RollingUpdate`          |
...
| `worker.baggageclaim.lisentIp`               | IP address on which to listen for API traffic.                                                                  | `127.0.0.1`              |
| `worker.baggageclaim.containerPort`          | Port on which to listen for API traffic.                                                                        | `7788`                   |
| `worker.baggageclaim.debugLisentIp`          | IP address on which to listen for the pprof debugger endpoints.                                                 | `127.0.0.1`              |
