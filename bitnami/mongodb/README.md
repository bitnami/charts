...
| `image.tag`              | MongoDB(&reg;) image tag (immutable tags are recommended)                                                                                                    | `5.0.10-debian-11-r2` |
...
| `tls.image.tag`          | Init container TLS certs setup image tag (immutable tags are recommended)                                                                                    | `1.23.1-debian-11-r3` |
...
| `metrics.image.tag`                          | MongoDB(&reg;) Prometheus exporter image tag (immutable tags are recommended)                                         | `0.33.0-debian-11-r8`      |
