...
| `podSecurityContext`                      | MongoDB pod(s)' Security Context                                                                           | `{}`                                                    |
| `containerSecurityContext`                | MongoDB containers' Security Context                                                                       | `{}`                                                    |
...
| `arbiter.podSecurityContext`              | Arbiter pod(s)' Security Context                                                                           | `{}`                                                         |
| `arbiter.containerSecurityContext`        | Arbiter containers' Security Context                                                                       | `{}`                                                         |
