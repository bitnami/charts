...
| `image.tag`            | MongoDB(&reg;) image tag (immutable tags are recommended)                                                                       | `4.4.13-debian-10-r48` |
...
| `tls.image.tag`        | Init container TLS certs setup image tag (immutable tags are recommended)                                                       | `1.21.6-debian-10-r81` |
...
| `externalAccess.autoDiscovery.image.tag`                 | Init container auto-discovery image tag (immutable tags are recommended)                                                                        | `1.23.5-debian-10-r30` |
...
| `metrics.image.tag`                          | MongoDB(&reg;) Prometheus exporter image tag (immutable tags are recommended)                                         | `0.31.2-debian-10-r11`     |
