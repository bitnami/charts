...
| `image.tag`         | Redmine image tag (immutable tags are recommended) | `4.2.2-debian-10-r2` |
...
| `certificates.image.tag`                             | Redmine image tag (immutable tags are recommended)                 | `10-debian-10-r149`                      |
