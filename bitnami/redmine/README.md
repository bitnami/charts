...
| `image.tag`             | Redmine image tag (immutable tags are recommended)                     | `5.0.1-debian-10-r3` |
...
| `certificates.image.tag`                             | Redmine image tag (immutable tags are recommended)                 | `10-debian-10-r431`                      |
