...
| `image.tag`             | Redmine image tag (immutable tags are recommended)                     | `4.2.4-debian-10-r0` |
...
| `certificates.image.tag`                             | Redmine image tag (immutable tags are recommended)                 | `10-debian-10-r353`                      |
