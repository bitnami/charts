...
| `extraEnvVarsCM`                                    | Name of existing ConfigMap containing extra env vars for minio-operator nodes                                                                                                                                                       | `""`                                     |
...
| Name                               | Description                                                                               | Value       |
| ---------------------------------- | ----------------------------------------------------------------------------------------- | ----------- |
| `service.type`                     | minio-operator service type                                                               | `ClusterIP` |
...
### minio-operator RBAC Parameters
