...
| `image.tag`                     | HashiCorp Consul image tag (immutable tags are recommended)                                  | `1.12.3-debian-11-r7` |
...
| `metrics.image.tag`                             | HashiCorp Consul Prometheus Exporter image tag (immutable tags are recommended)                                             | `0.8.0-debian-11-r20`     |
