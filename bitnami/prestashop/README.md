...
| `image.tag`                             | PrestaShop image tag (immutable tags are recommended)                                                      | `8.0.3-debian-11-r0` |
...
| `certificates.image.tag`                             | Container sidecar image tag (immutable tags are recommended)                                                      | `11-debian-11-r105`                      |
