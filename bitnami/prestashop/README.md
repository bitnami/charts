...
| `image.tag`                             | PrestaShop image tag (immutable tags are recommended)                                     | `1.7.8-6-debian-11-r9` |
...
| `certificates.image.tag`                             | Container sidecar image tag (immutable tags are recommended)         | `11-debian-11-r11`                       |
