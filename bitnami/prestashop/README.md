...
| `image.tag`                             | PrestaShop image tag (immutable tags are recommended)                                                      | `8.0.1-debian-11-r0` |
...
| `metrics.image.tag`          | Apache exporter image tag (immutable tags are recommended)                                                      | `0.11.0-debian-11-r79`    |
...
| `certificates.image.tag`                             | Container sidecar image tag (immutable tags are recommended)                                                      | `11-debian-11-r69`                       |
