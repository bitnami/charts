...
| `image.tag`                 | OpenSearch image tag (immutable tags are recommended)                                                                                               | `2.10.0-debian-11-r9` |
...
| `dashboards.image.tag`                                   | OpenSearch Dashboards image tag (immutable tags are recommended)                                                                                                       | `2.10.0-debian-11-r7`           |
