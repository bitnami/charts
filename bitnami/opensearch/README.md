...
| Name                                                     | Description                                                                                                                                            | Value                           |
| -------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------- |
| `dashboards.enabled`                                     | Enables Opensearch Dashboards deployment                                                                                                               | `true`                          |
...
| `dashboards.image.tag`                                   | Opensearch Dashboards image tag (immutable tags are recommended)                                                                                       | `development`                   |
...
| `dashboards.service.nodePorts.http-os`                   | Node port for REST API                                                                                                                                 | `""`                            |
...
| `dashboards.annotations`                                 | Annotations for the data statefulset                                                                                                                   | `{}`                            |
...
| `dashboards.podSecurityContext.fsGroup`                  | Set data pod's Security Context fsGroup                                                                                                                | `1001`                          |
...
| `dashboards.startupProbe.initialDelaySeconds`            | Delay before startup probe is initiated (data nodes pod)                                                                                               | `90`                            |
...
| `dashboards.livenessProbe.initialDelaySeconds`           | Delay before liveness probe is initiated (data nodes pod)                                                                                              | `90`                            |
...
| `dashboards.readinessProbe.initialDelaySeconds`          | Delay before readiness probe is initiated (data nodes pod)                                                                                             | `90`                            |
...
| `dashboards.persistence.enabled`                         | Enable persistence using a `PersistentVolumeClaim`                                                                                                     | `false`                         |
| `dashboards.persistence.storageClass`                    | Persistent Volume Storage Class                                                                                                                        | `""`                            |
| `dashboards.persistence.existingClaim`                   | Existing Persistent Volume Claim                                                                                                                       | `""`                            |
| `dashboards.persistence.existingVolume`                  | Existing Persistent Volume for use as volume match label selector to the `volumeClaimTemplate`. Ignored when `dashboards.persistence.selector` is set. | `""`                            |
| `dashboards.persistence.selector`                        | Configure custom selector for existing Persistent Volume. Overwrites `dashboards.persistence.existingVolume`                                           | `{}`                            |
...
| `dashboards.persistence.size`                            | Persistent Volume Size                                                                                                                                 | `8Gi`                           |
...
| `dashboards.serviceAccount.automountServiceAccountToken` | Automount service account token for the server service account                                                                                         | `true`                          |
...
| `dashboards.autoscaling.enabled`                         | Whether enable horizontal pod autoscale                                                                                                                | `false`                         |
| `dashboards.autoscaling.minReplicas`                     | Configure a minimum amount of pods                                                                                                                     | `1`                             |
| `dashboards.autoscaling.maxReplicas`                     | Configure a maximum amount of pods                                                                                                                     | `11`                            |
| `dashboards.autoscaling.targetCPU`                       | Define the CPU target to trigger the scaling actions (utilization percentage)                                                                          | `""`                            |
| `dashboards.autoscaling.targetMemory`                    | Define the memory target to trigger the scaling actions (utilization percentage)                                                                       | `""`                            |
