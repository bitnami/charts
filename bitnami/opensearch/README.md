...
| `image.tag`                 | OpenSearch image tag (immutable tags are recommended)                                                                                               | `2.9.0-debian-11-r47` |
...
| `dashboards.image.tag`                                   | OpenSearch Dashboards image tag (immutable tags are recommended)                                                                                                       | `2.9.0-debian-11-r47`           |
