...
| `image.tag`                                       | PyTorch image tag (immutable tags are recommended)                                                                       | `1.13.1-debian-11-r24` |
...
| `git.tag`                              | Git image tag (immutable tags are recommended)                                                                                                            | `2.39.2-debian-11-r5`   |
