...
| `image.tag`                                       | PyTorch image tag (immutable tags are recommended)                                                                       | `1.13.1-debian-11-r30` |
...
| `git.tag`                              | Git image tag (immutable tags are recommended)                                                                                                            | `2.40.0-debian-11-r1`   |
