...
| `image.tag`                                       | PyTorch image tag (immutable tags are recommended)                                                                       | `2.0.1-debian-11-r97` |
...
| `git.tag`                              | Git image tag (immutable tags are recommended)                                                                                                            | `2.41.0-debian-11-r76` |
