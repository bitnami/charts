...
| `image.tag`                                       | PyTorch image tag (immutable tags are recommended)                                                                       | `1.13.1-debian-11-r0` |
...
| `git.tag`                              | Git image tag (immutable tags are recommended)                                                                                                            | `2.39.0-debian-11-r1`   |
