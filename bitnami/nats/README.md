...
| `tls.cert`                                         | TLS certificate for NATS. Ignored if `tls.master.existingSecret` is set                                                                                                         | `""`                                            |
| `tls.key`                                          | TLS key for NATS. Ignored if `tls.master.existingSecret` is set                                                                                                                 | `""`                                            |
| `tls.existingSecret`                               | The name of an existing Secret containing the NATS certificates for TLS                                                                                                         | `""`                                            |
...
| `command`                                          | Override default container command (useful when using custom images)                                                                                                            | `["/nats-server"]`                              |
| `args`                                             | Override default container args (useful when using custom images)                                                                                                               | `["-c","/etc/{{ .Values.natsFilename }}.conf"]` |
