...
{{/*
Return the name of the secret containing the TLS certificates for NATS
*/}}
{{- define "nats.tls.secretName" -}}
{{- if or .Values.tls.autoGenerated.enabled (and (not (empty .Values.tls.cert)) (not (empty .Values.tls.key))) -}}
    {{- printf "%s-crt" (include "common.names.fullname" .) -}}
{{- else -}}
    {{- required "An existing secret name must be provided with TLS certs for NATS if cert and key are not provided!" (tpl .Values.tls.existingSecret .) -}}
{{- end -}}
{{- end -}}
