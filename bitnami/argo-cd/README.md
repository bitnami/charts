...
| `image.tag`         | Argo CD image tag (immutable tags are recommended) | `2.4.6-debian-11-r1` |
...
| `applicationSet.service.externalTrafficPolicy`                     | Argo CD application controller service external traffic policy                                           | `Cluster`       |
...
| `applicationSet.initContainers`                                    | Add additional init containers to the Argo CD pod(s)                                                     | `[]`            |
...
| `dex.image.tag`                                         | Dex image tag (immutable tags are recommended)                                                | `2.32.0-debian-11-r12` |
...
| `redis.image.tag`                         | Argo CD controller image tag (immutable tags are recommended)               | `7.0.3-debian-11-r0` |
