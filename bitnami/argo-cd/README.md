...
| `image.tag`         | Argo CD image tag (immutable tags are recommended)                                                      | `2.5.2-debian-11-r0` |
...
| `redis.image.tag`                         | Redis image tag (immutable tags are recommended)                                                      | `7.0.5-debian-11-r16` |
