...
| `image.tag`         | Argo CD image tag (immutable tags are recommended)                                                      | `2.6.0-debian-11-r0` |
...
| `dex.image.tag`                                         | Dex image tag (immutable tags are recommended)                                                      | `2.35.3-debian-11-r39` |
...
| `volumePermissions.image.tag`                          | Bitnami Shell image tag (immutable tags are recommended)                                                      | `11-debian-11-r80`      |
...
| `redis.image.tag`                         | Redis image tag (immutable tags are recommended)                                                      | `7.0.8-debian-11-r8` |
