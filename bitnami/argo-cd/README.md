...
| `image.tag`         | Argo CD image tag (immutable tags are recommended)                                                      | `2.6.4-debian-11-r0` |
...
| `dex.image.tag`                                         | Dex image tag (immutable tags are recommended)                                                      | `2.35.3-debian-11-r50` |
...
| `redis.image.tag`                         | Redis image tag (immutable tags are recommended)                                                      | `7.0.9-debian-11-r3` |
