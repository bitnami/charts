...
| `image.tag`         | Argo CD image tag (immutable tags are recommended)                                                      | `2.8.4-debian-11-r5` |
...
| `dex.image.tag`                                         | Dex image tag (immutable tags are recommended)                                                      | `2.37.0-debian-11-r87` |
...
| `redis.image.tag`                         | Redis image tag (immutable tags are recommended)                                                      | `7.2.1-debian-11-r19` |
