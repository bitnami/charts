...
| `image.tag`         | Argo CD image tag (immutable tags are recommended)                                                      | `2.6.6-debian-11-r0` |
...
| `dex.image.tag`                                         | Dex image tag (immutable tags are recommended)                                                      | `2.35.3-debian-11-r52` |
...
| `redis.image.tag`                         | Redis image tag (immutable tags are recommended)                                                      | `7.0.9-debian-11-r5` |
