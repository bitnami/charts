...
| `image.tag`         | Argo CD image tag (immutable tags are recommended) | `2.1.5-debian-10-r6` |
...
| `dex.image.tag`                                   | Dex image tag (immutable tags are recommended)                                                | `2.30.0-debian-10-r83` |
...
| `redis.image.tag`                         | Argo CD controller image tag (immutable tags are recommended)               | `6.2.6-debian-10-r21` |
