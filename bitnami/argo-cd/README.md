...
| `image.tag`         | Argo CD image tag (immutable tags are recommended)                                                      | `2.8.0-debian-11-r4` |
...
| `dex.image.tag`                                         | Dex image tag (immutable tags are recommended)                                                      | `2.37.0-debian-11-r39` |
...
| `redis.image.tag`                         | Redis image tag (immutable tags are recommended)                                                      | `7.0.12-debian-11-r26` |
