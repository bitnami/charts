...
| `image.tag`                             | Matomo Image tag                                                                                                      | `4.14.2-debian-11-r14` |
...
| `metrics.image.tag`         | Apache exporter image tag                                                                                       | `0.13.3-debian-11-r11`    |
...
| `certificates.image.tag`                             | Container sidecar image tag                                                                                       | `11-debian-11-r120`                      |
