...
| `image.tag`                             | Matomo Image tag                                                                                                      | `4.12.3-debian-11-r0` |
...
| `metrics.image.tag`         | Apache exporter image tag                                                                                       | `0.11.0-debian-11-r55`    |
...
| `certificates.image.tag`                             | Container sidecar image tag                                                                                       | `11-debian-11-r45`                       |
