...
| `image.tag`                             | Matomo Image tag                                                                                                      | `4.13.2-debian-11-r0` |
...
| `metrics.image.tag`         | Apache exporter image tag                                                                                       | `0.11.0-debian-11-r86`    |
...
| `certificates.image.tag`                             | Container sidecar image tag                                                                                       | `11-debian-11-r76`                       |
