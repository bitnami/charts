...
| `image.tag`                             | Matomo Image tag                                                                                                      | `4.15.0-debian-11-r0` |
...
| `volumePermissions.image.tag`          | Init container volume-permissions image tag                                                                                                               | `11-debian-11-r133`     |
...
| `metrics.image.tag`         | Apache exporter image tag                                                                                       | `0.13.4-debian-11-r12`    |
...
| `certificates.image.tag`                             | Container sidecar image tag                                                                                       | `11-debian-11-r133`                      |
