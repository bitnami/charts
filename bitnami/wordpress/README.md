...
| `image.tag`         | WordPress image tag (immutable tags are recommended) | `5.9.3-debian-10-r4` |
...
| `volumePermissions.image.tag`                          | Bitnami Shell image tag (immutable tags are recommended)                                        | `10-debian-10-r389`     |
