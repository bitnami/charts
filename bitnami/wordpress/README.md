...
| `image.tag`         | WordPress image tag (immutable tags are recommended)                                                      | `6.2.0-debian-11-r1` |
...
| `terminationGracePeriodSeconds`                     | In seconds, time the given to the WordPress pod needs to terminate gracefully                                            | `""`             |
