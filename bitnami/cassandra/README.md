...
| `image.tag`                   | Cassandra image tag (immutable tags are recommended)                                                                   | `4.0.3-debian-10-r36` |
...
| Name                                          | Description                                                              | Value  |
| --------------------------------------------- | ------------------------------------------------------------------------ | ------ |
| `automountServiceAccountToken`                | Enable/Disable Automount API credentials for a service account in a POD. | `true` |
...
| `volumePermissions.image.tag`                 | Init container volume                                                           | `10-debian-10-r378`     |
...
| `metrics.image.tag`                        | Cassandra exporter image tag                                                                           | `2.3.8-debian-10-r1`         |
