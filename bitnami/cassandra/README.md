...
| `podSecurityContext.seccompProfile.type`            | Set Cassandra pod's Security Context seccomp profile                                                                                                                                                              | `RuntimeDefault` |
...
| `volumePermissions.securityContext.runAsGroup`     | Group ID for the init container                                                                                                                                                                                                                       | `0`                        |
| `volumePermissions.securityContext.runAsNonRoot`   | runAsNonRoot for the init container                                                                                                                                                                                                                    | `false`                    |
| `volumePermissions.securityContext.seccompProfile.type` | seccompProfile.type for the init container                                                                                                                                                                                                       | `RuntimeDefault`           |
