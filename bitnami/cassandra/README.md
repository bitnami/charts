...
| `containerPorts.cassandra.intra`       | Intra Port on the Host and Container                                                                                    | `7000`                                                       |
| `containerPorts.cassandra.tls`         | TLS Port on the Host and Container                                                                                      | `7001`                                                       |
| `containerPorts.cassandra.jmx`         | JMX Port on the Host and Container                                                                                      | `7199`                                                       |
| `containerPorts.cassandra.cql`         | CQL Port on the Host and Container                                                                                      | `9042`                                                       |
| `containerPorts.cassandra.thrift`      | Thrift Port on the Host and Container                                                                                   | `9160`                                                       |
| `containerPorts.metrics.http`          | HTTP Port on the Host and Container                                                                                     | `8080`                                                       |
| `containerPorts.metrics.jmx`           | JMX Port on the Host and Container                                                                                      | `5555`                                                       |
