...
| `image.tag`                   | Cassandra image tag (immutable tags are recommended)                                                                   | `4.0.3-debian-10-r41` |
...
| `volumePermissions.image.tag`                 | Init container volume                                                           | `10-debian-10-r383`     |
...
| `metrics.image.tag`                        | Cassandra exporter image tag                                                                           | `2.3.8-debian-10-r6`         |
