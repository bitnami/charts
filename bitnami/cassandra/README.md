...
tls.existingTruststoreSecret=my-existing-cassandra-trust-bundle
tls.passwordsSecret=my-stores-password
...
| `tls.existingSecret`                | Existing secret that contains Cassandra Keystore and optionally truststore if `tls.existingTruststoreSecret` is not set                                                                                                   | `""`                  |
| `tls.existingTruststoreSecret`      | Existing secret that contains Cassandra truststore                                                                                                                                                                        | `""`                  |
...
| `tls.secretKeys.truststore`         | Key within `tls.existingSecret` or `tls.existingTruststoreSecret` (if set) that contains the truststore file                                                                                                              | `truststore`          |
