...
| `image.tag`                   | Cassandra image tag (immutable tags are recommended)                                                                   | `4.0.4-debian-11-r10` |
...
| `volumePermissions.image.tag`                 | Init container volume                                                           | `11-debian-11-r10`      |
...
| `metrics.image.tag`                        | Cassandra exporter image tag                                                                           | `2.3.8-debian-11-r10`        |
