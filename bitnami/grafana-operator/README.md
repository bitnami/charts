...
| `operator.namespaceScope`                                    | If the operator should run in namespace-scope or not                                                                                      | `false`                    |
...
| `operator.image.tag`                                         | Grafana Operator image tag                                                                                                                | `5.0.0-debian-11-r0`       |
...
| `grafana.image.tag`                                         | Grafana image tag                                                                                          | `9.5.3-debian-11-r3`     |
