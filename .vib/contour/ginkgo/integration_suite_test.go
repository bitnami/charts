...
func createIngressOrDie(ctx context.Context, c netcv1.NetworkingV1Interface, namespace string, name string, ingressRuleHost string, ingressRuleValue netv1.IngressRuleValue) netv1.Ingress {
