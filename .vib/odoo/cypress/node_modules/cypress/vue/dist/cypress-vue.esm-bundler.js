...
function mergeAppConfig(configGlobalConfig, mountGlobalConfig) {
    return __assign(__assign(__assign({}, configGlobalConfig), mountGlobalConfig), { globalProperties: __assign(__assign({}, configGlobalConfig === null || configGlobalConfig === void 0 ? void 0 : configGlobalConfig.globalProperties), mountGlobalConfig === null || mountGlobalConfig === void 0 ? void 0 : mountGlobalConfig.globalProperties), compilerOptions: __assign(__assign({}, configGlobalConfig === null || configGlobalConfig === void 0 ? void 0 : configGlobalConfig.compilerOptions), mountGlobalConfig === null || mountGlobalConfig === void 0 ? void 0 : mountGlobalConfig.compilerOptions) });
}
    ...
    return defineComponent({
        ...
        setup: function (props, _a) {
            ...
            return function () {
                ...
                return h(tag, propsWithoutSymbols, renderStubDefaultSlot ? slots : undefined);
            };
        }
    });
};
    ...
    if (isFunctionalComponent(originalComponent) ||
        ...
        component = defineComponent(__assign({ compatConfig: {
                ...
                COMPONENT_FUNCTIONAL: isLegacyFunctionalComponent(originalComponent)
                    ? 'suppress-warning'
                    : false
            }, props: originalComponent.props || {}, setup: function (_, _a) {
