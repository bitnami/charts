...
| `memcachedUser`     | Username of new user to create. | `nil`                                                    |
| `memcachedPassword` | Password for the new user.      | `nil`                                                    |
...
The [Bitnami Memcached](https://github.com/bitnami/bitnami-docker-memcached) image stores the Memcached data and configurations at the `/bitnami/memcached` path of the container.
...
```bash
$ gcloud compute disks create --size=500GB --zone=us-central1-a memcached-data-disk
```
